...
type [<ReferenceEquality>] Expr =
    ...
    | Typecase of TExpr * (StackSize * TExpr * Expr) []
    ...
    | AnnotBoxTest of StackSize * TExpr * bind: VarTag * on_succ: Expr * on_fail: Expr
    | AnnotTest of TExpr * bind: VarTag * on_succ: Expr * on_fail: Expr
