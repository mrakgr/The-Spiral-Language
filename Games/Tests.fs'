...
open Poker log
inl stack_size = 10
inl a' = {reply=reply_dmc {bias=0.0; scale=to float64 stack_size; range=32; num_players=2} s; name="One"; trace=term_cast (inl _ -> ()) float64}
inl b' = {reply=reply_random; name="Two"}
Loops.for {from=0; near_to=10; body=inl {i} ->
    Timer.time_it (string_format "iteration {0}" i)
    <| inl _ ->
...
open Poker log
inl stack_size = 10
inl a' = {reply=reply_dmc {distribution_size=64; bias=0.0; scale=to float64 stack_size; range=32; num_players=2} s; name="One"; trace=term_cast (inl _ -> ()) float64}
inl b' = {reply=reply_random; name="Two"}
Loops.for {from=0; near_to=10; body=inl {i} ->
    Timer.time_it (string_format "iteration {0}" i)
    <| inl _ ->
...
open Poker log
inl stack_size = 10
inl a' = {reply=reply_dmc {reward_range={from=-32; near_to=32}; bias=0.0; scale=1.0; range=32; num_players=2} s; name="One"; trace=term_cast (inl _ -> ()) float64}
inl b' = {reply=reply_random; name="Two"}
...
let poker8 =
    "poker8",[cuda_modules;loops;poker;timer],"What is the winrate of the deep MC learning (square error recurrent) player against the random one?",
    """
()
    """
