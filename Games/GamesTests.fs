...
let poker5 =
    "poker5",[cuda_modules;loops;poker;timer],"What is the winrate of the deep Q learning (square error) player against the random one?",
    """
...
inl b' = reply_random {name="Two"}
Loops.for {from=0; near_to=3; body=inl {i} ->
    Timer.time_it (string_format "iteration {0}" i)
    <| inl _ ->
