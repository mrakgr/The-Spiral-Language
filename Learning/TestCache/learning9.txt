...
extern "C" {
    ...
    __global__ void method_48(long long int var_0, float * var_1, float * var_2, float * var_3);
    ...
    __global__ void method_33(float * var_0, float var_1, float * var_2) {
        ...
        while (method_34(var_8, var_9)) {
            ...
            long long int var_19 = (var_11 + 64);
            var_8[0] = var_19;
            var_9[0] = var_18;
        }
        long long int var_20 = var_8[0];
        float var_21 = var_9[0];
        float var_22 = cub::BlockReduce<float,64,cub::BLOCK_REDUCE_WARP_REDUCTIONS,1,1>().Sum(var_21);
        float var_23 = (var_22 / var_1);
        long long int var_24 = threadIdx.x;
        char var_25 = (var_24 == 0);
        if (var_25) {
            long long int var_26 = blockIdx.x;
    ...
    __global__ void method_48(long long int var_0, float * var_1, float * var_2, float * var_3) {
        ...
        while (method_29(var_0, var_7)) {
            ...
            var_25[0] = var_22;
            var_26[0] = var_23;
            while (method_49(var_24, var_25, var_26)) {
...
and method_24((var_0: ManagedCuda.CudaBlas.CudaBlas), (var_1: ManagedCuda.CudaRand.CudaRandDevice), (var_2: EnvStack0), (var_3: uint64), (var_4: ResizeArray<Env1>), (var_5: ResizeArray<Env2>), (var_6: ManagedCuda.CudaContext), (var_7: ResizeArray<EnvHeap3>), (var_8: ResizeArray<EnvHeap4>), (var_9: ManagedCuda.BasicTypes.CUmodule), (var_10: EnvHeap4), (var_11: EnvStack9), (var_12: EnvStack9), (var_13: EnvStack9), (var_14: EnvStack9), (var_15: EnvStack9), (var_16: EnvStack9), (var_17: EnvStack9), (var_18: EnvStack9), (var_19: int64)): unit =
    ...
    if var_20 then
        ...
        if var_28 then
            ...
            let (var_31: int64) = 0L
            let (var_32: Env12) = method_47((var_15: EnvStack9), (var_16: EnvStack9), (var_11: EnvStack9), (var_12: EnvStack9), (var_13: EnvStack9), (var_14: EnvStack9), (var_0: ManagedCuda.CudaBlas.CudaBlas), (var_1: ManagedCuda.CudaRand.CudaRandDevice), (var_2: EnvStack0), (var_3: uint64), (var_4: ResizeArray<Env1>), (var_5: ResizeArray<Env2>), (var_6: ManagedCuda.CudaContext), (var_7: ResizeArray<EnvHeap3>), (var_8: ResizeArray<EnvHeap4>), (var_9: ManagedCuda.BasicTypes.CUmodule), (var_10: EnvHeap4), (var_29: int64), (var_30: float), (var_31: int64))
        ...
        ()
and method_53((var_0: ResizeArray<EnvHeap4>)): unit =
    let (var_2: (EnvHeap4 -> unit)) = method_54
...
and method_25((var_0: EnvStack9), (var_1: EnvStack9), (var_2: EnvStack9), (var_3: EnvStack9), (var_4: EnvStack9), (var_5: EnvStack9), (var_6: ManagedCuda.CudaBlas.CudaBlas), (var_7: ManagedCuda.CudaRand.CudaRandDevice), (var_8: EnvStack0), (var_9: uint64), (var_10: ResizeArray<Env1>), (var_11: ResizeArray<Env2>), (var_12: ManagedCuda.CudaContext), (var_13: ResizeArray<EnvHeap3>), (var_14: ResizeArray<EnvHeap4>), (var_15: ManagedCuda.BasicTypes.CUmodule), (var_16: EnvHeap4), (var_17: float), (var_18: int64)): Env11 =
    ...
    if var_19 then
        ...
        if var_20 then
            ...
            let (var_134: uint64) = method_5((var_106: (uint64 ref)))
            let (var_135: EnvHeap3) = var_1.mem_0
            ...
            let (var_151: EnvHeap3) = method_18((var_38: EnvHeap10), (var_6: ManagedCuda.CudaBlas.CudaBlas), (var_7: ManagedCuda.CudaRand.CudaRandDevice), (var_8: EnvStack0), (var_9: uint64), (var_10: ResizeArray<Env1>), (var_11: ResizeArray<Env2>), (var_12: ManagedCuda.CudaContext), (var_46: ResizeArray<EnvHeap3>), (var_14: ResizeArray<EnvHeap4>), (var_15: ManagedCuda.BasicTypes.CUmodule), (var_16: EnvHeap4), (var_150: int64))
            let (var_152: EnvStack9) = EnvStack9((var_151: EnvHeap3))
            ...
            // Cuda join point
            // method_31((var_134: uint64), (var_142: uint64), (var_50: int64), (var_157: uint64))
            let (var_158: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_31", var_15, var_12)
            ...
            let (var_163: (System.Object [])) = [|var_134; var_142; var_50; var_157|]: (System.Object [])
            var_158.RunAsync(var_161, var_163)
            let (var_164: uint64) = method_5((var_156: (uint64 ref)))
            let (var_166: int64) = 4L
            let (var_167: EnvHeap3) = method_18((var_38: EnvHeap10), (var_6: ManagedCuda.CudaBlas.CudaBlas), (var_7: ManagedCuda.CudaRand.CudaRandDevice), (var_8: EnvStack0), (var_9: uint64), (var_10: ResizeArray<Env1>), (var_11: ResizeArray<Env2>), (var_12: ManagedCuda.CudaContext), (var_46: ResizeArray<EnvHeap3>), (var_14: ResizeArray<EnvHeap4>), (var_15: ManagedCuda.BasicTypes.CUmodule), (var_16: EnvHeap4), (var_166: int64))
            let (var_168: EnvStack9) = EnvStack9((var_167: EnvHeap3))
            let (var_169: EnvHeap3) = var_168.mem_0
            ...
            // Cuda join point
            // method_33((var_164: uint64), (var_131: float32), (var_173: uint64))
            let (var_174: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_33", var_15, var_12)
            ...
            let (var_177: ManagedCuda.BasicTypes.CUstream) = method_23((var_64: (bool ref)), (var_65: ManagedCuda.CudaStream))
            let (var_179: (System.Object [])) = [|var_164; var_131; var_173|]: (System.Object [])
            var_174.RunAsync(var_177, var_179)
            let (var_180: int64) = 4L
            let (var_181: EnvHeap3) = method_18((var_38: EnvHeap10), (var_6: ManagedCuda.CudaBlas.CudaBlas), (var_7: ManagedCuda.CudaRand.CudaRandDevice), (var_8: EnvStack0), (var_9: uint64), (var_10: ResizeArray<Env1>), (var_11: ResizeArray<Env2>), (var_12: ManagedCuda.CudaContext), (var_46: ResizeArray<EnvHeap3>), (var_14: ResizeArray<EnvHeap4>), (var_15: ManagedCuda.BasicTypes.CUmodule), (var_16: EnvHeap4), (var_180: int64))
            let (var_182: EnvStack9) = EnvStack9((var_181: EnvHeap3))
            let (var_183: ManagedCuda.BasicTypes.CUstream) = method_23((var_64: (bool ref)), (var_65: ManagedCuda.CudaStream))
            ...
            method_35((var_182: EnvStack9), (var_192: int64), (var_193: float32))
            ...
            if var_61 then
                ...
                ()
            let (var_196: uint64) = method_5((var_106: (uint64 ref)))
            ...
            if var_61 then
                ...
                ()
            let (var_199: uint64) = method_5((var_126: (uint64 ref)))
            let (var_200: int64) =
                if var_111 then
                    var_110
                else
                    64L
            // Cuda join point
            // method_36((var_131: float32), (var_194: uint64), (var_195: uint64), (var_196: uint64), (var_198: uint64), (var_50: int64), (var_199: uint64))
            ...
            let (var_205: ManagedCuda.BasicTypes.CUstream) = method_23((var_64: (bool ref)), (var_65: ManagedCuda.CudaStream))
            let (var_207: (System.Object [])) = [|var_131; var_194; var_195; var_196; var_198; var_50; var_199|]: (System.Object [])
            var_201.RunAsync(var_205, var_207)
            if var_61 then
                (failwith "Tensor needs to be at least size 1.")
            else
                ()
            let (var_208: uint64) = method_5((var_86: (uint64 ref)))
            let (var_209: uint64) = method_5((var_126: (uint64 ref)))
            let (var_210: uint64) = method_5((var_106: (uint64 ref)))
            if var_61 then
                (failwith "Tensor needs to be at least size 1.")
            else
                ()
            ...
            let (var_212: int64) =
                if var_111 then
                    ...
                    64L
            // Cuda join point
            // method_37((var_208: uint64), (var_209: uint64), (var_210: uint64), (var_50: int64), (var_211: uint64))
            ...
            let (var_229: ManagedCuda.BasicTypes.CUstream) = method_23((var_64: (bool ref)), (var_65: ManagedCuda.CudaStream))
            let (var_231: (System.Object [])) = [|var_32; var_220; var_225|]: (System.Object [])
            var_226.RunAsync(var_229, var_231)
            let (var_232: EnvHeap3) = var_4.mem_0
            ...
            let (var_237: EnvHeap3) = var_5.mem_0
            ...
            let (var_245: ManagedCuda.BasicTypes.CUstream) = method_23((var_64: (bool ref)), (var_65: ManagedCuda.CudaStream))
            let (var_247: (System.Object [])) = [|var_236; var_241|]: (System.Object [])
            var_242.RunAsync(var_245, var_247)
            let (var_248: ManagedCuda.BasicTypes.CUstream) = method_23((var_64: (bool ref)), (var_65: ManagedCuda.CudaStream))
            ...
            let (var_254: uint64) = method_5((var_82: (uint64 ref)))
            // Cuda join point
            ...
            let (var_268: (float32 [])) = method_44((var_266: int64), (var_168: EnvStack9), (var_267: int64))
...
and method_47((var_0: EnvStack9), (var_1: EnvStack9), (var_2: EnvStack9), (var_3: EnvStack9), (var_4: EnvStack9), (var_5: EnvStack9), (var_6: ManagedCuda.CudaBlas.CudaBlas), (var_7: ManagedCuda.CudaRand.CudaRandDevice), (var_8: EnvStack0), (var_9: uint64), (var_10: ResizeArray<Env1>), (var_11: ResizeArray<Env2>), (var_12: ManagedCuda.CudaContext), (var_13: ResizeArray<EnvHeap3>), (var_14: ResizeArray<EnvHeap4>), (var_15: ManagedCuda.BasicTypes.CUmodule), (var_16: EnvHeap4), (var_17: int64), (var_18: float), (var_19: int64)): Env12 =
    ...
    if var_20 then
        ...
        if var_21 then
            ...
            let (var_135: uint64) = method_5((var_107: (uint64 ref)))
            let (var_136: EnvHeap3) = var_1.mem_0
            ...
            let (var_152: EnvHeap3) = method_18((var_39: EnvHeap10), (var_6: ManagedCuda.CudaBlas.CudaBlas), (var_7: ManagedCuda.CudaRand.CudaRandDevice), (var_8: EnvStack0), (var_9: uint64), (var_10: ResizeArray<Env1>), (var_11: ResizeArray<Env2>), (var_12: ManagedCuda.CudaContext), (var_47: ResizeArray<EnvHeap3>), (var_14: ResizeArray<EnvHeap4>), (var_15: ManagedCuda.BasicTypes.CUmodule), (var_16: EnvHeap4), (var_151: int64))
            let (var_153: EnvStack9) = EnvStack9((var_152: EnvHeap3))
            let (var_154: EnvHeap3) = var_153.mem_0
            ...
            // Cuda join point
            // method_31((var_135: uint64), (var_143: uint64), (var_51: int64), (var_158: uint64))
            let (var_159: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_31", var_15, var_12)
            ...
            let (var_164: (System.Object [])) = [|var_135; var_143; var_51; var_158|]: (System.Object [])
            var_159.RunAsync(var_162, var_164)
            let (var_165: uint64) = method_5((var_157: (uint64 ref)))
            let (var_167: int64) = 4L
            let (var_168: EnvHeap3) = method_18((var_39: EnvHeap10), (var_6: ManagedCuda.CudaBlas.CudaBlas), (var_7: ManagedCuda.CudaRand.CudaRandDevice), (var_8: EnvStack0), (var_9: uint64), (var_10: ResizeArray<Env1>), (var_11: ResizeArray<Env2>), (var_12: ManagedCuda.CudaContext), (var_47: ResizeArray<EnvHeap3>), (var_14: ResizeArray<EnvHeap4>), (var_15: ManagedCuda.BasicTypes.CUmodule), (var_16: EnvHeap4), (var_167: int64))
            let (var_169: EnvStack9) = EnvStack9((var_168: EnvHeap3))
            ...
            // Cuda join point
            // method_33((var_165: uint64), (var_132: float32), (var_174: uint64))
            let (var_175: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_33", var_15, var_12)
            ...
            let (var_178: ManagedCuda.BasicTypes.CUstream) = method_23((var_65: (bool ref)), (var_66: ManagedCuda.CudaStream))
            let (var_180: (System.Object [])) = [|var_165; var_132; var_174|]: (System.Object [])
            var_175.RunAsync(var_178, var_180)
            let (var_181: int64) = 4L
            let (var_182: EnvHeap3) = method_18((var_39: EnvHeap10), (var_6: ManagedCuda.CudaBlas.CudaBlas), (var_7: ManagedCuda.CudaRand.CudaRandDevice), (var_8: EnvStack0), (var_9: uint64), (var_10: ResizeArray<Env1>), (var_11: ResizeArray<Env2>), (var_12: ManagedCuda.CudaContext), (var_47: ResizeArray<EnvHeap3>), (var_14: ResizeArray<EnvHeap4>), (var_15: ManagedCuda.BasicTypes.CUmodule), (var_16: EnvHeap4), (var_181: int64))
            let (var_183: EnvStack9) = EnvStack9((var_182: EnvHeap3))
            let (var_184: ManagedCuda.BasicTypes.CUstream) = method_23((var_65: (bool ref)), (var_66: ManagedCuda.CudaStream))
            ...
            let (var_195: (float32 [])) = method_44((var_193: int64), (var_169: EnvStack9), (var_194: int64))
            ...
            let (var_202: EnvHeap3) = method_18((var_39: EnvHeap10), (var_6: ManagedCuda.CudaBlas.CudaBlas), (var_7: ManagedCuda.CudaRand.CudaRandDevice), (var_8: EnvStack0), (var_9: uint64), (var_10: ResizeArray<Env1>), (var_11: ResizeArray<Env2>), (var_12: ManagedCuda.CudaContext), (var_47: ResizeArray<EnvHeap3>), (var_14: ResizeArray<EnvHeap4>), (var_15: ManagedCuda.BasicTypes.CUmodule), (var_16: EnvHeap4), (var_201: int64))
            let (var_203: EnvStack9) = EnvStack9((var_202: EnvHeap3))
            let (var_204: uint64) = method_5((var_107: (uint64 ref)))
            let (var_205: uint64) = method_5((var_139: (uint64 ref)))
            let (var_206: uint64) = (var_205 + var_142)
            let (var_207: EnvHeap3) = var_203.mem_0
            ...
            // Cuda join point
            // method_48((var_33: int64), (var_204: uint64), (var_206: uint64), (var_211: uint64))
            let (var_212: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_48", var_15, var_12)
            ...
            let (var_215: ManagedCuda.BasicTypes.CUstream) = method_23((var_65: (bool ref)), (var_66: ManagedCuda.CudaStream))
...
and method_35((var_0: EnvStack9), (var_1: int64), (var_2: float32)): unit =
    ...
    var_4.Free()
and method_38((var_0: int32), (var_1: EnvStack9), (var_2: int64), (var_3: EnvStack9), (var_4: int64), (var_5: EnvStack9), (var_6: ManagedCuda.CudaBlas.CudaBlas), (var_7: ManagedCuda.CudaRand.CudaRandDevice), (var_8: EnvStack0), (var_9: uint64), (var_10: ResizeArray<Env1>), (var_11: ResizeArray<Env2>), (var_12: ManagedCuda.CudaContext), (var_13: ResizeArray<EnvHeap3>), (var_14: ResizeArray<EnvHeap4>), (var_15: ManagedCuda.BasicTypes.CUmodule), (var_16: EnvHeap4)): unit =
    let (var_17: ManagedCuda.CudaBlas.CudaBlasHandle) = var_6.get_CublasHandle()
    let (var_18: (int64 ref)) = var_16.mem_0
    let (var_19: EnvHeap5) = var_16.mem_1
    let (var_20: (bool ref)) = var_19.mem_0
...
and method_44((var_0: int64), (var_1: EnvStack9), (var_2: int64)): (float32 []) =
    ...
    var_12.Free()
    var_11
and method_51((var_0: int64), (var_1: EnvStack9), (var_2: int64), (var_3: int64)): (float32 []) =
    ...
    var_14.Free()
    var_13
and method_52((var_0: (float32 [])), (var_1: int64), (var_2: int64), (var_3: int64)): int64 =
    ...
    if var_4 then
        ...
        method_52((var_0: (float32 [])), (var_1: int64), (var_8: int64), (var_9: int64))
    else
        var_2
...
method_53((var_68: ResizeArray<EnvHeap4>))
