...
extern "C" {
    ...
    __device__ __forceinline__ Tuple5 make_Tuple5(float mem_0, float mem_1){
        Tuple5 tmp;
        tmp.mem_0 = mem_0;
        tmp.mem_1 = mem_1;
        return tmp;
    ...
    __device__ __forceinline__ Env4 make_Env4(long long int mem_0, Tuple5 mem_1){
        Env4 tmp;
        tmp.mem_0 = mem_0;
        tmp.mem_1 = mem_1;
        return tmp;
    ...
    __device__ __forceinline__ Tuple7 make_Tuple7(Tuple5 mem_0, Tuple5 mem_1){
        Tuple7 tmp;
        tmp.mem_0 = mem_0;
        tmp.mem_1 = mem_1;
        return tmp;
    }
    typedef Tuple5(*FunPointer6)(Tuple5, Tuple5);
    ...
    __device__ char method_28(Env3 * var_0);
    ...
    __device__ char method_42(Env4 * var_0);
    __device__ Tuple5 method_43(Tuple5 var_0, Tuple5 var_1);
    ...
    __global__ void method_27(long long int var_0, float * var_1, float * var_2) {
        ...
        while (method_17(var_11)) {
            ...
            Env3 var_47[1];
            var_47[0] = (make_Env3(32, var_45));
            while (method_28(var_47)) {
                Env3 var_49 = var_47[0];
                long long int var_50 = var_49.mem_0;
                float var_51 = var_49.mem_1;
                long long int var_52 = (var_50 / 2);
                char var_53 = (var_4 < var_50);
                char var_55;
                if (var_53) {
                    var_55 = (var_4 >= var_52);
                } else {
                ...
                if (var_55) {
                    ...
                    long long int var_66 = (var_61 + var_3);
                    var_46[var_66] = var_51;
                } else {
                }
                __syncthreads();
                char var_67 = (var_4 < var_52);
                float var_91;
                if (var_67) {
                    long long int var_68 = (var_4 + var_52);
                    Env1 var_69[1];
                    var_69[0] = (make_Env1(var_68, var_51));
                    while (method_21(var_50, var_69)) {
                        Env1 var_71 = var_69[0];
                        long long int var_72 = var_71.mem_0;
                        float var_73 = var_71.mem_1;
                        ...
                        long long int var_85 = (var_80 + var_3);
                        float var_86 = var_46[var_85];
                ...
                var_47[0] = (make_Env3(var_52, var_91));
            }
            Env3 var_92 = var_47[0];
            long long int var_93 = var_92.mem_0;
            float var_94 = var_92.mem_1;
            char var_95 = (var_4 == 0);
            if (var_95) {
                float var_96 = var_2[var_14];
                float var_97 = (var_94 + var_96);
                var_2[var_14] = var_97;
            } else {
            }
            var_11[0] = (make_Env0(var_15));
        }
        Env0 var_98 = var_11[0];
    ...
    __global__ void method_41(float * var_0, float * var_1, float * var_2) {
        ...
        while (method_35(var_10)) {
            ...
            float var_26 = 0;
            Env4 var_27[1];
            var_27[0] = (make_Env4(var_24, make_Tuple5(var_25, var_26)));
            while (method_42(var_27)) {
                Env4 var_29 = var_27[0];
                long long int var_30 = var_29.mem_0;
                Tuple5 var_31 = var_29.mem_1;
                ...
                Tuple5 var_43;
                if (var_42) {
                    var_43 = make_Tuple5(var_32, var_33);
                } else {
                    var_43 = make_Tuple5(var_40, var_41);
                }
                float var_44 = var_43.mem_0;
                float var_45 = var_43.mem_1;
                var_27[0] = (make_Env4(var_34, make_Tuple5(var_44, var_45)));
            }
            Env4 var_46 = var_27[0];
            long long int var_47 = var_46.mem_0;
            Tuple5 var_48 = var_46.mem_1;
            float var_49 = var_48.mem_0;
            float var_50 = var_48.mem_1;
            FunPointer6 var_53 = method_43;
            Tuple5 var_54 = cub::BlockReduce<Tuple5,10>().Reduce(make_Tuple5(var_49, var_50), var_53);
    ...
    __device__ Tuple5 method_43(Tuple5 var_0, Tuple5 var_1) {
        ...
        Tuple5 var_7;
        if (var_6) {
            var_7 = make_Tuple5(var_2, var_3);
        } else {
            var_7 = make_Tuple5(var_4, var_5);
        }
        float var_8 = var_7.mem_0;
        float var_9 = var_7.mem_1;
        return make_Tuple5(var_8, var_9);
    }
}
"""
