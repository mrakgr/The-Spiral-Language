...
extern "C" {
    ...
    __global__ void method_12(long long int * var_0, long long int * var_1, long long int * var_2);
    __device__ char method_9(Env0 * var_0);
    __device__ char method_10(Env1 * var_0);
    __device__ char method_11(Env1 * var_0);
    ...
    __global__ void method_8(long long int * var_0, long long int * var_1) {
        ...
        while (method_9(var_10)) {
            ...
            __shared__ long long int var_46[56];
            char var_47 = (var_2 >= 0);
            char var_49;
            if (var_47) {
                var_49 = (var_2 < 8);
            ...
            if (var_59) {
                ...
                while (method_11(var_60)) {
                    Env1 var_62 = var_60[0];
                    long long int var_63 = var_62.mem_0;
                    long long int var_64 = var_62.mem_1;
                    ...
                    long long int var_72 = var_46[var_71];
                    long long int var_73 = (var_64 + var_72);
                    var_60[0] = (make_Env1(var_65, var_73));
                }
                Env1 var_74 = var_60[0];
                long long int var_75 = var_74.mem_0;
                long long int var_76 = var_74.mem_1;
                long long int var_77 = var_1[var_13];
                long long int var_78 = (var_76 / 2);
                var_1[var_13] = var_78;
            } else {
            }
            var_10[0] = (make_Env0(var_14));
        }
        Env0 var_79 = var_10[0];
    ...
    __global__ void method_12(long long int * var_0, long long int * var_1, long long int * var_2) {
        ...
        while (method_9(var_11)) {
            ...
            while (method_10(var_26)) {
                ...
                long long int var_41 = var_0[var_40];
                long long int var_42 = var_1[var_14];
                long long int var_43 = (var_41 + var_42);
                long long int var_44 = (var_30 + var_43);
                var_26[0] = (make_Env1(var_31, var_44));
            }
            Env1 var_45 = var_26[0];
            long long int var_46 = var_45.mem_0;
            long long int var_47 = var_45.mem_1;
            __shared__ long long int var_48[56];
            char var_49 = (var_3 >= 0);
            char var_51;
            if (var_49) {
                var_51 = (var_3 < 8);
            ...
            if (var_54) {
                ...
                long long int var_59 = (var_4 - 1);
                long long int var_60 = (var_53 + var_59);
                var_48[var_60] = var_47;
            } else {
            }
            __syncthreads();
            char var_61 = (var_4 == 0);
            if (var_61) {
                Env1 var_62[1];
                var_62[0] = (make_Env1(1, var_47));
                while (method_11(var_62)) {
                    Env1 var_64 = var_62[0];
                    long long int var_65 = var_64.mem_0;
                    long long int var_66 = var_64.mem_1;
                    long long int var_67 = (var_65 + 1);
                    char var_68 = (var_65 >= 1);
                    char var_70;
                    if (var_68) {
                        var_70 = (var_65 < 8);
                    } else {
                    ...
                    long long int var_72 = (var_65 - 1);
                    long long int var_73 = (var_53 + var_72);
                    long long int var_74 = var_48[var_73];
                    long long int var_75 = (var_66 + var_74);
                    var_62[0] = (make_Env1(var_67, var_75));
                }
                Env1 var_76 = var_62[0];
                long long int var_77 = var_76.mem_0;
                long long int var_78 = var_76.mem_1;
                long long int var_79 = var_2[var_14];
                long long int var_80 = (var_78 / 2);
                var_2[var_14] = var_80;
            } else {
            }
            var_11[0] = (make_Env0(var_15));
        }
        Env0 var_81 = var_11[0];
        long long int var_82 = var_81.mem_0;
    }
    __device__ char method_9(Env0 * var_0) {
        Env0 var_1 = var_0[0];
...
and method_13((var_0: ManagedCuda.CudaContext), (var_1: ManagedCuda.CudaStream), (var_2: uint64), (var_3: uint64), (var_4: System.Collections.Generic.Stack<Env3>), (var_5: EnvStack2), (var_6: int64), (var_7: int64), (var_8: int64), (var_9: int64), (var_10: int64), (var_11: int64), (var_12: int64), (var_13: int64)): unit =
    ...
    let (var_27: (int64 [])) = Array.zeroCreate<int64> (System.Convert.ToInt32(var_16))
    ...
    method_15((var_28: System.Text.StringBuilder), (var_29: string), (var_27: (int64 [])), (var_6: int64), (var_7: int64), (var_8: int64), (var_9: int64), (var_10: int64), (var_11: int64), (var_12: int64), (var_13: int64))
    let (var_32: int64) = 0L
...
let (var_52: (int64 [])) = Array.zeroCreate<int64> (System.Convert.ToInt32(256L))
let (var_53: int64) = 0L
method_2((var_52: (int64 [])), (var_53: int64))
let (var_54: (int64 [])) = Array.zeroCreate<int64> (System.Convert.ToInt32(8L))
let (var_55: int64) = 0L
...
let (var_74: (System.Object [])) = [|var_70; var_72|]: (System.Object [])
let (var_75: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_8", var_32, var_1)
let (var_76: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(1u, 1u, 1u)
var_75.set_GridDimensions(var_76)
let (var_77: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(8u, 8u, 1u)
var_75.set_BlockDimensions(var_77)
let (var_78: ManagedCuda.BasicTypes.CUstream) = var_51.get_Stream()
var_75.RunAsync(var_78, var_74)
let (var_81: int64) = 64L
...
// Cuda join point
// method_12((var_83: ManagedCuda.BasicTypes.CUdeviceptr), (var_84: ManagedCuda.BasicTypes.CUdeviceptr), (var_86: ManagedCuda.BasicTypes.CUdeviceptr))
let (var_88: (System.Object [])) = [|var_83; var_84; var_86|]: (System.Object [])
let (var_89: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_12", var_32, var_1)
let (var_90: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(1u, 1u, 1u)
var_89.set_GridDimensions(var_90)
let (var_91: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(8u, 8u, 1u)
...
method_13((var_1: ManagedCuda.CudaContext), (var_51: ManagedCuda.CudaStream), (var_49: uint64), (var_50: uint64), (var_45: System.Collections.Generic.Stack<Env3>), (var_58: EnvStack2), (var_93: int64), (var_94: int64), (var_95: int64), (var_96: int64), (var_97: int64), (var_98: int64), (var_99: int64), (var_100: int64))
let (var_101: int64) = 0L
let (var_102: int64) = 1L
let (var_103: int64) = 0L
let (var_104: int64) = 8L
method_20((var_1: ManagedCuda.CudaContext), (var_51: ManagedCuda.CudaStream), (var_49: uint64), (var_50: uint64), (var_45: System.Collections.Generic.Stack<Env3>), (var_69: EnvStack2), (var_101: int64), (var_102: int64), (var_103: int64), (var_104: int64))
let (var_105: int64) = 0L
let (var_106: int64) = 1L
let (var_107: int64) = 0L
let (var_108: int64) = 8L
method_20((var_1: ManagedCuda.CudaContext), (var_51: ManagedCuda.CudaStream), (var_49: uint64), (var_50: uint64), (var_45: System.Collections.Generic.Stack<Env3>), (var_82: EnvStack2), (var_105: int64), (var_106: int64), (var_107: int64), (var_108: int64))
var_85 := Union0Case1
var_71 := Union0Case1
var_64 := Union0Case1
var_59 := Union0Case1
var_51.Dispose()
let (var_109: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_46: (Union0 ref)))
var_1.FreeMemory(var_109)
var_46 := Union0Case1
var_1.Dispose()
