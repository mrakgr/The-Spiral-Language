...
extern "C" {
    ...
    __global__ void method_16(unsigned char * var_0, float * var_1) {
        ...
        while (method_17(var_6)) {
            ...
            long long int var_11 = (var_10 % 1115394);
            long long int var_12 = (var_10 / 1115394);
            char var_13 = (var_11 >= 0);
            char var_15;
            if (var_13) {
                var_15 = (var_11 < 1115394);
            } else {
                var_15 = 0;
            }
            ...
            long long int var_17 = (var_11 * 128);
            char var_19;
            if (var_13) {
                var_19 = (var_11 < 1115394);
            } else {
                var_19 = 0;
            }
            ...
            unsigned char var_21 = var_0[var_11];
            long long int var_22[1];
            var_22[0] = var_9;
            while (method_18(var_22)) {
                long long int var_24 = var_22[0];
                unsigned char var_25 = ((unsigned char) (var_24));
                char var_26 = (var_21 == var_25);
                float var_27;
                if (var_26) {
                    var_27 = 1;
                } else {
                ...
                long long int var_32 = (var_17 + var_24);
                var_1[var_32] = var_27;
                long long int var_33 = (var_24 + 32);
                var_22[0] = var_33;
            }
            long long int var_34 = var_22[0];
            long long int var_35 = (var_8 + 35692800);
            var_6[0] = var_35;
        }
        long long int var_36 = var_6[0];
    }
    __global__ void method_23(float * var_0, float * var_1, float * var_2) {
...
and method_20((var_0: ManagedCuda.CudaBlas.CudaBlas), (var_1: ManagedCuda.CudaRand.CudaRandDevice), (var_2: EnvStack0), (var_3: uint64), (var_4: ResizeArray<Env1>), (var_5: ResizeArray<Env2>), (var_6: ManagedCuda.CudaContext), (var_7: ResizeArray<EnvHeap3>), (var_8: ResizeArray<EnvHeap4>), (var_9: ManagedCuda.BasicTypes.CUmodule), (var_10: EnvHeap4), (var_11: EnvStack9), (var_12: EnvStack9), (var_13: EnvStack9), (var_14: EnvStack9), (var_15: EnvStack9), (var_16: EnvStack9), (var_17: EnvStack9), (var_18: int64)): unit =
    ...
    if var_19 then
        ...
        let (var_22: int64) = 0L
        let (var_23: float) = method_21((var_11: EnvStack9), (var_0: ManagedCuda.CudaBlas.CudaBlas), (var_1: ManagedCuda.CudaRand.CudaRandDevice), (var_2: EnvStack0), (var_3: uint64), (var_4: ResizeArray<Env1>), (var_5: ResizeArray<Env2>), (var_6: ManagedCuda.CudaContext), (var_7: ResizeArray<EnvHeap3>), (var_8: ResizeArray<EnvHeap4>), (var_9: ManagedCuda.BasicTypes.CUmodule), (var_10: EnvHeap4), (var_20: int64), (var_21: float), (var_12: EnvStack9), (var_13: EnvStack9), (var_14: EnvStack9), (var_15: EnvStack9), (var_16: EnvStack9), (var_17: EnvStack9), (var_22: int64))
        ...
        if (System.Double.IsNaN var_23) then
            ...
            method_20((var_0: ManagedCuda.CudaBlas.CudaBlas), (var_1: ManagedCuda.CudaRand.CudaRandDevice), (var_2: EnvStack0), (var_3: uint64), (var_4: ResizeArray<Env1>), (var_5: ResizeArray<Env2>), (var_6: ManagedCuda.CudaContext), (var_7: ResizeArray<EnvHeap3>), (var_8: ResizeArray<EnvHeap4>), (var_9: ManagedCuda.BasicTypes.CUmodule), (var_10: EnvHeap4), (var_11: EnvStack9), (var_12: EnvStack9), (var_13: EnvStack9), (var_14: EnvStack9), (var_15: EnvStack9), (var_16: EnvStack9), (var_17: EnvStack9), (var_26: int64))
    else
        ()
and method_50((var_0: ResizeArray<EnvHeap4>)): unit =
    let (var_2: (EnvHeap4 -> unit)) = method_51
...
and method_21((var_0: EnvStack9), (var_1: ManagedCuda.CudaBlas.CudaBlas), (var_2: ManagedCuda.CudaRand.CudaRandDevice), (var_3: EnvStack0), (var_4: uint64), (var_5: ResizeArray<Env1>), (var_6: ResizeArray<Env2>), (var_7: ManagedCuda.CudaContext), (var_8: ResizeArray<EnvHeap3>), (var_9: ResizeArray<EnvHeap4>), (var_10: ManagedCuda.BasicTypes.CUmodule), (var_11: EnvHeap4), (var_12: int64), (var_13: float), (var_14: EnvStack9), (var_15: EnvStack9), (var_16: EnvStack9), (var_17: EnvStack9), (var_18: EnvStack9), (var_19: EnvStack9), (var_20: int64)): float =
    ...
    if var_21 then
        ...
        if var_23 then
            ...
            ()
        let (var_24: int64) = (var_20 * 8192L)
        if var_23 then
            (failwith "Argument out of bounds.")
        else
            ()
        let (var_25: int64) = (8192L + var_24)
        ...
        let (var_136: EnvHeap3) = method_11((var_26: EnvHeap8), (var_1: ManagedCuda.CudaBlas.CudaBlas), (var_2: ManagedCuda.CudaRand.CudaRandDevice), (var_3: EnvStack0), (var_4: uint64), (var_5: ResizeArray<Env1>), (var_6: ResizeArray<Env2>), (var_7: ManagedCuda.CudaContext), (var_34: ResizeArray<EnvHeap3>), (var_9: ResizeArray<EnvHeap4>), (var_10: ManagedCuda.BasicTypes.CUmodule), (var_11: EnvHeap4), (var_135: int64))
        let (var_137: EnvStack9) = EnvStack9((var_136: EnvHeap3))
        method_22((var_17: EnvStack9), (var_0: EnvStack9), (var_24: int64), (var_137: EnvStack9), (var_1: ManagedCuda.CudaBlas.CudaBlas), (var_2: ManagedCuda.CudaRand.CudaRandDevice), (var_3: EnvStack0), (var_4: uint64), (var_5: ResizeArray<Env1>), (var_6: ResizeArray<Env2>), (var_7: ManagedCuda.CudaContext), (var_34: ResizeArray<EnvHeap3>), (var_9: ResizeArray<EnvHeap4>), (var_10: ManagedCuda.BasicTypes.CUmodule), (var_11: EnvHeap4))
        let (var_138: EnvHeap3) = var_137.mem_0
        let (var_139: int64) = 512L
        let (var_140: EnvHeap3) = method_11((var_26: EnvHeap8), (var_1: ManagedCuda.CudaBlas.CudaBlas), (var_2: ManagedCuda.CudaRand.CudaRandDevice), (var_3: EnvStack0), (var_4: uint64), (var_5: ResizeArray<Env1>), (var_6: ResizeArray<Env2>), (var_7: ManagedCuda.CudaContext), (var_34: ResizeArray<EnvHeap3>), (var_9: ResizeArray<EnvHeap4>), (var_10: ManagedCuda.BasicTypes.CUmodule), (var_11: EnvHeap4), (var_139: int64))
        let (var_141: EnvStack9) = EnvStack9((var_140: EnvHeap3))
        ...
        let (var_155: EnvHeap3) = var_15.mem_0
        ...
        // Cuda join point
        // method_23((var_159: uint64), (var_163: uint64), (var_164: uint64))
        let (var_165: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_23", var_10, var_7)
        ...
        let (var_176: EnvHeap3) = method_11((var_26: EnvHeap8), (var_1: ManagedCuda.CudaBlas.CudaBlas), (var_2: ManagedCuda.CudaRand.CudaRandDevice), (var_3: EnvStack0), (var_4: uint64), (var_5: ResizeArray<Env1>), (var_6: ResizeArray<Env2>), (var_7: ManagedCuda.CudaContext), (var_34: ResizeArray<EnvHeap3>), (var_9: ResizeArray<EnvHeap4>), (var_10: ManagedCuda.BasicTypes.CUmodule), (var_11: EnvHeap4), (var_175: int64))
        ...
        // Cuda join point
        // method_25((var_178: uint64), (var_183: uint64))
        let (var_184: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_25", var_10, var_7)
        ...
        let (var_191: EnvHeap3) = method_11((var_26: EnvHeap8), (var_1: ManagedCuda.CudaBlas.CudaBlas), (var_2: ManagedCuda.CudaRand.CudaRandDevice), (var_3: EnvStack0), (var_4: uint64), (var_5: ResizeArray<Env1>), (var_6: ResizeArray<Env2>), (var_7: ManagedCuda.CudaContext), (var_34: ResizeArray<EnvHeap3>), (var_9: ResizeArray<EnvHeap4>), (var_10: ManagedCuda.BasicTypes.CUmodule), (var_11: EnvHeap4), (var_190: int64))
        let (var_192: EnvStack9) = EnvStack9((var_191: EnvHeap3))
        ...
        let (var_207: int64) = (var_25 * 4L)
        let (var_208: uint64) = (uint64 var_207)
        let (var_209: uint64) = (var_206 + var_208)
        let (var_217: int64) = 4L
        let (var_218: EnvHeap3) = method_11((var_26: EnvHeap8), (var_1: ManagedCuda.CudaBlas.CudaBlas), (var_2: ManagedCuda.CudaRand.CudaRandDevice), (var_3: EnvStack0), (var_4: uint64), (var_5: ResizeArray<Env1>), (var_6: ResizeArray<Env2>), (var_7: ManagedCuda.CudaContext), (var_34: ResizeArray<EnvHeap3>), (var_9: ResizeArray<EnvHeap4>), (var_10: ManagedCuda.BasicTypes.CUmodule), (var_11: EnvHeap4), (var_217: int64))
        ...
        // Cuda join point
        // method_26((var_202: uint64), (var_209: uint64), (var_224: uint64))
        let (var_225: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_26", var_10, var_7)
        ...
        let (var_231: (unit -> unit)) = method_28((var_141: EnvStack9), (var_137: EnvStack9), (var_14: EnvStack9), (var_15: EnvStack9), (var_0: EnvStack9), (var_24: int64), (var_16: EnvStack9), (var_17: EnvStack9), (var_1: ManagedCuda.CudaBlas.CudaBlas), (var_2: ManagedCuda.CudaRand.CudaRandDevice), (var_3: EnvStack0), (var_4: uint64), (var_5: ResizeArray<Env1>), (var_6: ResizeArray<Env2>), (var_7: ManagedCuda.CudaContext), (var_34: ResizeArray<EnvHeap3>), (var_9: ResizeArray<EnvHeap4>), (var_10: ManagedCuda.BasicTypes.CUmodule), (var_11: EnvHeap4), (var_192: EnvStack9), (var_177: EnvStack9), (var_219: EnvStack9), (var_25: int64))
        let (var_232: (unit -> float32)) = method_34((var_219: EnvStack9), (var_1: ManagedCuda.CudaBlas.CudaBlas), (var_2: ManagedCuda.CudaRand.CudaRandDevice), (var_3: EnvStack0), (var_4: uint64), (var_5: ResizeArray<Env1>), (var_6: ResizeArray<Env2>), (var_7: ManagedCuda.CudaContext), (var_34: ResizeArray<EnvHeap3>), (var_9: ResizeArray<EnvHeap4>), (var_10: ManagedCuda.BasicTypes.CUmodule), (var_11: EnvHeap4))
        let (var_322: int64) = 1L
        method_41((var_0: EnvStack9), (var_24: int64), (var_25: int64), (var_14: EnvStack9), (var_15: EnvStack9), (var_16: EnvStack9), (var_17: EnvStack9), (var_18: EnvStack9), (var_19: EnvStack9), (var_1: ManagedCuda.CudaBlas.CudaBlas), (var_2: ManagedCuda.CudaRand.CudaRandDevice), (var_3: EnvStack0), (var_4: uint64), (var_5: ResizeArray<Env1>), (var_6: ResizeArray<Env2>), (var_7: ManagedCuda.CudaContext), (var_34: ResizeArray<EnvHeap3>), (var_9: ResizeArray<EnvHeap4>), (var_10: ManagedCuda.BasicTypes.CUmodule), (var_11: EnvHeap4), (var_12: int64), (var_13: float), (var_20: int64), (var_8: ResizeArray<EnvHeap3>), (var_232: (unit -> float32)), (var_231: (unit -> unit)), (var_192: EnvStack9), (var_177: EnvStack9), (var_322: int64))
    else
        let (var_324: float) = (float var_12)
        (var_13 / var_324)
and method_51 ((var_0: EnvHeap4)): unit =
...
and method_28 ((var_0: EnvStack9), (var_1: EnvStack9), (var_2: EnvStack9), (var_3: EnvStack9), (var_4: EnvStack9), (var_5: int64), (var_6: EnvStack9), (var_7: EnvStack9), (var_8: ManagedCuda.CudaBlas.CudaBlas), (var_9: ManagedCuda.CudaRand.CudaRandDevice), (var_10: EnvStack0), (var_11: uint64), (var_12: ResizeArray<Env1>), (var_13: ResizeArray<Env2>), (var_14: ManagedCuda.CudaContext), (var_15: ResizeArray<EnvHeap3>), (var_16: ResizeArray<EnvHeap4>), (var_17: ManagedCuda.BasicTypes.CUmodule), (var_18: EnvHeap4), (var_19: EnvStack9), (var_20: EnvStack9), (var_21: EnvStack9), (var_22: int64)) (): unit =
...
and method_34 ((var_0: EnvStack9), (var_1: ManagedCuda.CudaBlas.CudaBlas), (var_2: ManagedCuda.CudaRand.CudaRandDevice), (var_3: EnvStack0), (var_4: uint64), (var_5: ResizeArray<Env1>), (var_6: ResizeArray<Env2>), (var_7: ManagedCuda.CudaContext), (var_8: ResizeArray<EnvHeap3>), (var_9: ResizeArray<EnvHeap4>), (var_10: ManagedCuda.BasicTypes.CUmodule), (var_11: EnvHeap4)) (): float32 =
    let (var_12: int64) = 1L
    let (var_13: int64) = 0L
    let (var_14: (float32 [])) = method_35((var_12: int64), (var_0: EnvStack9), (var_13: int64))
    var_14.[int32 0L]
and method_41((var_0: EnvStack9), (var_1: int64), (var_2: int64), (var_3: EnvStack9), (var_4: EnvStack9), (var_5: EnvStack9), (var_6: EnvStack9), (var_7: EnvStack9), (var_8: EnvStack9), (var_9: ManagedCuda.CudaBlas.CudaBlas), (var_10: ManagedCuda.CudaRand.CudaRandDevice), (var_11: EnvStack0), (var_12: uint64), (var_13: ResizeArray<Env1>), (var_14: ResizeArray<Env2>), (var_15: ManagedCuda.CudaContext), (var_16: ResizeArray<EnvHeap3>), (var_17: ResizeArray<EnvHeap4>), (var_18: ManagedCuda.BasicTypes.CUmodule), (var_19: EnvHeap4), (var_20: int64), (var_21: float), (var_22: int64), (var_23: ResizeArray<EnvHeap3>), (var_24: (unit -> float32)), (var_25: (unit -> unit)), (var_26: EnvStack9), (var_27: EnvStack9), (var_28: int64)): float =
    ...
    if var_29 then
        ...
        let (var_37: EnvHeap8) = ({mem_0 = (var_11: EnvStack0); mem_1 = (var_12: uint64); mem_2 = (var_13: ResizeArray<Env1>); mem_3 = (var_14: ResizeArray<Env2>)} : EnvHeap8)
        let (var_38: EnvHeap3) = method_11((var_37: EnvHeap8), (var_9: ManagedCuda.CudaBlas.CudaBlas), (var_10: ManagedCuda.CudaRand.CudaRandDevice), (var_11: EnvStack0), (var_12: uint64), (var_13: ResizeArray<Env1>), (var_14: ResizeArray<Env2>), (var_15: ManagedCuda.CudaContext), (var_16: ResizeArray<EnvHeap3>), (var_17: ResizeArray<EnvHeap4>), (var_18: ManagedCuda.BasicTypes.CUmodule), (var_19: EnvHeap4), (var_36: int64))
        let (var_39: EnvStack9) = EnvStack9((var_38: EnvHeap3))
        method_22((var_6: EnvStack9), (var_0: EnvStack9), (var_33: int64), (var_39: EnvStack9), (var_9: ManagedCuda.CudaBlas.CudaBlas), (var_10: ManagedCuda.CudaRand.CudaRandDevice), (var_11: EnvStack0), (var_12: uint64), (var_13: ResizeArray<Env1>), (var_14: ResizeArray<Env2>), (var_15: ManagedCuda.CudaContext), (var_16: ResizeArray<EnvHeap3>), (var_17: ResizeArray<EnvHeap4>), (var_18: ManagedCuda.BasicTypes.CUmodule), (var_19: EnvHeap4))
        let (var_40: EnvHeap3) = var_39.mem_0
        let (var_41: int64) = 512L
        let (var_42: EnvHeap3) = method_11((var_37: EnvHeap8), (var_9: ManagedCuda.CudaBlas.CudaBlas), (var_10: ManagedCuda.CudaRand.CudaRandDevice), (var_11: EnvStack0), (var_12: uint64), (var_13: ResizeArray<Env1>), (var_14: ResizeArray<Env2>), (var_15: ManagedCuda.CudaContext), (var_16: ResizeArray<EnvHeap3>), (var_17: ResizeArray<EnvHeap4>), (var_18: ManagedCuda.BasicTypes.CUmodule), (var_19: EnvHeap4), (var_41: int64))
        ...
        method_36((var_8: EnvStack9), (var_27: EnvStack9), (var_39: EnvStack9), (var_9: ManagedCuda.CudaBlas.CudaBlas), (var_10: ManagedCuda.CudaRand.CudaRandDevice), (var_11: EnvStack0), (var_12: uint64), (var_13: ResizeArray<Env1>), (var_14: ResizeArray<Env2>), (var_15: ManagedCuda.CudaContext), (var_16: ResizeArray<EnvHeap3>), (var_17: ResizeArray<EnvHeap4>), (var_18: ManagedCuda.BasicTypes.CUmodule), (var_19: EnvHeap4))
        ...
        // Cuda join point
        // method_25((var_80: uint64), (var_85: uint64))
        let (var_86: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_25", var_18, var_15)
        ...
        // Cuda join point
        // method_26((var_104: uint64), (var_111: uint64), (var_126: uint64))
        let (var_127: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_26", var_18, var_15)
        ...
        let (var_133: (unit -> unit)) = method_37((var_25: (unit -> unit)), (var_43: EnvStack9), (var_39: EnvStack9), (var_3: EnvStack9), (var_4: EnvStack9), (var_0: EnvStack9), (var_33: int64), (var_5: EnvStack9), (var_6: EnvStack9), (var_26: EnvStack9), (var_27: EnvStack9), (var_7: EnvStack9), (var_8: EnvStack9), (var_9: ManagedCuda.CudaBlas.CudaBlas), (var_10: ManagedCuda.CudaRand.CudaRandDevice), (var_11: EnvStack0), (var_12: uint64), (var_13: ResizeArray<Env1>), (var_14: ResizeArray<Env2>), (var_15: ManagedCuda.CudaContext), (var_16: ResizeArray<EnvHeap3>), (var_17: ResizeArray<EnvHeap4>), (var_18: ManagedCuda.BasicTypes.CUmodule), (var_19: EnvHeap4), (var_94: EnvStack9), (var_79: EnvStack9), (var_121: EnvStack9), (var_34: int64))
        let (var_134: (unit -> float32)) = method_40((var_121: EnvStack9), (var_9: ManagedCuda.CudaBlas.CudaBlas), (var_10: ManagedCuda.CudaRand.CudaRandDevice), (var_11: EnvStack0), (var_12: uint64), (var_13: ResizeArray<Env1>), (var_14: ResizeArray<Env2>), (var_15: ManagedCuda.CudaContext), (var_16: ResizeArray<EnvHeap3>), (var_17: ResizeArray<EnvHeap4>), (var_18: ManagedCuda.BasicTypes.CUmodule), (var_19: EnvHeap4), (var_24: (unit -> float32)))
        let (var_135: int64) = (var_28 + 1L)
        method_41((var_0: EnvStack9), (var_1: int64), (var_2: int64), (var_3: EnvStack9), (var_4: EnvStack9), (var_5: EnvStack9), (var_6: EnvStack9), (var_7: EnvStack9), (var_8: EnvStack9), (var_9: ManagedCuda.CudaBlas.CudaBlas), (var_10: ManagedCuda.CudaRand.CudaRandDevice), (var_11: EnvStack0), (var_12: uint64), (var_13: ResizeArray<Env1>), (var_14: ResizeArray<Env2>), (var_15: ManagedCuda.CudaContext), (var_16: ResizeArray<EnvHeap3>), (var_17: ResizeArray<EnvHeap4>), (var_18: ManagedCuda.BasicTypes.CUmodule), (var_19: EnvHeap4), (var_20: int64), (var_21: float), (var_22: int64), (var_23: ResizeArray<EnvHeap3>), (var_134: (unit -> float32)), (var_133: (unit -> unit)), (var_94: EnvStack9), (var_79: EnvStack9), (var_135: int64))
    else
        ...
        if (System.Double.IsNaN var_139) then
            method_42((var_16: ResizeArray<EnvHeap3>))
            method_42((var_16: ResizeArray<EnvHeap3>))
            let (var_151: float) = (float var_150)
            (var_139 / var_151)
        else
            var_25()
            let (var_153: EnvHeap3) = var_4.mem_0
            ...
            let (var_158: EnvHeap3) = var_3.mem_0
            ...
            // Cuda join point
            // method_44((var_157: uint64), (var_162: uint64))
            let (var_163: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_44", var_18, var_15)
            ...
            let (var_166: (int64 ref)) = var_19.mem_0
            let (var_167: EnvHeap5) = var_19.mem_1
            let (var_168: (bool ref)) = var_167.mem_0
            let (var_169: ManagedCuda.CudaStream) = var_167.mem_1
            let (var_170: ManagedCuda.BasicTypes.CUstream) = method_19((var_168: (bool ref)), (var_169: ManagedCuda.CudaStream))
            let (var_172: (System.Object [])) = [|var_157; var_162|]: (System.Object [])
            var_163.RunAsync(var_170, var_172)
            let (var_173: EnvHeap3) = var_6.mem_0
            ...
            let (var_178: EnvHeap3) = var_5.mem_0
            ...
            // Cuda join point
            // method_45((var_177: uint64), (var_182: uint64))
            let (var_183: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_45", var_18, var_15)
            let (var_184: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(64u, 1u, 1u)
            var_183.set_GridDimensions(var_184)
            let (var_185: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(128u, 1u, 1u)
            var_183.set_BlockDimensions(var_185)
            let (var_186: ManagedCuda.BasicTypes.CUstream) = method_19((var_168: (bool ref)), (var_169: ManagedCuda.CudaStream))
            let (var_188: (System.Object [])) = [|var_177; var_182|]: (System.Object [])
            var_183.RunAsync(var_186, var_188)
            let (var_189: EnvHeap3) = var_8.mem_0
            let (var_190: (int64 ref)) = var_189.mem_0
            let (var_191: EnvStack0) = var_189.mem_1
            let (var_192: (uint64 ref)) = var_191.mem_0
            let (var_193: uint64) = method_5((var_192: (uint64 ref)))
            let (var_194: EnvHeap3) = var_7.mem_0
            let (var_195: (int64 ref)) = var_194.mem_0
            let (var_196: EnvStack0) = var_194.mem_1
            let (var_197: (uint64 ref)) = var_196.mem_0
            let (var_198: uint64) = method_5((var_197: (uint64 ref)))
            // Cuda join point
            // method_45((var_193: uint64), (var_198: uint64))
            let (var_199: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_45", var_18, var_15)
            let (var_200: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(64u, 1u, 1u)
            var_199.set_GridDimensions(var_200)
            let (var_201: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(128u, 1u, 1u)
            var_199.set_BlockDimensions(var_201)
            let (var_202: ManagedCuda.BasicTypes.CUstream) = method_19((var_168: (bool ref)), (var_169: ManagedCuda.CudaStream))
            let (var_204: (System.Object [])) = [|var_193; var_198|]: (System.Object [])
            var_199.RunAsync(var_202, var_204)
            method_42((var_16: ResizeArray<EnvHeap3>))
            let (var_205: int64) = (var_22 + 1L)
            method_47((var_0: EnvStack9), (var_9: ManagedCuda.CudaBlas.CudaBlas), (var_10: ManagedCuda.CudaRand.CudaRandDevice), (var_11: EnvStack0), (var_12: uint64), (var_13: ResizeArray<Env1>), (var_14: ResizeArray<Env2>), (var_15: ManagedCuda.CudaContext), (var_23: ResizeArray<EnvHeap3>), (var_17: ResizeArray<EnvHeap4>), (var_18: ManagedCuda.BasicTypes.CUmodule), (var_19: EnvHeap4), (var_150: int64), (var_139: float), (var_3: EnvStack9), (var_4: EnvStack9), (var_5: EnvStack9), (var_6: EnvStack9), (var_7: EnvStack9), (var_8: EnvStack9), (var_16: ResizeArray<EnvHeap3>), (var_27: EnvStack9), (var_205: int64))
and method_14 ((var_1: uint64)) ((var_0: Env1)): int32 =
    ...
    if var_4 then
        ...
        if var_5 then
            ...
            1
and method_31((var_0: EnvStack9), (var_1: EnvStack9), (var_2: int64), (var_3: EnvStack9), (var_4: ManagedCuda.CudaBlas.CudaBlas), (var_5: ManagedCuda.CudaRand.CudaRandDevice), (var_6: EnvStack0), (var_7: uint64), (var_8: ResizeArray<Env1>), (var_9: ResizeArray<Env2>), (var_10: ManagedCuda.CudaContext), (var_11: ResizeArray<EnvHeap3>), (var_12: ResizeArray<EnvHeap4>), (var_13: ManagedCuda.BasicTypes.CUmodule), (var_14: EnvHeap4)): unit =
    let (var_15: ManagedCuda.CudaBlas.CudaBlasHandle) = var_4.get_CublasHandle()
    let (var_16: (int64 ref)) = var_14.mem_0
    let (var_17: EnvHeap5) = var_14.mem_1
    let (var_18: (bool ref)) = var_17.mem_0
    ...
    if var_49 <> ManagedCuda.CudaBlas.CublasStatus.Success then raise <| new ManagedCuda.CudaBlas.CudaBlasException(var_49)
and method_35((var_0: int64), (var_1: EnvStack9), (var_2: int64)): (float32 []) =
    ...
    var_12.Free()
    var_11
and method_36((var_0: EnvStack9), (var_1: EnvStack9), (var_2: EnvStack9), (var_3: ManagedCuda.CudaBlas.CudaBlas), (var_4: ManagedCuda.CudaRand.CudaRandDevice), (var_5: EnvStack0), (var_6: uint64), (var_7: ResizeArray<Env1>), (var_8: ResizeArray<Env2>), (var_9: ManagedCuda.CudaContext), (var_10: ResizeArray<EnvHeap3>), (var_11: ResizeArray<EnvHeap4>), (var_12: ManagedCuda.BasicTypes.CUmodule), (var_13: EnvHeap4)): unit =
...
and method_37 ((var_0: (unit -> unit)), (var_1: EnvStack9), (var_2: EnvStack9), (var_3: EnvStack9), (var_4: EnvStack9), (var_5: EnvStack9), (var_6: int64), (var_7: EnvStack9), (var_8: EnvStack9), (var_9: EnvStack9), (var_10: EnvStack9), (var_11: EnvStack9), (var_12: EnvStack9), (var_13: ManagedCuda.CudaBlas.CudaBlas), (var_14: ManagedCuda.CudaRand.CudaRandDevice), (var_15: EnvStack0), (var_16: uint64), (var_17: ResizeArray<Env1>), (var_18: ResizeArray<Env2>), (var_19: ManagedCuda.CudaContext), (var_20: ResizeArray<EnvHeap3>), (var_21: ResizeArray<EnvHeap4>), (var_22: ManagedCuda.BasicTypes.CUmodule), (var_23: EnvHeap4), (var_24: EnvStack9), (var_25: EnvStack9), (var_26: EnvStack9), (var_27: int64)) (): unit =
    ...
    method_31((var_1: EnvStack9), (var_5: EnvStack9), (var_6: int64), (var_7: EnvStack9), (var_13: ManagedCuda.CudaBlas.CudaBlas), (var_14: ManagedCuda.CudaRand.CudaRandDevice), (var_15: EnvStack0), (var_16: uint64), (var_17: ResizeArray<Env1>), (var_18: ResizeArray<Env2>), (var_19: ManagedCuda.CudaContext), (var_20: ResizeArray<EnvHeap3>), (var_21: ResizeArray<EnvHeap4>), (var_22: ManagedCuda.BasicTypes.CUmodule), (var_23: EnvHeap4))
    method_38((var_12: EnvStack9), (var_1: EnvStack9), (var_9: EnvStack9), (var_13: ManagedCuda.CudaBlas.CudaBlas), (var_14: ManagedCuda.CudaRand.CudaRandDevice), (var_15: EnvStack0), (var_16: uint64), (var_17: ResizeArray<Env1>), (var_18: ResizeArray<Env2>), (var_19: ManagedCuda.CudaContext), (var_20: ResizeArray<EnvHeap3>), (var_21: ResizeArray<EnvHeap4>), (var_22: ManagedCuda.BasicTypes.CUmodule), (var_23: EnvHeap4))
    method_39((var_1: EnvStack9), (var_10: EnvStack9), (var_11: EnvStack9), (var_13: ManagedCuda.CudaBlas.CudaBlas), (var_14: ManagedCuda.CudaRand.CudaRandDevice), (var_15: EnvStack0), (var_16: uint64), (var_17: ResizeArray<Env1>), (var_18: ResizeArray<Env2>), (var_19: ManagedCuda.CudaContext), (var_20: ResizeArray<EnvHeap3>), (var_21: ResizeArray<EnvHeap4>), (var_22: ManagedCuda.BasicTypes.CUmodule), (var_23: EnvHeap4))
    ...
    var_0()
and method_40 ((var_0: EnvStack9), (var_1: ManagedCuda.CudaBlas.CudaBlas), (var_2: ManagedCuda.CudaRand.CudaRandDevice), (var_3: EnvStack0), (var_4: uint64), (var_5: ResizeArray<Env1>), (var_6: ResizeArray<Env2>), (var_7: ManagedCuda.CudaContext), (var_8: ResizeArray<EnvHeap3>), (var_9: ResizeArray<EnvHeap4>), (var_10: ManagedCuda.BasicTypes.CUmodule), (var_11: EnvHeap4), (var_12: (unit -> float32))) (): float32 =
    let (var_13: float32) = var_12()
    let (var_14: int64) = 1L
    let (var_15: int64) = 0L
    let (var_16: (float32 [])) = method_35((var_14: int64), (var_0: EnvStack9), (var_15: int64))
    let (var_17: float32) = var_16.[int32 0L]
    (var_13 + var_17)
and method_47((var_0: EnvStack9), (var_1: ManagedCuda.CudaBlas.CudaBlas), (var_2: ManagedCuda.CudaRand.CudaRandDevice), (var_3: EnvStack0), (var_4: uint64), (var_5: ResizeArray<Env1>), (var_6: ResizeArray<Env2>), (var_7: ManagedCuda.CudaContext), (var_8: ResizeArray<EnvHeap3>), (var_9: ResizeArray<EnvHeap4>), (var_10: ManagedCuda.BasicTypes.CUmodule), (var_11: EnvHeap4), (var_12: int64), (var_13: float), (var_14: EnvStack9), (var_15: EnvStack9), (var_16: EnvStack9), (var_17: EnvStack9), (var_18: EnvStack9), (var_19: EnvStack9), (var_20: ResizeArray<EnvHeap3>), (var_21: EnvStack9), (var_22: int64)): float =
    ...
    if var_23 then
        ...
        if var_25 then
            ...
            ()
        let (var_26: int64) = (var_22 * 8192L)
        if var_25 then
            (failwith "Argument out of bounds.")
        else
            ()
        let (var_27: int64) = (8192L + var_26)
        let (var_28: EnvHeap8) = ({mem_0 = (var_3: EnvStack0); mem_1 = (var_4: uint64); mem_2 = (var_5: ResizeArray<Env1>); mem_3 = (var_6: ResizeArray<Env2>)} : EnvHeap8)
        ...
        let (var_138: EnvHeap3) = method_11((var_28: EnvHeap8), (var_1: ManagedCuda.CudaBlas.CudaBlas), (var_2: ManagedCuda.CudaRand.CudaRandDevice), (var_3: EnvStack0), (var_4: uint64), (var_5: ResizeArray<Env1>), (var_6: ResizeArray<Env2>), (var_7: ManagedCuda.CudaContext), (var_36: ResizeArray<EnvHeap3>), (var_9: ResizeArray<EnvHeap4>), (var_10: ManagedCuda.BasicTypes.CUmodule), (var_11: EnvHeap4), (var_137: int64))
        let (var_139: EnvStack9) = EnvStack9((var_138: EnvHeap3))
        method_22((var_17: EnvStack9), (var_0: EnvStack9), (var_26: int64), (var_139: EnvStack9), (var_1: ManagedCuda.CudaBlas.CudaBlas), (var_2: ManagedCuda.CudaRand.CudaRandDevice), (var_3: EnvStack0), (var_4: uint64), (var_5: ResizeArray<Env1>), (var_6: ResizeArray<Env2>), (var_7: ManagedCuda.CudaContext), (var_36: ResizeArray<EnvHeap3>), (var_9: ResizeArray<EnvHeap4>), (var_10: ManagedCuda.BasicTypes.CUmodule), (var_11: EnvHeap4))
        let (var_140: EnvHeap3) = var_139.mem_0
        let (var_141: int64) = 512L
        let (var_142: EnvHeap3) = method_11((var_28: EnvHeap8), (var_1: ManagedCuda.CudaBlas.CudaBlas), (var_2: ManagedCuda.CudaRand.CudaRandDevice), (var_3: EnvStack0), (var_4: uint64), (var_5: ResizeArray<Env1>), (var_6: ResizeArray<Env2>), (var_7: ManagedCuda.CudaContext), (var_36: ResizeArray<EnvHeap3>), (var_9: ResizeArray<EnvHeap4>), (var_10: ManagedCuda.BasicTypes.CUmodule), (var_11: EnvHeap4), (var_141: int64))
        let (var_143: EnvStack9) = EnvStack9((var_142: EnvHeap3))
        ...
        method_36((var_19: EnvStack9), (var_21: EnvStack9), (var_139: EnvStack9), (var_1: ManagedCuda.CudaBlas.CudaBlas), (var_2: ManagedCuda.CudaRand.CudaRandDevice), (var_3: EnvStack0), (var_4: uint64), (var_5: ResizeArray<Env1>), (var_6: ResizeArray<Env2>), (var_7: ManagedCuda.CudaContext), (var_36: ResizeArray<EnvHeap3>), (var_9: ResizeArray<EnvHeap4>), (var_10: ManagedCuda.BasicTypes.CUmodule), (var_11: EnvHeap4))
        ...
        // Cuda join point
        // method_23((var_161: uint64), (var_165: uint64), (var_166: uint64))
        let (var_167: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_23", var_10, var_7)
        ...
        let (var_179: EnvStack9) = EnvStack9((var_178: EnvHeap3))
        ...
        // Cuda join point
        // method_25((var_180: uint64), (var_185: uint64))
        let (var_186: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_25", var_10, var_7)
        ...
        let (var_221: EnvStack9) = EnvStack9((var_220: EnvHeap3))
        ...
        // Cuda join point
        // method_26((var_204: uint64), (var_211: uint64), (var_226: uint64))
        ...
        let (var_233: (unit -> unit)) = method_48((var_143: EnvStack9), (var_139: EnvStack9), (var_14: EnvStack9), (var_15: EnvStack9), (var_0: EnvStack9), (var_26: int64), (var_16: EnvStack9), (var_17: EnvStack9), (var_21: EnvStack9), (var_18: EnvStack9), (var_19: EnvStack9), (var_1: ManagedCuda.CudaBlas.CudaBlas), (var_2: ManagedCuda.CudaRand.CudaRandDevice), (var_3: EnvStack0), (var_4: uint64), (var_5: ResizeArray<Env1>), (var_6: ResizeArray<Env2>), (var_7: ManagedCuda.CudaContext), (var_36: ResizeArray<EnvHeap3>), (var_9: ResizeArray<EnvHeap4>), (var_10: ManagedCuda.BasicTypes.CUmodule), (var_11: EnvHeap4), (var_194: EnvStack9), (var_179: EnvStack9), (var_221: EnvStack9), (var_27: int64))
        let (var_234: (unit -> float32)) = method_34((var_221: EnvStack9), (var_1: ManagedCuda.CudaBlas.CudaBlas), (var_2: ManagedCuda.CudaRand.CudaRandDevice), (var_3: EnvStack0), (var_4: uint64), (var_5: ResizeArray<Env1>), (var_6: ResizeArray<Env2>), (var_7: ManagedCuda.CudaContext), (var_36: ResizeArray<EnvHeap3>), (var_9: ResizeArray<EnvHeap4>), (var_10: ManagedCuda.BasicTypes.CUmodule), (var_11: EnvHeap4))
        let (var_324: int64) = 1L
        method_49((var_0: EnvStack9), (var_26: int64), (var_27: int64), (var_14: EnvStack9), (var_15: EnvStack9), (var_16: EnvStack9), (var_17: EnvStack9), (var_18: EnvStack9), (var_19: EnvStack9), (var_1: ManagedCuda.CudaBlas.CudaBlas), (var_2: ManagedCuda.CudaRand.CudaRandDevice), (var_3: EnvStack0), (var_4: uint64), (var_5: ResizeArray<Env1>), (var_6: ResizeArray<Env2>), (var_7: ManagedCuda.CudaContext), (var_36: ResizeArray<EnvHeap3>), (var_9: ResizeArray<EnvHeap4>), (var_10: ManagedCuda.BasicTypes.CUmodule), (var_11: EnvHeap4), (var_12: int64), (var_13: float), (var_22: int64), (var_8: ResizeArray<EnvHeap3>), (var_20: ResizeArray<EnvHeap3>), (var_234: (unit -> float32)), (var_233: (unit -> unit)), (var_194: EnvStack9), (var_179: EnvStack9), (var_324: int64))
    else
        method_42((var_20: ResizeArray<EnvHeap3>))
        let (var_326: float) = (float var_12)
        (var_13 / var_326)
and method_38((var_0: EnvStack9), (var_1: EnvStack9), (var_2: EnvStack9), (var_3: ManagedCuda.CudaBlas.CudaBlas), (var_4: ManagedCuda.CudaRand.CudaRandDevice), (var_5: EnvStack0), (var_6: uint64), (var_7: ResizeArray<Env1>), (var_8: ResizeArray<Env2>), (var_9: ManagedCuda.CudaContext), (var_10: ResizeArray<EnvHeap3>), (var_11: ResizeArray<EnvHeap4>), (var_12: ManagedCuda.BasicTypes.CUmodule), (var_13: EnvHeap4)): unit =
    let (var_14: ManagedCuda.CudaBlas.CudaBlasHandle) = var_3.get_CublasHandle()
    let (var_15: (int64 ref)) = var_13.mem_0
    let (var_16: EnvHeap5) = var_13.mem_1
    let (var_17: (bool ref)) = var_16.mem_0
    ...
    let (var_45: ManagedCuda.CudaBlas.CublasStatus) = ManagedCuda.CudaBlas.CudaBlasNativeMethods.cublasSgemm_v2(var_14, var_20, var_21, 128, 1, 128, var_22, var_29, 128, var_36, 128, var_37, var_44, 128)
    if var_45 <> ManagedCuda.CudaBlas.CublasStatus.Success then raise <| new ManagedCuda.CudaBlas.CudaBlasException(var_45)
and method_39((var_0: EnvStack9), (var_1: EnvStack9), (var_2: EnvStack9), (var_3: ManagedCuda.CudaBlas.CudaBlas), (var_4: ManagedCuda.CudaRand.CudaRandDevice), (var_5: EnvStack0), (var_6: uint64), (var_7: ResizeArray<Env1>), (var_8: ResizeArray<Env2>), (var_9: ManagedCuda.CudaContext), (var_10: ResizeArray<EnvHeap3>), (var_11: ResizeArray<EnvHeap4>), (var_12: ManagedCuda.BasicTypes.CUmodule), (var_13: EnvHeap4)): unit =
    let (var_14: ManagedCuda.CudaBlas.CudaBlasHandle) = var_3.get_CublasHandle()
    let (var_15: (int64 ref)) = var_13.mem_0
    let (var_16: EnvHeap5) = var_13.mem_1
    let (var_17: (bool ref)) = var_16.mem_0
    ...
    if var_45 <> ManagedCuda.CudaBlas.CublasStatus.Success then raise <| new ManagedCuda.CudaBlas.CudaBlasException(var_45)
and method_48 ((var_0: EnvStack9), (var_1: EnvStack9), (var_2: EnvStack9), (var_3: EnvStack9), (var_4: EnvStack9), (var_5: int64), (var_6: EnvStack9), (var_7: EnvStack9), (var_8: EnvStack9), (var_9: EnvStack9), (var_10: EnvStack9), (var_11: ManagedCuda.CudaBlas.CudaBlas), (var_12: ManagedCuda.CudaRand.CudaRandDevice), (var_13: EnvStack0), (var_14: uint64), (var_15: ResizeArray<Env1>), (var_16: ResizeArray<Env2>), (var_17: ManagedCuda.CudaContext), (var_18: ResizeArray<EnvHeap3>), (var_19: ResizeArray<EnvHeap4>), (var_20: ManagedCuda.BasicTypes.CUmodule), (var_21: EnvHeap4), (var_22: EnvStack9), (var_23: EnvStack9), (var_24: EnvStack9), (var_25: int64)) (): unit =
    ...
    method_31((var_0: EnvStack9), (var_4: EnvStack9), (var_5: int64), (var_6: EnvStack9), (var_11: ManagedCuda.CudaBlas.CudaBlas), (var_12: ManagedCuda.CudaRand.CudaRandDevice), (var_13: EnvStack0), (var_14: uint64), (var_15: ResizeArray<Env1>), (var_16: ResizeArray<Env2>), (var_17: ManagedCuda.CudaContext), (var_18: ResizeArray<EnvHeap3>), (var_19: ResizeArray<EnvHeap4>), (var_20: ManagedCuda.BasicTypes.CUmodule), (var_21: EnvHeap4))
    method_39((var_0: EnvStack9), (var_8: EnvStack9), (var_9: EnvStack9), (var_11: ManagedCuda.CudaBlas.CudaBlas), (var_12: ManagedCuda.CudaRand.CudaRandDevice), (var_13: EnvStack0), (var_14: uint64), (var_15: ResizeArray<Env1>), (var_16: ResizeArray<Env2>), (var_17: ManagedCuda.CudaContext), (var_18: ResizeArray<EnvHeap3>), (var_19: ResizeArray<EnvHeap4>), (var_20: ManagedCuda.BasicTypes.CUmodule), (var_21: EnvHeap4))
...
and method_49((var_0: EnvStack9), (var_1: int64), (var_2: int64), (var_3: EnvStack9), (var_4: EnvStack9), (var_5: EnvStack9), (var_6: EnvStack9), (var_7: EnvStack9), (var_8: EnvStack9), (var_9: ManagedCuda.CudaBlas.CudaBlas), (var_10: ManagedCuda.CudaRand.CudaRandDevice), (var_11: EnvStack0), (var_12: uint64), (var_13: ResizeArray<Env1>), (var_14: ResizeArray<Env2>), (var_15: ManagedCuda.CudaContext), (var_16: ResizeArray<EnvHeap3>), (var_17: ResizeArray<EnvHeap4>), (var_18: ManagedCuda.BasicTypes.CUmodule), (var_19: EnvHeap4), (var_20: int64), (var_21: float), (var_22: int64), (var_23: ResizeArray<EnvHeap3>), (var_24: ResizeArray<EnvHeap3>), (var_25: (unit -> float32)), (var_26: (unit -> unit)), (var_27: EnvStack9), (var_28: EnvStack9), (var_29: int64)): float =
    ...
    if var_30 then
        ...
        let (var_38: EnvHeap8) = ({mem_0 = (var_11: EnvStack0); mem_1 = (var_12: uint64); mem_2 = (var_13: ResizeArray<Env1>); mem_3 = (var_14: ResizeArray<Env2>)} : EnvHeap8)
        let (var_39: EnvHeap3) = method_11((var_38: EnvHeap8), (var_9: ManagedCuda.CudaBlas.CudaBlas), (var_10: ManagedCuda.CudaRand.CudaRandDevice), (var_11: EnvStack0), (var_12: uint64), (var_13: ResizeArray<Env1>), (var_14: ResizeArray<Env2>), (var_15: ManagedCuda.CudaContext), (var_16: ResizeArray<EnvHeap3>), (var_17: ResizeArray<EnvHeap4>), (var_18: ManagedCuda.BasicTypes.CUmodule), (var_19: EnvHeap4), (var_37: int64))
        let (var_40: EnvStack9) = EnvStack9((var_39: EnvHeap3))
        method_22((var_6: EnvStack9), (var_0: EnvStack9), (var_34: int64), (var_40: EnvStack9), (var_9: ManagedCuda.CudaBlas.CudaBlas), (var_10: ManagedCuda.CudaRand.CudaRandDevice), (var_11: EnvStack0), (var_12: uint64), (var_13: ResizeArray<Env1>), (var_14: ResizeArray<Env2>), (var_15: ManagedCuda.CudaContext), (var_16: ResizeArray<EnvHeap3>), (var_17: ResizeArray<EnvHeap4>), (var_18: ManagedCuda.BasicTypes.CUmodule), (var_19: EnvHeap4))
        let (var_41: EnvHeap3) = var_40.mem_0
        let (var_42: int64) = 512L
        let (var_43: EnvHeap3) = method_11((var_38: EnvHeap8), (var_9: ManagedCuda.CudaBlas.CudaBlas), (var_10: ManagedCuda.CudaRand.CudaRandDevice), (var_11: EnvStack0), (var_12: uint64), (var_13: ResizeArray<Env1>), (var_14: ResizeArray<Env2>), (var_15: ManagedCuda.CudaContext), (var_16: ResizeArray<EnvHeap3>), (var_17: ResizeArray<EnvHeap4>), (var_18: ManagedCuda.BasicTypes.CUmodule), (var_19: EnvHeap4), (var_42: int64))
        let (var_44: EnvStack9) = EnvStack9((var_43: EnvHeap3))
        ...
        method_36((var_8: EnvStack9), (var_28: EnvStack9), (var_40: EnvStack9), (var_9: ManagedCuda.CudaBlas.CudaBlas), (var_10: ManagedCuda.CudaRand.CudaRandDevice), (var_11: EnvStack0), (var_12: uint64), (var_13: ResizeArray<Env1>), (var_14: ResizeArray<Env2>), (var_15: ManagedCuda.CudaContext), (var_16: ResizeArray<EnvHeap3>), (var_17: ResizeArray<EnvHeap4>), (var_18: ManagedCuda.BasicTypes.CUmodule), (var_19: EnvHeap4))
        ...
        let (var_79: EnvHeap3) = method_11((var_38: EnvHeap8), (var_9: ManagedCuda.CudaBlas.CudaBlas), (var_10: ManagedCuda.CudaRand.CudaRandDevice), (var_11: EnvStack0), (var_12: uint64), (var_13: ResizeArray<Env1>), (var_14: ResizeArray<Env2>), (var_15: ManagedCuda.CudaContext), (var_16: ResizeArray<EnvHeap3>), (var_17: ResizeArray<EnvHeap4>), (var_18: ManagedCuda.BasicTypes.CUmodule), (var_19: EnvHeap4), (var_78: int64))
        let (var_80: EnvStack9) = EnvStack9((var_79: EnvHeap3))
        ...
        // Cuda join point
        // method_25((var_81: uint64), (var_86: uint64))
        let (var_87: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_25", var_18, var_15)
        ...
        let (var_94: EnvHeap3) = method_11((var_38: EnvHeap8), (var_9: ManagedCuda.CudaBlas.CudaBlas), (var_10: ManagedCuda.CudaRand.CudaRandDevice), (var_11: EnvStack0), (var_12: uint64), (var_13: ResizeArray<Env1>), (var_14: ResizeArray<Env2>), (var_15: ManagedCuda.CudaContext), (var_16: ResizeArray<EnvHeap3>), (var_17: ResizeArray<EnvHeap4>), (var_18: ManagedCuda.BasicTypes.CUmodule), (var_19: EnvHeap4), (var_93: int64))
        let (var_95: EnvStack9) = EnvStack9((var_94: EnvHeap3))
        ...
        let (var_121: EnvHeap3) = method_11((var_38: EnvHeap8), (var_9: ManagedCuda.CudaBlas.CudaBlas), (var_10: ManagedCuda.CudaRand.CudaRandDevice), (var_11: EnvStack0), (var_12: uint64), (var_13: ResizeArray<Env1>), (var_14: ResizeArray<Env2>), (var_15: ManagedCuda.CudaContext), (var_16: ResizeArray<EnvHeap3>), (var_17: ResizeArray<EnvHeap4>), (var_18: ManagedCuda.BasicTypes.CUmodule), (var_19: EnvHeap4), (var_120: int64))
        ...
        // Cuda join point
        // method_26((var_105: uint64), (var_112: uint64), (var_127: uint64))
        ...
        let (var_134: (unit -> unit)) = method_37((var_26: (unit -> unit)), (var_44: EnvStack9), (var_40: EnvStack9), (var_3: EnvStack9), (var_4: EnvStack9), (var_0: EnvStack9), (var_34: int64), (var_5: EnvStack9), (var_6: EnvStack9), (var_27: EnvStack9), (var_28: EnvStack9), (var_7: EnvStack9), (var_8: EnvStack9), (var_9: ManagedCuda.CudaBlas.CudaBlas), (var_10: ManagedCuda.CudaRand.CudaRandDevice), (var_11: EnvStack0), (var_12: uint64), (var_13: ResizeArray<Env1>), (var_14: ResizeArray<Env2>), (var_15: ManagedCuda.CudaContext), (var_16: ResizeArray<EnvHeap3>), (var_17: ResizeArray<EnvHeap4>), (var_18: ManagedCuda.BasicTypes.CUmodule), (var_19: EnvHeap4), (var_95: EnvStack9), (var_80: EnvStack9), (var_122: EnvStack9), (var_35: int64))
        let (var_135: (unit -> float32)) = method_40((var_122: EnvStack9), (var_9: ManagedCuda.CudaBlas.CudaBlas), (var_10: ManagedCuda.CudaRand.CudaRandDevice), (var_11: EnvStack0), (var_12: uint64), (var_13: ResizeArray<Env1>), (var_14: ResizeArray<Env2>), (var_15: ManagedCuda.CudaContext), (var_16: ResizeArray<EnvHeap3>), (var_17: ResizeArray<EnvHeap4>), (var_18: ManagedCuda.BasicTypes.CUmodule), (var_19: EnvHeap4), (var_25: (unit -> float32)))
        let (var_136: int64) = (var_29 + 1L)
        method_49((var_0: EnvStack9), (var_1: int64), (var_2: int64), (var_3: EnvStack9), (var_4: EnvStack9), (var_5: EnvStack9), (var_6: EnvStack9), (var_7: EnvStack9), (var_8: EnvStack9), (var_9: ManagedCuda.CudaBlas.CudaBlas), (var_10: ManagedCuda.CudaRand.CudaRandDevice), (var_11: EnvStack0), (var_12: uint64), (var_13: ResizeArray<Env1>), (var_14: ResizeArray<Env2>), (var_15: ManagedCuda.CudaContext), (var_16: ResizeArray<EnvHeap3>), (var_17: ResizeArray<EnvHeap4>), (var_18: ManagedCuda.BasicTypes.CUmodule), (var_19: EnvHeap4), (var_20: int64), (var_21: float), (var_22: int64), (var_23: ResizeArray<EnvHeap3>), (var_24: ResizeArray<EnvHeap3>), (var_135: (unit -> float32)), (var_134: (unit -> unit)), (var_95: EnvStack9), (var_80: EnvStack9), (var_136: int64))
    else
        let (var_138: float32) = var_25()
        let (var_139: float) = (float var_138)
        let (var_140: float) = (var_21 + var_139)
        method_42((var_24: ResizeArray<EnvHeap3>))
        ...
        if (System.Double.IsNaN var_140) then
            ...
            let (var_163: uint64) = method_5((var_162: (uint64 ref)))
            // Cuda join point
            // method_44((var_158: uint64), (var_163: uint64))
            let (var_164: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_44", var_18, var_15)
            ...
            let (var_183: uint64) = method_5((var_182: (uint64 ref)))
            // Cuda join point
            // method_45((var_178: uint64), (var_183: uint64))
            let (var_184: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_45", var_18, var_15)
            ...
            // Cuda join point
            // method_45((var_194: uint64), (var_199: uint64))
            let (var_200: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_45", var_18, var_15)
            ...
            method_47((var_0: EnvStack9), (var_9: ManagedCuda.CudaBlas.CudaBlas), (var_10: ManagedCuda.CudaRand.CudaRandDevice), (var_11: EnvStack0), (var_12: uint64), (var_13: ResizeArray<Env1>), (var_14: ResizeArray<Env2>), (var_15: ManagedCuda.CudaContext), (var_23: ResizeArray<EnvHeap3>), (var_17: ResizeArray<EnvHeap4>), (var_18: ManagedCuda.BasicTypes.CUmodule), (var_19: EnvHeap4), (var_151: int64), (var_140: float), (var_3: EnvStack9), (var_4: EnvStack9), (var_5: EnvStack9), (var_6: EnvStack9), (var_7: EnvStack9), (var_8: EnvStack9), (var_16: ResizeArray<EnvHeap3>), (var_28: EnvStack9), (var_206: int64))
...
let (var_112: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(139425u, 1u, 1u)
var_111.set_GridDimensions(var_112)
let (var_113: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(256u, 1u, 1u)
...
method_20((var_47: ManagedCuda.CudaBlas.CudaBlas), (var_44: ManagedCuda.CudaRand.CudaRandDevice), (var_40: EnvStack0), (var_35: uint64), (var_41: ResizeArray<Env1>), (var_42: ResizeArray<Env2>), (var_1: ManagedCuda.CudaContext), (var_56: ResizeArray<EnvHeap3>), (var_68: ResizeArray<EnvHeap4>), (var_32: ManagedCuda.BasicTypes.CUmodule), (var_72: EnvHeap4), (var_105: EnvStack9), (var_183: EnvStack9), (var_171: EnvStack9), (var_135: EnvStack9), (var_123: EnvStack9), (var_159: EnvStack9), (var_147: EnvStack9), (var_193: int64))
method_50((var_68: ResizeArray<EnvHeap4>))
