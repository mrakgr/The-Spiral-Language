...
extern "C" {
    ...
    __global__ void method_39(float * var_0, float * var_1, long long int var_2, float * var_3);
    ...
    __global__ void method_39(float * var_0, float * var_1, long long int var_2, float * var_3) {
        ...
        while (method_18(var_11)) {
            ...
            long long int var_21 = (var_2 + var_20);
            char var_23;
            if (var_16) {
                var_23 = (var_14 < 32);
            } else {
            ...
            while (method_40(var_28)) {
                ...
                long long int var_41 = (var_21 + var_31);
                float var_42 = var_0[var_40];
                float var_43 = var_1[var_41];
                printf("inner i=%d, (%f,%f)\n", var_31, var_42, var_43);
                char var_44 = (var_33 > var_42);
                Tuple4 var_45;
                if (var_44) {
                    var_45 = make_Tuple4(var_33, var_34);
                } else {
                    var_45 = make_Tuple4(var_42, var_43);
                }
                float var_46 = var_45.mem_0;
                float var_47 = var_45.mem_1;
                var_28[0] = (make_Env3(var_35, make_Tuple4(var_46, var_47)));
            }
            Env3 var_48 = var_28[0];
            long long int var_49 = var_48.mem_0;
            Tuple4 var_50 = var_48.mem_1;
            float var_51 = var_50.mem_0;
            float var_52 = var_50.mem_1;
            FunPointer5 var_55 = method_41;
            Tuple4 var_56 = cub::BlockReduce<Tuple4,1>().Reduce(make_Tuple4(var_51, var_52), var_55);
            float var_57 = var_56.mem_0;
            float var_58 = var_56.mem_1;
            char var_59 = (var_4 == 0);
            if (var_59) {
                char var_61;
                if (var_16) {
...
and method_14((var_0: uint64), (var_1: uint64), (var_2: System.Collections.Generic.Stack<Env3>), (var_3: ManagedCuda.CudaContext), (var_4: ManagedCuda.BasicTypes.CUmodule), (var_5: ManagedCuda.CudaStream), (var_6: EnvStack2), (var_7: EnvStack2), (var_8: ManagedCuda.CudaBlas.CudaBlasHandle), (var_9: EnvStack2), (var_10: EnvStack2), (var_11: EnvStack2), (var_12: EnvStack2), (var_13: int64), (var_14: float), (var_15: int64)): Env7 =
    ...
    if var_16 then
        ...
        let (var_30: EnvStack2) = method_10((var_0: uint64), (var_2: System.Collections.Generic.Stack<Env3>), (var_1: uint64), (var_29: int64))
        ...
        let (var_32: EnvStack2) = method_10((var_0: uint64), (var_2: System.Collections.Generic.Stack<Env3>), (var_1: uint64), (var_31: int64))
        let (var_33: (Union0 ref)) = var_32.mem_0
        let (var_34: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_33: (Union0 ref)))
        let (var_35: ManagedCuda.BasicTypes.CUstream) = var_5.get_Stream()
        let (var_36: ManagedCuda.BasicTypes.SizeT) = ManagedCuda.BasicTypes.SizeT(1280L)
        var_3.ClearMemoryAsync(var_34, 0uy, var_36, var_35)
        ...
        let (var_44: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_16", var_4, var_3)
        ...
        let (var_47: ManagedCuda.BasicTypes.CUstream) = var_5.get_Stream()
        var_44.RunAsync(var_47, var_43)
        let (var_52: int64) = 1280L
        let (var_53: EnvStack2) = method_10((var_0: uint64), (var_2: System.Collections.Generic.Stack<Env3>), (var_1: uint64), (var_52: int64))
        ...
        let (var_59: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_19", var_4, var_3)
        ...
        let (var_62: ManagedCuda.BasicTypes.CUstream) = var_5.get_Stream()
        var_59.RunAsync(var_62, var_58)
        let (var_63: int64) = 1280L
        let (var_64: EnvStack2) = method_10((var_0: uint64), (var_2: System.Collections.Generic.Stack<Env3>), (var_1: uint64), (var_63: int64))
        let (var_65: (Union0 ref)) = var_64.mem_0
        let (var_66: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_65: (Union0 ref)))
        let (var_67: ManagedCuda.BasicTypes.CUstream) = var_5.get_Stream()
        let (var_68: ManagedCuda.BasicTypes.SizeT) = ManagedCuda.BasicTypes.SizeT(1280L)
        var_3.ClearMemoryAsync(var_66, 0uy, var_68, var_67)
        ...
        let (var_75: EnvStack2) = method_10((var_0: uint64), (var_2: System.Collections.Generic.Stack<Env3>), (var_1: uint64), (var_74: int64))
        ...
        let (var_80: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_21", var_4, var_3)
        ...
        let (var_85: (float32 [])) = Array.zeroCreate<float32> (System.Convert.ToInt32(3L))
        var_3.CopyToHost(var_85, var_84)
        var_3.Synchronize()
        ...
        let (var_90: float32) = (var_88 / 32.000000f)
        let (var_91: (float32 ref)) = (ref 0.000000f)
        var_91 := 1.000000f
        let (var_92: float32) = (!var_91)
        let (var_93: float32) = (var_92 / 32.000000f)
        ...
        let (var_102: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_25", var_4, var_3)
        ...
        let (var_105: ManagedCuda.BasicTypes.CUstream) = var_5.get_Stream()
        ...
        let (var_112: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_26", var_4, var_3)
        ...
        let (var_121: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_28", var_4, var_3)
        let (var_122: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(1u, 1u, 1u)
        var_121.set_GridDimensions(var_122)
        let (var_123: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(10u, 8u, 1u)
        ...
        // Cuda join point
        // method_31((var_126: ManagedCuda.BasicTypes.CUdeviceptr), (var_128: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_130: (System.Object [])) = [|var_126; var_128|]: (System.Object [])
        let (var_131: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_31", var_4, var_3)
        ...
        // Cuda join point
        // method_33((var_138: ManagedCuda.BasicTypes.CUdeviceptr), (var_139: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_141: (System.Object [])) = [|var_138; var_139|]: (System.Object [])
        let (var_142: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_33", var_4, var_3)
        ...
        var_3.ClearMemoryAsync(var_146, 0uy, var_148, var_147)
        let (var_149: float) = (float var_90)
        let (var_150: float) = (var_149 * 32.000000)
        let (var_151: float) = (var_14 + var_150)
        let (var_152: int64) = 1280L
        let (var_153: EnvStack2) = method_10((var_0: uint64), (var_2: System.Collections.Generic.Stack<Env3>), (var_1: uint64), (var_152: int64))
        let (var_154: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_55: (Union0 ref)))
        let (var_155: (Union0 ref)) = var_153.mem_0
        let (var_156: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_155: (Union0 ref)))
        // Cuda join point
        // method_34((var_154: ManagedCuda.BasicTypes.CUdeviceptr), (var_156: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_158: (System.Object [])) = [|var_154; var_156|]: (System.Object [])
        let (var_159: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_34", var_4, var_3)
        let (var_160: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(3u, 1u, 1u)
        ...
        let (var_162: ManagedCuda.BasicTypes.CUstream) = var_5.get_Stream()
        var_159.RunAsync(var_162, var_158)
        let (var_163: int64) = 1280L
        let (var_164: EnvStack2) = method_10((var_0: uint64), (var_2: System.Collections.Generic.Stack<Env3>), (var_1: uint64), (var_163: int64))
        let (var_165: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_70: (Union0 ref)))
        let (var_166: (Union0 ref)) = var_164.mem_0
        let (var_167: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_166: (Union0 ref)))
        // Cuda join point
        // method_34((var_165: ManagedCuda.BasicTypes.CUdeviceptr), (var_167: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_169: (System.Object [])) = [|var_165; var_167|]: (System.Object [])
        let (var_170: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_34", var_4, var_3)
        let (var_171: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(3u, 1u, 1u)
        ...
        let (var_173: ManagedCuda.BasicTypes.CUstream) = var_5.get_Stream()
        var_170.RunAsync(var_173, var_169)
        let (var_174: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_155: (Union0 ref)))
        let (var_175: (float32 [])) = Array.zeroCreate<float32> (System.Convert.ToInt32(320L))
        var_3.CopyToHost(var_175, var_174)
        var_3.Synchronize()
        let (var_176: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_166: (Union0 ref)))
        let (var_177: (float32 [])) = Array.zeroCreate<float32> (System.Convert.ToInt32(320L))
        var_3.CopyToHost(var_177, var_176)
        var_3.Synchronize()
        let (var_178: System.Text.StringBuilder) = System.Text.StringBuilder()
        let (var_179: string) = ""
        let (var_180: int64) = 0L
        method_35((var_178: System.Text.StringBuilder), (var_180: int64))
        let (var_181: System.Text.StringBuilder) = var_178.AppendLine("[|")
        let (var_182: int64) = 0L
        method_36((var_178: System.Text.StringBuilder), (var_179: string), (var_175: (float32 [])), (var_177: (float32 [])), (var_182: int64))
        let (var_183: int64) = 0L
        method_35((var_178: System.Text.StringBuilder), (var_183: int64))
        let (var_184: System.Text.StringBuilder) = var_178.AppendLine("|]")
        let (var_185: string) = var_178.ToString()
        let (var_186: string) = System.String.Format("{0}",var_185)
        System.Console.WriteLine(var_186)
        var_166 := Union0Case1
        var_155 := Union0Case1
        let (var_187: int64) = 128L
        let (var_188: EnvStack2) = method_10((var_0: uint64), (var_2: System.Collections.Generic.Stack<Env3>), (var_1: uint64), (var_187: int64))
        let (var_189: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_55: (Union0 ref)))
        let (var_190: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_70: (Union0 ref)))
        let (var_191: (Union0 ref)) = var_188.mem_0
        let (var_192: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_191: (Union0 ref)))
        // Cuda join point
        // method_39((var_189: ManagedCuda.BasicTypes.CUdeviceptr), (var_190: ManagedCuda.BasicTypes.CUdeviceptr), (var_28: int64), (var_192: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_194: (System.Object [])) = [|var_189; var_190; var_28; var_192|]: (System.Object [])
        let (var_195: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_39", var_4, var_3)
        let (var_196: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(1u, 1u, 1u)
        ...
        let (var_198: ManagedCuda.BasicTypes.CUstream) = var_5.get_Stream()
        var_195.RunAsync(var_198, var_194)
        let (var_199: float32) = 0.000000f
        let (var_200: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_191: (Union0 ref)))
        let (var_201: (float32 [])) = Array.zeroCreate<float32> (System.Convert.ToInt32(32L))
        var_3.CopyToHost(var_201, var_200)
        var_3.Synchronize()
        let (var_202: int64) = var_201.LongLength
        let (var_203: int64) = 0L
        let (var_204: float32) = method_42((var_201: (float32 [])), (var_202: int64), (var_199: float32), (var_203: int64))
        let (var_205: int64) = (int64 var_204)
        var_191 := Union0Case1
        let (var_206: int64) = (var_13 + var_205)
        var_65 := Union0Case1
        var_55 := Union0Case1
        var_33 := Union0Case1
        var_39 := Union0Case1
        method_43((var_0: uint64), (var_1: uint64), (var_2: System.Collections.Generic.Stack<Env3>), (var_3: ManagedCuda.CudaContext), (var_4: ManagedCuda.BasicTypes.CUmodule), (var_5: ManagedCuda.CudaStream), (var_6: EnvStack2), (var_7: EnvStack2), (var_8: ManagedCuda.CudaBlas.CudaBlasHandle), (var_9: EnvStack2), (var_10: EnvStack2), (var_11: EnvStack2), (var_12: EnvStack2), (var_13: int64), (var_14: float), (var_206: int64), (var_151: float), (var_17: int64))
    else
        (Env7(var_13, var_14))
and method_15((var_0: ManagedCuda.CudaBlas.CudaBlasHandle), (var_1: EnvStack2), (var_2: int64), (var_3: EnvStack2), (var_4: EnvStack2)): unit =
    ...
    let (var_10: (Union0 ref)) = var_3.mem_0
    let (var_11: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_10: (Union0 ref)))
    let (var_12: (float32 ref)) = (ref 0.000000f)
    let (var_13: (Union0 ref)) = var_4.mem_0
    let (var_14: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_13: (Union0 ref)))
    let (var_15: ManagedCuda.CudaBlas.CublasStatus) = ManagedCuda.CudaBlas.CudaBlasNativeMethods.cublasSgemm_v2(var_0, var_5, var_6, 32, 10, 784, var_7, var_9, 32, var_11, 784, var_12, var_14, 32)
    if var_15 <> ManagedCuda.CudaBlas.CublasStatus.Success then raise <| new ManagedCuda.CudaBlas.CudaBlasException(var_15)
...
and method_27((var_0: ManagedCuda.CudaBlas.CudaBlasHandle), (var_1: EnvStack2), (var_2: int64), (var_3: EnvStack2), (var_4: EnvStack2)): unit =
    ...
    let (var_10: (Union0 ref)) = var_3.mem_0
    let (var_11: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_10: (Union0 ref)))
    let (var_12: (float32 ref)) = (ref 1.000000f)
    let (var_13: (Union0 ref)) = var_4.mem_0
    let (var_14: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_13: (Union0 ref)))
    let (var_15: ManagedCuda.CudaBlas.CublasStatus) = ManagedCuda.CudaBlas.CudaBlasNativeMethods.cublasSgemm_v2(var_0, var_5, var_6, 784, 10, 32, var_7, var_9, 32, var_11, 32, var_12, var_14, 784)
    if var_15 <> ManagedCuda.CudaBlas.CublasStatus.Success then raise <| new ManagedCuda.CudaBlas.CudaBlasException(var_15)
and method_35((var_0: System.Text.StringBuilder), (var_1: int64)): unit =
    ...
    if var_2 then
        ...
        ()
and method_36((var_0: System.Text.StringBuilder), (var_1: string), (var_2: (float32 [])), (var_3: (float32 [])), (var_4: int64)): unit =
    ...
    if var_5 then
        ...
        let (var_9: int64) = 0L
        method_37((var_0: System.Text.StringBuilder), (var_9: int64))
        let (var_10: System.Text.StringBuilder) = var_0.Append("[|")
        let (var_11: int64) = 0L
        let (var_12: string) = method_38((var_0: System.Text.StringBuilder), (var_2: (float32 [])), (var_8: int64), (var_3: (float32 [])), (var_1: string), (var_11: int64))
        let (var_13: System.Text.StringBuilder) = var_0.AppendLine("|]")
        let (var_14: int64) = (var_4 + 1L)
        method_36((var_0: System.Text.StringBuilder), (var_1: string), (var_2: (float32 [])), (var_3: (float32 [])), (var_14: int64))
    else
        ()
and method_42((var_0: (float32 [])), (var_1: int64), (var_2: float32), (var_3: int64)): float32 =
    let (var_4: bool) = (var_3 < var_1)
    if var_4 then
        let (var_5: float32) = var_0.[int32 var_3]
        let (var_6: float32) = (var_2 + var_5)
        let (var_7: int64) = (var_3 + 1L)
        method_42((var_0: (float32 [])), (var_1: int64), (var_6: float32), (var_7: int64))
    else
        var_2
and method_43((var_0: uint64), (var_1: uint64), (var_2: System.Collections.Generic.Stack<Env3>), (var_3: ManagedCuda.CudaContext), (var_4: ManagedCuda.BasicTypes.CUmodule), (var_5: ManagedCuda.CudaStream), (var_6: EnvStack2), (var_7: EnvStack2), (var_8: ManagedCuda.CudaBlas.CudaBlasHandle), (var_9: EnvStack2), (var_10: EnvStack2), (var_11: EnvStack2), (var_12: EnvStack2), (var_13: int64), (var_14: float), (var_15: int64), (var_16: float), (var_17: int64)): Env7 =
    ...
    if var_18 then
        ...
        let (var_33: int64) = 1280L
        let (var_34: EnvStack2) = method_10((var_0: uint64), (var_2: System.Collections.Generic.Stack<Env3>), (var_1: uint64), (var_33: int64))
        let (var_35: (Union0 ref)) = var_34.mem_0
        let (var_36: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_35: (Union0 ref)))
        let (var_37: ManagedCuda.BasicTypes.CUstream) = var_5.get_Stream()
        let (var_38: ManagedCuda.BasicTypes.SizeT) = ManagedCuda.BasicTypes.SizeT(1280L)
        var_3.ClearMemoryAsync(var_36, 0uy, var_38, var_37)
        ...
        let (var_46: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_16", var_4, var_3)
        ...
        let (var_49: ManagedCuda.BasicTypes.CUstream) = var_5.get_Stream()
        var_46.RunAsync(var_49, var_45)
        let (var_54: int64) = 1280L
        let (var_55: EnvStack2) = method_10((var_0: uint64), (var_2: System.Collections.Generic.Stack<Env3>), (var_1: uint64), (var_54: int64))
        ...
        let (var_61: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_19", var_4, var_3)
        let (var_62: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(3u, 1u, 1u)
        ...
        let (var_64: ManagedCuda.BasicTypes.CUstream) = var_5.get_Stream()
        var_61.RunAsync(var_64, var_60)
        let (var_65: int64) = 1280L
        let (var_66: EnvStack2) = method_10((var_0: uint64), (var_2: System.Collections.Generic.Stack<Env3>), (var_1: uint64), (var_65: int64))
        let (var_67: (Union0 ref)) = var_66.mem_0
        let (var_68: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_67: (Union0 ref)))
        let (var_69: ManagedCuda.BasicTypes.CUstream) = var_5.get_Stream()
        let (var_70: ManagedCuda.BasicTypes.SizeT) = ManagedCuda.BasicTypes.SizeT(1280L)
        var_3.ClearMemoryAsync(var_68, 0uy, var_70, var_69)
        ...
        let (var_76: int64) = 12L
        let (var_77: EnvStack2) = method_10((var_0: uint64), (var_2: System.Collections.Generic.Stack<Env3>), (var_1: uint64), (var_76: int64))
        ...
        let (var_82: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_21", var_4, var_3)
        let (var_83: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(3u, 1u, 1u)
        ...
        let (var_87: (float32 [])) = Array.zeroCreate<float32> (System.Convert.ToInt32(3L))
        var_3.CopyToHost(var_87, var_86)
        var_3.Synchronize()
        ...
        let (var_95: float32) = (var_94 / 32.000000f)
        ...
        let (var_104: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_25", var_4, var_3)
        ...
        let (var_107: ManagedCuda.BasicTypes.CUstream) = var_5.get_Stream()
        ...
        let (var_114: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_26", var_4, var_3)
        ...
        let (var_117: ManagedCuda.BasicTypes.CUstream) = var_5.get_Stream()
        ...
        let (var_123: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_28", var_4, var_3)
        let (var_124: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(1u, 1u, 1u)
        var_123.set_GridDimensions(var_124)
        let (var_125: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(10u, 8u, 1u)
        var_123.set_BlockDimensions(var_125)
        let (var_126: ManagedCuda.BasicTypes.CUstream) = var_5.get_Stream()
        ...
        // Cuda join point
        // method_31((var_128: ManagedCuda.BasicTypes.CUdeviceptr), (var_130: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_132: (System.Object [])) = [|var_128; var_130|]: (System.Object [])
        let (var_133: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_31", var_4, var_3)
        ...
        let (var_138: ManagedCuda.BasicTypes.CUstream) = var_5.get_Stream()
        let (var_139: ManagedCuda.BasicTypes.SizeT) = ManagedCuda.BasicTypes.SizeT(31360L)
        var_3.ClearMemoryAsync(var_137, 0uy, var_139, var_138)
        ...
        // Cuda join point
        // method_33((var_140: ManagedCuda.BasicTypes.CUdeviceptr), (var_141: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_143: (System.Object [])) = [|var_140; var_141|]: (System.Object [])
        let (var_144: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_33", var_4, var_3)
        ...
        var_3.ClearMemoryAsync(var_148, 0uy, var_150, var_149)
        let (var_151: float) = (float var_92)
        let (var_152: float) = (var_151 * 32.000000)
        let (var_153: float) = (var_16 + var_152)
        let (var_154: int64) = 1280L
        let (var_155: EnvStack2) = method_10((var_0: uint64), (var_2: System.Collections.Generic.Stack<Env3>), (var_1: uint64), (var_154: int64))
        let (var_156: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_57: (Union0 ref)))
        let (var_157: (Union0 ref)) = var_155.mem_0
        let (var_158: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_157: (Union0 ref)))
        // Cuda join point
        // method_34((var_156: ManagedCuda.BasicTypes.CUdeviceptr), (var_158: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_160: (System.Object [])) = [|var_156; var_158|]: (System.Object [])
        let (var_161: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_34", var_4, var_3)
        let (var_162: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(3u, 1u, 1u)
        ...
        let (var_164: ManagedCuda.BasicTypes.CUstream) = var_5.get_Stream()
        var_161.RunAsync(var_164, var_160)
        let (var_165: int64) = 1280L
        let (var_166: EnvStack2) = method_10((var_0: uint64), (var_2: System.Collections.Generic.Stack<Env3>), (var_1: uint64), (var_165: int64))
        let (var_167: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_72: (Union0 ref)))
        let (var_168: (Union0 ref)) = var_166.mem_0
        let (var_169: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_168: (Union0 ref)))
        // Cuda join point
        // method_34((var_167: ManagedCuda.BasicTypes.CUdeviceptr), (var_169: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_171: (System.Object [])) = [|var_167; var_169|]: (System.Object [])
        let (var_172: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_34", var_4, var_3)
        let (var_173: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(3u, 1u, 1u)
        var_172.set_GridDimensions(var_173)
        let (var_174: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(128u, 1u, 1u)
        var_172.set_BlockDimensions(var_174)
        let (var_175: ManagedCuda.BasicTypes.CUstream) = var_5.get_Stream()
        var_172.RunAsync(var_175, var_171)
        let (var_176: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_157: (Union0 ref)))
        let (var_177: (float32 [])) = Array.zeroCreate<float32> (System.Convert.ToInt32(320L))
        var_3.CopyToHost(var_177, var_176)
        var_3.Synchronize()
        let (var_178: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_168: (Union0 ref)))
        let (var_179: (float32 [])) = Array.zeroCreate<float32> (System.Convert.ToInt32(320L))
        var_3.CopyToHost(var_179, var_178)
        var_3.Synchronize()
        let (var_180: System.Text.StringBuilder) = System.Text.StringBuilder()
        let (var_181: string) = ""
        let (var_182: int64) = 0L
        method_35((var_180: System.Text.StringBuilder), (var_182: int64))
        let (var_183: System.Text.StringBuilder) = var_180.AppendLine("[|")
        let (var_184: int64) = 0L
        method_36((var_180: System.Text.StringBuilder), (var_181: string), (var_177: (float32 [])), (var_179: (float32 [])), (var_184: int64))
        let (var_185: int64) = 0L
        method_35((var_180: System.Text.StringBuilder), (var_185: int64))
        let (var_186: System.Text.StringBuilder) = var_180.AppendLine("|]")
        let (var_187: string) = var_180.ToString()
        let (var_188: string) = System.String.Format("{0}",var_187)
        System.Console.WriteLine(var_188)
        var_168 := Union0Case1
        var_157 := Union0Case1
        let (var_189: int64) = 128L
        let (var_190: EnvStack2) = method_10((var_0: uint64), (var_2: System.Collections.Generic.Stack<Env3>), (var_1: uint64), (var_189: int64))
        let (var_191: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_57: (Union0 ref)))
        let (var_192: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_72: (Union0 ref)))
        let (var_193: (Union0 ref)) = var_190.mem_0
        let (var_194: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_193: (Union0 ref)))
        // Cuda join point
        // method_39((var_191: ManagedCuda.BasicTypes.CUdeviceptr), (var_192: ManagedCuda.BasicTypes.CUdeviceptr), (var_30: int64), (var_194: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_196: (System.Object [])) = [|var_191; var_192; var_30; var_194|]: (System.Object [])
        let (var_197: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_39", var_4, var_3)
        ...
        let (var_200: ManagedCuda.BasicTypes.CUstream) = var_5.get_Stream()
        var_197.RunAsync(var_200, var_196)
        let (var_201: float32) = 0.000000f
        let (var_202: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_193: (Union0 ref)))
        let (var_203: (float32 [])) = Array.zeroCreate<float32> (System.Convert.ToInt32(32L))
        var_3.CopyToHost(var_203, var_202)
        var_3.Synchronize()
        let (var_204: int64) = var_203.LongLength
        let (var_205: int64) = 0L
        let (var_206: float32) = method_42((var_203: (float32 [])), (var_204: int64), (var_201: float32), (var_205: int64))
        let (var_207: int64) = (int64 var_206)
        var_193 := Union0Case1
        let (var_208: int64) = (var_15 + var_207)
        var_67 := Union0Case1
        var_57 := Union0Case1
        var_35 := Union0Case1
        var_41 := Union0Case1
        method_43((var_0: uint64), (var_1: uint64), (var_2: System.Collections.Generic.Stack<Env3>), (var_3: ManagedCuda.CudaContext), (var_4: ManagedCuda.BasicTypes.CUmodule), (var_5: ManagedCuda.CudaStream), (var_6: EnvStack2), (var_7: EnvStack2), (var_8: ManagedCuda.CudaBlas.CudaBlasHandle), (var_9: EnvStack2), (var_10: EnvStack2), (var_11: EnvStack2), (var_12: EnvStack2), (var_13: int64), (var_14: float), (var_208: int64), (var_153: float), (var_19: int64))
    else
        (Env7(var_15, var_16))
