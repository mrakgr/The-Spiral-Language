...
and method_15((var_0: ManagedCuda.CudaContext), (var_1: ManagedCuda.BasicTypes.CUmodule), (var_2: ManagedCuda.CudaStream), (var_3: uint64), (var_4: uint64), (var_5: System.Collections.Generic.Stack<Env2>), (var_6: (Union0 ref)), (var_7: (Union0 ref)), (var_8: ManagedCuda.CudaBlas.CudaBlasHandle), (var_9: (Union0 ref)), (var_10: (Union0 ref)), (var_11: (Union0 ref)), (var_12: (Union0 ref)), (var_13: int64), (var_14: float), (var_15: int64)): Env7 =
    ...
    if var_16 then
        ...
        let (var_94: int64) = (var_28 * 4L)
        let (var_95: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_12: (Union0 ref)))
        let (var_96: ManagedCuda.BasicTypes.SizeT) = var_95.Pointer
        let (var_97: uint64) = uint64 var_96
        let (var_98: uint64) = (uint64 var_94)
        let (var_99: uint64) = (var_97 + var_98)
        ...
        let (var_102: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_92: (Union0 ref)))
        // Cuda join point
        // method_29((var_93: ManagedCuda.BasicTypes.CUdeviceptr), (var_101: ManagedCuda.BasicTypes.CUdeviceptr), (var_102: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_104: (System.Object [])) = [|var_93; var_101; var_102|]: (System.Object [])
        let (var_105: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_29", var_1, var_0)
        let (var_106: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(1u, 32u, 1u)
        var_105.set_GridDimensions(var_106)
        let (var_107: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(10u, 1u, 1u)
        ...
        let (var_109: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_92: (Union0 ref)))
        let (var_110: (int64 [])) = Array.zeroCreate<int64> (System.Convert.ToInt32(32L))
        var_0.CopyToHost(var_110, var_109)
        var_0.Synchronize()
        let (var_111: int64) = var_110.LongLength
        let (var_112: int64) = 0L
        let (var_113: int64) = method_33((var_110: (int64 [])), (var_111: int64), (var_112: int64))
        var_92 := Union0Case1
        let (var_114: float32) = method_35((var_74: (Union0 ref)), (var_0: ManagedCuda.CudaContext), (var_83: (Union8 ref)), (var_86: (Union8 ref)))
        var_87 := 1.000000f
        let (var_115: float32) = method_35((var_74: (Union0 ref)), (var_0: ManagedCuda.CudaContext), (var_83: (Union8 ref)), (var_86: (Union8 ref)))
        let (var_116: float32) = (!var_87)
        let (var_117: float32) = method_28((var_74: (Union0 ref)), (var_0: ManagedCuda.CudaContext), (var_83: (Union8 ref)))
        let (var_118: float32) = (var_116 / 32.000000f)
        let (var_119: float32) = (!var_84)
        let (var_120: float32) = (var_119 + var_118)
        var_84 := var_120
        let (var_121: float32) = method_28((var_74: (Union0 ref)), (var_0: ManagedCuda.CudaContext), (var_83: (Union8 ref)))
        let (var_122: float32) = (!var_84)
        let (var_123: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_53: (Union0 ref)))
        let (var_124: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_12: (Union0 ref)))
        let (var_125: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_64: (Union0 ref)))
        // Cuda join point
        // method_36((var_122: float32), (var_121: float32), (var_123: ManagedCuda.BasicTypes.CUdeviceptr), (var_124: ManagedCuda.BasicTypes.CUdeviceptr), (var_125: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_127: (System.Object [])) = [|var_122; var_121; var_123; var_124; var_125|]: (System.Object [])
        let (var_128: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_36", var_1, var_0)
        let (var_129: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(3u, 1u, 1u)
        ...
        let (var_132: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_31: (Union0 ref)))
        let (var_133: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_64: (Union0 ref)))
        let (var_134: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_53: (Union0 ref)))
        let (var_135: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_34: (Union0 ref)))
        // Cuda join point
        // method_38((var_132: ManagedCuda.BasicTypes.CUdeviceptr), (var_133: ManagedCuda.BasicTypes.CUdeviceptr), (var_134: ManagedCuda.BasicTypes.CUdeviceptr), (var_135: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_137: (System.Object [])) = [|var_132; var_133; var_134; var_135|]: (System.Object [])
        let (var_138: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_38", var_1, var_0)
        let (var_139: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(3u, 1u, 1u)
        ...
        let (var_142: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_34: (Union0 ref)))
        let (var_143: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_6: (Union0 ref)))
        // Cuda join point
        // method_41((var_142: ManagedCuda.BasicTypes.CUdeviceptr), (var_143: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_145: (System.Object [])) = [|var_142; var_143|]: (System.Object [])
        let (var_146: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_41", var_1, var_0)
        let (var_147: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(1u, 1u, 1u)
        var_146.set_GridDimensions(var_147)
        let (var_148: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(10u, 8u, 1u)
        ...
        let (var_150: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_9: (Union0 ref)))
        let (var_151: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_10: (Union0 ref)))
        // Cuda join point
        // method_45((var_150: ManagedCuda.BasicTypes.CUdeviceptr), (var_151: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_153: (System.Object [])) = [|var_150; var_151|]: (System.Object [])
        let (var_154: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_45", var_1, var_0)
        let (var_155: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(62u, 1u, 1u)
        ...
        let (var_158: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_9: (Union0 ref)))
        ...
        let (var_161: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_6: (Union0 ref)))
        let (var_162: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_7: (Union0 ref)))
        // Cuda join point
        // method_47((var_161: ManagedCuda.BasicTypes.CUdeviceptr), (var_162: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_164: (System.Object [])) = [|var_161; var_162|]: (System.Object [])
        let (var_165: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_47", var_1, var_0)
        ...
        let (var_169: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_6: (Union0 ref)))
        ...
        var_0.ClearMemoryAsync(var_169, 0uy, var_171, var_170)
        let (var_172: float) = (float var_114)
        let (var_173: float) = (var_172 * 32.000000)
        let (var_174: float) = (var_14 + var_173)
        let (var_175: int64) = (var_13 + var_113)
        var_74 := Union0Case1
        var_64 := Union0Case1
        var_53 := Union0Case1
        var_34 := Union0Case1
        var_31 := Union0Case1
        method_49((var_0: ManagedCuda.CudaContext), (var_1: ManagedCuda.BasicTypes.CUmodule), (var_2: ManagedCuda.CudaStream), (var_3: uint64), (var_4: uint64), (var_5: System.Collections.Generic.Stack<Env2>), (var_6: (Union0 ref)), (var_7: (Union0 ref)), (var_8: ManagedCuda.CudaBlas.CudaBlasHandle), (var_9: (Union0 ref)), (var_10: (Union0 ref)), (var_11: (Union0 ref)), (var_12: (Union0 ref)), (var_13: int64), (var_14: float), (var_175: int64), (var_174: float), (var_17: int64))
    else
        (Env7(var_13, var_14))
and method_16((var_0: ManagedCuda.CudaBlas.CudaBlasHandle), (var_1: (Union0 ref)), (var_2: int64), (var_3: (Union0 ref)), (var_4: (Union0 ref))): unit =
    ...
    let (var_19: ManagedCuda.CudaBlas.CublasStatus) = ManagedCuda.CudaBlas.CudaBlasNativeMethods.cublasSgemm_v2(var_0, var_5, var_6, 32, 10, 784, var_7, var_15, 32, var_16, 784, var_17, var_18, 32)
...
and method_40((var_0: ManagedCuda.CudaBlas.CudaBlasHandle), (var_1: (Union0 ref)), (var_2: int64), (var_3: (Union0 ref)), (var_4: (Union0 ref))): unit =
    ...
    let (var_18: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_4: (Union0 ref)))
    let (var_19: ManagedCuda.CudaBlas.CublasStatus) = ManagedCuda.CudaBlas.CudaBlasNativeMethods.cublasSgemm_v2(var_0, var_5, var_6, 784, 10, 32, var_7, var_15, 32, var_16, 32, var_17, var_18, 784)
    if var_19 <> ManagedCuda.CudaBlas.CublasStatus.Success then raise <| new ManagedCuda.CudaBlas.CudaBlasException(var_19)
and method_49((var_0: ManagedCuda.CudaContext), (var_1: ManagedCuda.BasicTypes.CUmodule), (var_2: ManagedCuda.CudaStream), (var_3: uint64), (var_4: uint64), (var_5: System.Collections.Generic.Stack<Env2>), (var_6: (Union0 ref)), (var_7: (Union0 ref)), (var_8: ManagedCuda.CudaBlas.CudaBlasHandle), (var_9: (Union0 ref)), (var_10: (Union0 ref)), (var_11: (Union0 ref)), (var_12: (Union0 ref)), (var_13: int64), (var_14: float), (var_15: int64), (var_16: float), (var_17: int64)): Env7 =
    ...
    if var_18 then
        ...
        let (var_100: uint64) = (uint64 var_96)
        let (var_101: uint64) = (var_99 + var_100)
        ...
        let (var_104: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_94: (Union0 ref)))
        // Cuda join point
        // method_29((var_95: ManagedCuda.BasicTypes.CUdeviceptr), (var_103: ManagedCuda.BasicTypes.CUdeviceptr), (var_104: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_106: (System.Object [])) = [|var_95; var_103; var_104|]: (System.Object [])
        let (var_107: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_29", var_1, var_0)
        let (var_108: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(1u, 32u, 1u)
        var_107.set_GridDimensions(var_108)
        let (var_109: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(10u, 1u, 1u)
        var_107.set_BlockDimensions(var_109)
        let (var_110: ManagedCuda.BasicTypes.CUstream) = var_2.get_Stream()
        var_107.RunAsync(var_110, var_106)
        let (var_111: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_94: (Union0 ref)))
        let (var_112: (int64 [])) = Array.zeroCreate<int64> (System.Convert.ToInt32(32L))
        var_0.CopyToHost(var_112, var_111)
        var_0.Synchronize()
        let (var_113: int64) = var_112.LongLength
        let (var_114: int64) = 0L
        let (var_115: int64) = method_33((var_112: (int64 [])), (var_113: int64), (var_114: int64))
        var_94 := Union0Case1
        let (var_116: float32) = method_35((var_76: (Union0 ref)), (var_0: ManagedCuda.CudaContext), (var_85: (Union8 ref)), (var_88: (Union8 ref)))
        var_89 := 1.000000f
        let (var_117: float32) = method_35((var_76: (Union0 ref)), (var_0: ManagedCuda.CudaContext), (var_85: (Union8 ref)), (var_88: (Union8 ref)))
        let (var_118: float32) = (!var_89)
        let (var_119: float32) = method_28((var_76: (Union0 ref)), (var_0: ManagedCuda.CudaContext), (var_85: (Union8 ref)))
        let (var_120: float32) = (var_118 / 32.000000f)
        let (var_121: float32) = (!var_86)
        let (var_122: float32) = (var_121 + var_120)
        var_86 := var_122
        let (var_123: float32) = method_28((var_76: (Union0 ref)), (var_0: ManagedCuda.CudaContext), (var_85: (Union8 ref)))
        let (var_124: float32) = (!var_86)
        let (var_125: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_55: (Union0 ref)))
        let (var_126: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_12: (Union0 ref)))
        let (var_127: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_66: (Union0 ref)))
        // Cuda join point
        // method_36((var_124: float32), (var_123: float32), (var_125: ManagedCuda.BasicTypes.CUdeviceptr), (var_126: ManagedCuda.BasicTypes.CUdeviceptr), (var_127: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_129: (System.Object [])) = [|var_124; var_123; var_125; var_126; var_127|]: (System.Object [])
        let (var_130: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_36", var_1, var_0)
        let (var_131: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(3u, 1u, 1u)
        ...
        let (var_134: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_33: (Union0 ref)))
        let (var_135: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_66: (Union0 ref)))
        let (var_136: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_55: (Union0 ref)))
        let (var_137: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_36: (Union0 ref)))
        // Cuda join point
        // method_38((var_134: ManagedCuda.BasicTypes.CUdeviceptr), (var_135: ManagedCuda.BasicTypes.CUdeviceptr), (var_136: ManagedCuda.BasicTypes.CUdeviceptr), (var_137: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_139: (System.Object [])) = [|var_134; var_135; var_136; var_137|]: (System.Object [])
        let (var_140: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_38", var_1, var_0)
        let (var_141: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(3u, 1u, 1u)
        ...
        let (var_144: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_36: (Union0 ref)))
        let (var_145: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_6: (Union0 ref)))
        // Cuda join point
        // method_41((var_144: ManagedCuda.BasicTypes.CUdeviceptr), (var_145: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_147: (System.Object [])) = [|var_144; var_145|]: (System.Object [])
        let (var_148: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_41", var_1, var_0)
        let (var_149: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(1u, 1u, 1u)
        var_148.set_GridDimensions(var_149)
        let (var_150: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(10u, 8u, 1u)
        ...
        let (var_152: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_9: (Union0 ref)))
        let (var_153: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_10: (Union0 ref)))
        // Cuda join point
        // method_45((var_152: ManagedCuda.BasicTypes.CUdeviceptr), (var_153: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_155: (System.Object [])) = [|var_152; var_153|]: (System.Object [])
        let (var_156: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_45", var_1, var_0)
        let (var_157: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(62u, 1u, 1u)
        ...
        let (var_160: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_9: (Union0 ref)))
        ...
        let (var_163: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_6: (Union0 ref)))
        let (var_164: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_7: (Union0 ref)))
        // Cuda join point
        // method_47((var_163: ManagedCuda.BasicTypes.CUdeviceptr), (var_164: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_166: (System.Object [])) = [|var_163; var_164|]: (System.Object [])
        let (var_167: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_47", var_1, var_0)
        ...
        let (var_171: ManagedCuda.BasicTypes.CUdeviceptr) = method_13((var_6: (Union0 ref)))
        let (var_172: ManagedCuda.BasicTypes.CUstream) = var_2.get_Stream()
        let (var_173: ManagedCuda.BasicTypes.SizeT) = ManagedCuda.BasicTypes.SizeT(40L)
        var_0.ClearMemoryAsync(var_171, 0uy, var_173, var_172)
        let (var_174: float) = (float var_116)
        let (var_175: float) = (var_174 * 32.000000)
        let (var_176: float) = (var_16 + var_175)
        let (var_177: int64) = (var_15 + var_115)
        var_76 := Union0Case1
        var_66 := Union0Case1
        var_55 := Union0Case1
        var_36 := Union0Case1
        var_33 := Union0Case1
        method_49((var_0: ManagedCuda.CudaContext), (var_1: ManagedCuda.BasicTypes.CUmodule), (var_2: ManagedCuda.CudaStream), (var_3: uint64), (var_4: uint64), (var_5: System.Collections.Generic.Stack<Env2>), (var_6: (Union0 ref)), (var_7: (Union0 ref)), (var_8: ManagedCuda.CudaBlas.CudaBlasHandle), (var_9: (Union0 ref)), (var_10: (Union0 ref)), (var_11: (Union0 ref)), (var_12: (Union0 ref)), (var_13: int64), (var_14: float), (var_177: int64), (var_176: float), (var_19: int64))
    else
        (Env7(var_15, var_16))
