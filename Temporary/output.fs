...
extern "C" {
    ...
    __device__ void method_24(float var_0, float var_1, float * var_2, float * var_3, long long int var_4, float * var_5, long long int var_6);
    __device__ void method_26(float * var_0, float * var_1, float * var_2, long long int var_3, float * var_4, long long int var_5);
    __device__ void method_28(float * var_0, float * var_1, long long int var_2);
    __device__ void method_30(float * var_0, float * var_1, float * var_2, long long int var_3);
    ...
    __global__ void method_23(float var_0, float var_1, float * var_2, float * var_3, long long int var_4, float * var_5) {
        ...
        method_24(var_0, var_1, var_2, var_3, var_4, var_5, var_13);
    }
    __global__ void method_25(float * var_0, float * var_1, float * var_2, long long int var_3, float * var_4) {
        long long int var_5 = threadIdx.x;
        long long int var_6 = threadIdx.y;
        ...
        method_26(var_0, var_1, var_2, var_3, var_4, var_12);
    }
    __global__ void method_27(float * var_0, float * var_1) {
    ...
    __global__ void method_29(float * var_0, float * var_1, float * var_2) {
        ...
        long long int var_9 = (var_6 * 128);
        long long int var_10 = (var_9 + var_3);
        method_30(var_0, var_1, var_2, var_10);
    }
    __device__ void method_14(float * var_0, long long int var_1, float * var_2, long long int var_3) {
    ...
    __device__ void method_24(float var_0, float var_1, float * var_2, float * var_3, long long int var_4, float * var_5, long long int var_6) {
        ...
        if (var_7) {
            ...
            method_24(var_0, var_1, var_2, var_3, var_4, var_5, var_22);
        } else {
        }
    }
    __device__ void method_26(float * var_0, float * var_1, float * var_2, long long int var_3, float * var_4, long long int var_5) {
        ...
        if (var_6) {
            ...
            method_26(var_0, var_1, var_2, var_3, var_4, var_21);
        } else {
        }
    }
    __device__ void method_28(float * var_0, float * var_1, long long int var_2) {
    ...
    __device__ void method_30(float * var_0, float * var_1, float * var_2, long long int var_3) {
        ...
        if (var_4) {
            ...
            var_7[0] = var_13;
            long long int var_14 = (var_3 + 8192);
            method_30(var_0, var_1, var_2, var_14);
        } else {
        }
    }
}
...
and method_11((var_0: uint64), (var_1: uint64), (var_2: System.Collections.Generic.Stack<Env3>), (var_3: ManagedCuda.CudaContext), (var_4: ManagedCuda.BasicTypes.CUmodule), (var_5: ManagedCuda.CudaStream), (var_6: ManagedCuda.CudaBlas.CudaBlas), (var_7: EnvStack2), (var_8: EnvStack2), (var_9: EnvStack2), (var_10: int64), (var_11: int64), (var_12: int64), (var_13: int64), (var_14: int64), (var_15: EnvStack2), (var_16: int64), (var_17: int64), (var_18: int64), (var_19: int64), (var_20: int64)): float =
    ...
    if var_21 then
        ...
        if var_63 then
            ...
            let (var_74: ManagedCuda.BasicTypes.CUdeviceptr) = method_12((var_38: int64), (var_73: ManagedCuda.BasicTypes.CUdeviceptr))
            if var_68 then
                (failwith "Tensor needs to be at least size 1.")
            else
                ()
            ...
            let (var_77: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_76: ManagedCuda.BasicTypes.CUdeviceptr))
            ...
            let (var_89: ManagedCuda.BasicTypes.CUdeviceptr) = method_12((var_38: int64), (var_88: ManagedCuda.BasicTypes.CUdeviceptr))
            let (var_90: (Union0 ref)) = var_8.mem_0
            let (var_91: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_90: (Union0 ref)))
            let (var_92: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_91: ManagedCuda.BasicTypes.CUdeviceptr))
            if var_83 then
                (failwith "Tensor needs to be at least size 1.")
            else
                ()
            ...
            let (var_95: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_94: ManagedCuda.BasicTypes.CUdeviceptr))
        ...
        let (var_108: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_107: ManagedCuda.BasicTypes.CUdeviceptr))
        if var_104 then
            (failwith "Tensor needs to be at least size 1.")
        else
            ()
        ...
        let (var_120: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_119: ManagedCuda.BasicTypes.CUdeviceptr))
        if var_117 then
            (failwith "Tensor needs to be at least size 1.")
        else
            ()
        ...
        // Cuda join point
        // method_13((var_120: ManagedCuda.BasicTypes.CUdeviceptr), (var_52: int64), (var_123: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_125: (System.Object [])) = [|var_120; var_52; var_123|]: (System.Object [])
        let (var_126: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_13", var_4, var_3)
        ...
        let (var_133: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_132: ManagedCuda.BasicTypes.CUdeviceptr))
        if var_104 then
            (failwith "Tensor needs to be at least size 1.")
        else
            ()
        ...
        let (var_141: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_140: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_142: (Union0 ref)) = var_15.mem_0
        let (var_143: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_142: (Union0 ref)))
        let (var_144: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_143: ManagedCuda.BasicTypes.CUdeviceptr))
        ...
        let (var_158: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_157: ManagedCuda.BasicTypes.CUdeviceptr))
        // Cuda join point
        // method_15((var_141: ManagedCuda.BasicTypes.CUdeviceptr), (var_144: ManagedCuda.BasicTypes.CUdeviceptr), (var_52: int64), (var_158: ManagedCuda.BasicTypes.CUdeviceptr), (var_149: int64))
        let (var_160: (System.Object [])) = [|var_141; var_144; var_52; var_158; var_149|]: (System.Object [])
        let (var_161: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_15", var_4, var_3)
        ...
        let (var_172: float32) = method_22((var_27: int64), (var_155: EnvStack2), (var_149: int64), (var_3: ManagedCuda.CudaContext), (var_167: (Union11 ref)), (var_170: (Union11 ref)))
        ...
        var_171 := 1.000000f
        let (var_181: float32) = method_22((var_27: int64), (var_155: EnvStack2), (var_149: int64), (var_3: ManagedCuda.CudaContext), (var_167: (Union11 ref)), (var_170: (Union11 ref)))
        let (var_182: float32) = (!var_171)
        let (var_183: float32) = method_21((var_155: EnvStack2), (var_149: int64), (var_3: ManagedCuda.CudaContext), (var_167: (Union11 ref)))
        ...
        var_168 := var_187
        let (var_188: float32) = method_21((var_155: EnvStack2), (var_149: int64), (var_3: ManagedCuda.CudaContext), (var_167: (Union11 ref)))
        ...
        let (var_194: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_193: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_195: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_142: (Union0 ref)))
        let (var_196: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_195: ManagedCuda.BasicTypes.CUdeviceptr))
        if var_117 then
            (failwith "Tensor needs to be at least size 1.")
        else
            ()
        let (var_197: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_131: (Union0 ref)))
        let (var_198: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_197: ManagedCuda.BasicTypes.CUdeviceptr))
        // Cuda join point
        // method_23((var_189: float32), (var_188: float32), (var_194: ManagedCuda.BasicTypes.CUdeviceptr), (var_196: ManagedCuda.BasicTypes.CUdeviceptr), (var_52: int64), (var_198: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_200: (System.Object [])) = [|var_189; var_188; var_194; var_196; var_52; var_198|]: (System.Object [])
        let (var_201: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_23", var_4, var_3)
        ...
        let (var_206: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_205: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_207: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_131: (Union0 ref)))
        let (var_208: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_207: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_209: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_121: (Union0 ref)))
        let (var_210: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_209: ManagedCuda.BasicTypes.CUdeviceptr))
        if var_117 then
            (failwith "Tensor needs to be at least size 1.")
        else
            ()
        let (var_211: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_106: (Union0 ref)))
        let (var_212: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_211: ManagedCuda.BasicTypes.CUdeviceptr))
        // Cuda join point
        // method_25((var_206: ManagedCuda.BasicTypes.CUdeviceptr), (var_208: ManagedCuda.BasicTypes.CUdeviceptr), (var_210: ManagedCuda.BasicTypes.CUdeviceptr), (var_52: int64), (var_212: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_214: (System.Object [])) = [|var_206; var_208; var_210; var_52; var_212|]: (System.Object [])
        let (var_215: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_25", var_4, var_3)
        ...
        if var_62 then
            ...
            let (var_227: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_226: ManagedCuda.BasicTypes.CUdeviceptr))
            let (var_228: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_225: (Union0 ref)))
            let (var_229: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_228: ManagedCuda.BasicTypes.CUdeviceptr))
            // Cuda join point
            // method_27((var_227: ManagedCuda.BasicTypes.CUdeviceptr), (var_229: ManagedCuda.BasicTypes.CUdeviceptr))
            let (var_231: (System.Object [])) = [|var_227; var_229|]: (System.Object [])
            let (var_232: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_27", var_4, var_3)
            ...
            let (var_241: ManagedCuda.BasicTypes.CUdeviceptr) = method_12((var_38: int64), (var_240: ManagedCuda.BasicTypes.CUdeviceptr))
            if var_104 then
                (failwith "Tensor needs to be at least size 1.")
            else
                ()
            let (var_242: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_106: (Union0 ref)))
            let (var_243: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_242: ManagedCuda.BasicTypes.CUdeviceptr))
            let (var_244: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_225: (Union0 ref)))
            let (var_245: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_244: ManagedCuda.BasicTypes.CUdeviceptr))
            ...
            if var_61 then
                ...
                let (var_251: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_250: ManagedCuda.BasicTypes.CUdeviceptr))
                if var_104 then
                    (failwith "Tensor needs to be at least size 1.")
                else
                    ()
                ...
                let (var_257: ManagedCuda.BasicTypes.CUdeviceptr) = method_12((var_38: int64), (var_256: ManagedCuda.BasicTypes.CUdeviceptr))
                let (var_258: (Union0 ref)) = var_7.mem_0
                let (var_259: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_258: (Union0 ref)))
                let (var_260: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_259: ManagedCuda.BasicTypes.CUdeviceptr))
                ...
                let (var_271: ManagedCuda.BasicTypes.CUdeviceptr) = method_12((var_38: int64), (var_270: ManagedCuda.BasicTypes.CUdeviceptr))
                if var_104 then
                    (failwith "Tensor needs to be at least size 1.")
                else
                    ()
                let (var_272: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_106: (Union0 ref)))
                let (var_273: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_272: ManagedCuda.BasicTypes.CUdeviceptr))
                let (var_274: (Union0 ref)) = var_7.mem_0
                let (var_275: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_274: (Union0 ref)))
                let (var_276: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_275: ManagedCuda.BasicTypes.CUdeviceptr))
        ...
        let (var_286: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_285: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_287: (Union0 ref)) = var_8.mem_0
        let (var_288: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_287: (Union0 ref)))
        let (var_289: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_288: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_290: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_287: (Union0 ref)))
        let (var_291: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_290: ManagedCuda.BasicTypes.CUdeviceptr))
        // Cuda join point
        // method_29((var_286: ManagedCuda.BasicTypes.CUdeviceptr), (var_289: ManagedCuda.BasicTypes.CUdeviceptr), (var_291: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_293: (System.Object [])) = [|var_286; var_289; var_291|]: (System.Object [])
        let (var_294: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_29", var_4, var_3)
        ...
        let (var_299: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_298: ManagedCuda.BasicTypes.CUdeviceptr))
        ...
        var_106 := Union0Case1
        var_118 := Union0Case1
        method_31((var_0: uint64), (var_1: uint64), (var_2: System.Collections.Generic.Stack<Env3>), (var_3: ManagedCuda.CudaContext), (var_4: ManagedCuda.BasicTypes.CUmodule), (var_5: ManagedCuda.CudaStream), (var_6: ManagedCuda.CudaBlas.CudaBlas), (var_7: EnvStack2), (var_8: EnvStack2), (var_9: EnvStack2), (var_10: int64), (var_11: int64), (var_12: int64), (var_13: int64), (var_14: int64), (var_15: EnvStack2), (var_16: int64), (var_17: int64), (var_18: int64), (var_19: int64), (var_20: int64), (var_22: int64), (var_305: float))
    else
        0.000000
...
and method_21((var_0: EnvStack2), (var_1: int64), (var_2: ManagedCuda.CudaContext), (var_3: (Union11 ref))): float32 =
    ...
    | Union11Case1 ->
        ...
        var_7
and method_31((var_0: uint64), (var_1: uint64), (var_2: System.Collections.Generic.Stack<Env3>), (var_3: ManagedCuda.CudaContext), (var_4: ManagedCuda.BasicTypes.CUmodule), (var_5: ManagedCuda.CudaStream), (var_6: ManagedCuda.CudaBlas.CudaBlas), (var_7: EnvStack2), (var_8: EnvStack2), (var_9: EnvStack2), (var_10: int64), (var_11: int64), (var_12: int64), (var_13: int64), (var_14: int64), (var_15: EnvStack2), (var_16: int64), (var_17: int64), (var_18: int64), (var_19: int64), (var_20: int64), (var_21: int64), (var_22: float)): float =
    ...
    if var_23 then
        ...
        if var_65 then
            ...
            let (var_76: ManagedCuda.BasicTypes.CUdeviceptr) = method_12((var_40: int64), (var_75: ManagedCuda.BasicTypes.CUdeviceptr))
            if var_70 then
                (failwith "Tensor needs to be at least size 1.")
            else
                ()
            ...
            let (var_79: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_78: ManagedCuda.BasicTypes.CUdeviceptr))
            ...
            let (var_91: ManagedCuda.BasicTypes.CUdeviceptr) = method_12((var_40: int64), (var_90: ManagedCuda.BasicTypes.CUdeviceptr))
            let (var_92: (Union0 ref)) = var_8.mem_0
            let (var_93: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_92: (Union0 ref)))
            let (var_94: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_93: ManagedCuda.BasicTypes.CUdeviceptr))
            if var_85 then
                (failwith "Tensor needs to be at least size 1.")
            else
                ()
            ...
            let (var_97: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_96: ManagedCuda.BasicTypes.CUdeviceptr))
        ...
        let (var_110: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_109: ManagedCuda.BasicTypes.CUdeviceptr))
        if var_106 then
            (failwith "Tensor needs to be at least size 1.")
        else
            ()
        ...
        let (var_122: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_121: ManagedCuda.BasicTypes.CUdeviceptr))
        if var_119 then
            (failwith "Tensor needs to be at least size 1.")
        else
            ()
        ...
        // Cuda join point
        // method_13((var_122: ManagedCuda.BasicTypes.CUdeviceptr), (var_54: int64), (var_125: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_127: (System.Object [])) = [|var_122; var_54; var_125|]: (System.Object [])
        let (var_128: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_13", var_4, var_3)
        ...
        let (var_135: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_134: ManagedCuda.BasicTypes.CUdeviceptr))
        if var_106 then
            (failwith "Tensor needs to be at least size 1.")
        else
            ()
        ...
        let (var_143: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_142: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_144: (Union0 ref)) = var_15.mem_0
        let (var_145: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_144: (Union0 ref)))
        let (var_146: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_145: ManagedCuda.BasicTypes.CUdeviceptr))
        ...
        let (var_160: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_159: ManagedCuda.BasicTypes.CUdeviceptr))
        // Cuda join point
        // method_15((var_143: ManagedCuda.BasicTypes.CUdeviceptr), (var_146: ManagedCuda.BasicTypes.CUdeviceptr), (var_54: int64), (var_160: ManagedCuda.BasicTypes.CUdeviceptr), (var_151: int64))
        let (var_162: (System.Object [])) = [|var_143; var_146; var_54; var_160; var_151|]: (System.Object [])
        let (var_163: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_15", var_4, var_3)
        ...
        let (var_174: float32) = method_22((var_29: int64), (var_157: EnvStack2), (var_151: int64), (var_3: ManagedCuda.CudaContext), (var_169: (Union11 ref)), (var_172: (Union11 ref)))
        ...
        System.Console.WriteLine("Running the backwards phase...")
        var_173 := 1.000000f
        let (var_183: float32) = method_22((var_29: int64), (var_157: EnvStack2), (var_151: int64), (var_3: ManagedCuda.CudaContext), (var_169: (Union11 ref)), (var_172: (Union11 ref)))
        let (var_184: float32) = (!var_173)
        let (var_185: float32) = method_21((var_157: EnvStack2), (var_151: int64), (var_3: ManagedCuda.CudaContext), (var_169: (Union11 ref)))
        ...
        var_170 := var_189
        let (var_190: float32) = method_21((var_157: EnvStack2), (var_151: int64), (var_3: ManagedCuda.CudaContext), (var_169: (Union11 ref)))
        ...
        let (var_200: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_199: ManagedCuda.BasicTypes.CUdeviceptr))
        // Cuda join point
        // method_23((var_191: float32), (var_190: float32), (var_196: ManagedCuda.BasicTypes.CUdeviceptr), (var_198: ManagedCuda.BasicTypes.CUdeviceptr), (var_54: int64), (var_200: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_202: (System.Object [])) = [|var_191; var_190; var_196; var_198; var_54; var_200|]: (System.Object [])
        let (var_203: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_23", var_4, var_3)
        ...
        let (var_214: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_213: ManagedCuda.BasicTypes.CUdeviceptr))
        // Cuda join point
        // method_25((var_208: ManagedCuda.BasicTypes.CUdeviceptr), (var_210: ManagedCuda.BasicTypes.CUdeviceptr), (var_212: ManagedCuda.BasicTypes.CUdeviceptr), (var_54: int64), (var_214: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_216: (System.Object [])) = [|var_208; var_210; var_212; var_54; var_214|]: (System.Object [])
        let (var_217: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_25", var_4, var_3)
        ...
        if var_64 then
            ...
            let (var_231: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_230: ManagedCuda.BasicTypes.CUdeviceptr))
            // Cuda join point
            // method_27((var_229: ManagedCuda.BasicTypes.CUdeviceptr), (var_231: ManagedCuda.BasicTypes.CUdeviceptr))
            let (var_233: (System.Object [])) = [|var_229; var_231|]: (System.Object [])
            let (var_234: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_27", var_4, var_3)
            ...
            let (var_243: ManagedCuda.BasicTypes.CUdeviceptr) = method_12((var_40: int64), (var_242: ManagedCuda.BasicTypes.CUdeviceptr))
            if var_106 then
                (failwith "Tensor needs to be at least size 1.")
            else
                ()
            ...
            let (var_247: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_246: ManagedCuda.BasicTypes.CUdeviceptr))
            ...
            if var_63 then
                ...
                let (var_253: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_252: ManagedCuda.BasicTypes.CUdeviceptr))
                if var_106 then
                    (failwith "Tensor needs to be at least size 1.")
                else
                    ()
                ...
                let (var_259: ManagedCuda.BasicTypes.CUdeviceptr) = method_12((var_40: int64), (var_258: ManagedCuda.BasicTypes.CUdeviceptr))
                let (var_260: (Union0 ref)) = var_7.mem_0
                let (var_261: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_260: (Union0 ref)))
                let (var_262: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_261: ManagedCuda.BasicTypes.CUdeviceptr))
                ...
                let (var_273: ManagedCuda.BasicTypes.CUdeviceptr) = method_12((var_40: int64), (var_272: ManagedCuda.BasicTypes.CUdeviceptr))
                if var_106 then
                    (failwith "Tensor needs to be at least size 1.")
                else
                    ()
                let (var_274: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_108: (Union0 ref)))
                let (var_275: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_274: ManagedCuda.BasicTypes.CUdeviceptr))
                let (var_276: (Union0 ref)) = var_7.mem_0
                let (var_277: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_276: (Union0 ref)))
                let (var_278: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_277: ManagedCuda.BasicTypes.CUdeviceptr))
        ...
        let (var_288: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_287: ManagedCuda.BasicTypes.CUdeviceptr))
        ...
        let (var_293: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_292: ManagedCuda.BasicTypes.CUdeviceptr))
        // Cuda join point
        // method_29((var_288: ManagedCuda.BasicTypes.CUdeviceptr), (var_291: ManagedCuda.BasicTypes.CUdeviceptr), (var_293: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_295: (System.Object [])) = [|var_288; var_291; var_293|]: (System.Object [])
        let (var_296: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_29", var_4, var_3)
        ...
        let (var_301: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_300: ManagedCuda.BasicTypes.CUdeviceptr))
...
let (var_237: ManagedCuda.BasicTypes.CUdeviceptr) = method_10((var_236: ManagedCuda.BasicTypes.CUdeviceptr))
