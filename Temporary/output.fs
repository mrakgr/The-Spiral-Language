...
inl label = s.CudaTensor.zero {elem_type=float; dim=batch_size,hidden_size}
    ^
Error trace on line: 19, column: 9 in file "learning6".
    inl label = input hidden_size
        ^
Error trace on line: 20, column: 9 in file "learning6".
    inl input = input input_size
        ^
Error trace on line: 22, column: 9 in file "learning6".
        input
        ^
Error trace on line: 24, column: 9 in file "learning6".
        |> error square label
        ^
Variable error not bound.
