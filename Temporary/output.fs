...
let rec method_1((var_0: Rec0), (var_1: Rec0)): int64 =
    let (var_2: int64) = method_2((var_0: Rec0))
    let (var_3: int64) = method_2((var_1: Rec0))
    (var_2 * var_3)
and method_2((var_0: Rec0)): int64 =
    match var_0 with
    | Rec0Case0(var_1) ->
        let (var_4: Rec0) = var_1.mem_0
        let (var_5: Rec0) = var_1.mem_1
        let (var_6: int64) = method_2((var_4: Rec0))
        let (var_7: int64) = method_2((var_5: Rec0))
        (var_6 + var_7)
    | Rec0Case1(var_2) ->
        let (var_9: Rec0) = var_2.mem_0
        let (var_10: Rec0) = var_2.mem_1
        let (var_11: int64) = method_2((var_9: Rec0))
        let (var_12: int64) = method_2((var_10: Rec0))
        (var_11 * var_12)
    | Rec0Case2(var_3) ->
        var_3.mem_0
