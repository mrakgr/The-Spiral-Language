...
extern "C" {
    ...
    __device__ void method_7(long long int var_0, long long int var_1, long long int var_2, float * var_3, float * var_4, float * var_5, long long int var_6, long long int var_7, long long int var_8, long long int var_9);
    ...
    __device__ void method_7(long long int var_0, long long int var_1, long long int var_2, float * var_3, float * var_4, float * var_5, long long int var_6, long long int var_7, long long int var_8, long long int var_9) {
        ...
        if (var_10) {
            ...
            Tuple0 var_24 = cub::BlockReduce<Tuple0,16>().Reduce(make_Tuple0(var_19, var_20), var_23);
            ...
            long long int var_29 = (var_9 + 32);
            method_7(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_29);
        } else {
        }
    }
    __device__ Tuple0 method_8(float * var_0, long long int var_1, float * var_2, float var_3, float var_4, long long int var_5) {
...
and method_17((var_0: ManagedCuda.CudaContext), (var_1: ManagedCuda.CudaStream), (var_2: uint64), (var_3: uint64), (var_4: System.Collections.Generic.Stack<Env2>), (var_5: (Union0 ref)), (var_6: int64), (var_7: int64), (var_8: int64), (var_9: int64)): unit =
    ...
    let (var_21: string) = method_14((var_17: System.Text.StringBuilder), (var_16: (float32 [])), (var_6: int64), (var_7: int64), (var_8: int64), (var_9: int64), (var_18: string))
...
let (var_62: ManagedCuda.BasicTypes.SizeT) = ManagedCuda.BasicTypes.SizeT(512L)
var_51.GenerateUniform32(var_61, var_62)
let (var_63: int64) = 128L
...
let (var_66: ManagedCuda.BasicTypes.CUdeviceptr) = method_5((var_55: (Union0 ref)))
let (var_67: ManagedCuda.BasicTypes.CUdeviceptr) = method_5((var_60: (Union0 ref)))
let (var_68: ManagedCuda.BasicTypes.CUdeviceptr) = method_5((var_65: (Union0 ref)))
// Cuda join point
// method_6((var_66: ManagedCuda.BasicTypes.CUdeviceptr), (var_67: ManagedCuda.BasicTypes.CUdeviceptr), (var_68: ManagedCuda.BasicTypes.CUdeviceptr))
let (var_70: (System.Object [])) = [|var_66; var_67; var_68|]: (System.Object [])
let (var_71: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_6", var_32, var_1)
let (var_72: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(1u, 32u, 1u)
var_71.set_GridDimensions(var_72)
let (var_73: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(16u, 1u, 1u)
var_71.set_BlockDimensions(var_73)
let (var_74: ManagedCuda.BasicTypes.CUstream) = var_49.get_Stream()
var_71.RunAsync(var_74, var_70)
let (var_75: int64) = 0L
let (var_76: int64) = 0L
let (var_77: int64) = 16L
let (var_78: int64) = 1L
let (var_79: int64) = 0L
let (var_80: int64) = 32L
let (var_81: int64) = 0L
let (var_82: int64) = 16L
method_10((var_1: ManagedCuda.CudaContext), (var_49: ManagedCuda.CudaStream), (var_47: uint64), (var_48: uint64), (var_44: System.Collections.Generic.Stack<Env2>), (var_55: (Union0 ref)), (var_75: int64), (var_76: int64), (var_77: int64), (var_78: int64), (var_79: int64), (var_80: int64), (var_81: int64), (var_82: int64))
let (var_83: int64) = 0L
let (var_84: int64) = 1L
let (var_85: int64) = 0L
let (var_86: int64) = 32L
method_17((var_1: ManagedCuda.CudaContext), (var_49: ManagedCuda.CudaStream), (var_47: uint64), (var_48: uint64), (var_44: System.Collections.Generic.Stack<Env2>), (var_65: (Union0 ref)), (var_83: int64), (var_84: int64), (var_85: int64), (var_86: int64))
var_65 := Union0Case1
var_60 := Union0Case1
var_55 := Union0Case1
var_51.Dispose()
var_49.Dispose()
let (var_87: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_43: (Union0 ref)))
