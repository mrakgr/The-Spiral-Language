...
// Cuda join point
// method_1()
let (var_36: (System.Object [])) = [||]: (System.Object [])
let (var_37: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_1", var_32, var_1)
let (var_38: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(1u, 1u, 1u)
var_37.set_GridDimensions(var_38)
let (var_39: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(1u, 1u, 1u)
var_37.set_BlockDimensions(var_39)
let (var_40: float32) = var_37.Run(var_36)
var_1.Dispose()
var_40
