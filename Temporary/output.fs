...
and method_14((var_0: ManagedCuda.CudaContext), (var_1: ManagedCuda.BasicTypes.CUmodule), (var_2: ManagedCuda.CudaStream), (var_3: uint64), (var_4: uint64), (var_5: System.Collections.Generic.Stack<Env3>), (var_6: EnvStack2), (var_7: EnvStack2), (var_8: ManagedCuda.CudaBlas.CudaBlasHandle), (var_9: EnvStack2), (var_10: EnvStack2), (var_11: EnvStack2), (var_12: EnvStack2), (var_13: int64), (var_14: float), (var_15: int64)): Env7 =
    ...
    if var_16 then
        ...
        if var_41 then
            ...
            ()
        let (var_200: int64) = (var_28 * 4L)
        let (var_201: EnvStack2) = method_10((var_3: uint64), (var_5: System.Collections.Generic.Stack<Env3>), (var_4: uint64), (var_200: int64))
        let (var_202: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_69: (Union0 ref)))
        let (var_203: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_90: (Union0 ref)))
        let (var_204: ManagedCuda.BasicTypes.SizeT) = var_203.Pointer
        let (var_205: uint64) = uint64 var_204
        let (var_206: uint64) = (var_205 + var_94)
        ...
        let (var_209: (Union0 ref)) = var_201.mem_0
        let (var_210: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_209: (Union0 ref)))
        // Cuda join point
        // method_32((var_28: int64), (var_202: ManagedCuda.BasicTypes.CUdeviceptr), (var_208: ManagedCuda.BasicTypes.CUdeviceptr), (var_210: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_211: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_32", var_1, var_0)
        let (var_212: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(1u, 64u, 1u)
        var_211.set_GridDimensions(var_212)
        let (var_213: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(10u, 1u, 1u)
        var_211.set_BlockDimensions(var_213)
        let (var_214: ManagedCuda.BasicTypes.CUstream) = var_2.get_Stream()
        let (var_216: (System.Object [])) = [|var_28; var_202; var_208; var_210|]: (System.Object [])
        ...
        if var_41 then
            ...
            ()
        let (var_218: (float32 [])) = Array.zeroCreate<float32> (System.Convert.ToInt32(var_28))
        let (var_219: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_209: (Union0 ref)))
        var_0.CopyToHost(var_218, var_219)
        let (var_220: int64) = var_218.LongLength
        let (var_221: int64) = 0L
        let (var_222: int64) = method_35((var_218: (float32 [])), (var_220: int64), (var_217: int64), (var_221: int64))
        var_209 := Union0Case1
        let (var_223: int64) = (var_13 + var_222)
        var_84 := Union0Case1
        var_69 := Union0Case1
        var_43 := Union0Case1
        var_51 := Union0Case1
        method_14((var_0: ManagedCuda.CudaContext), (var_1: ManagedCuda.BasicTypes.CUmodule), (var_2: ManagedCuda.CudaStream), (var_3: uint64), (var_4: uint64), (var_5: System.Collections.Generic.Stack<Env3>), (var_6: EnvStack2), (var_7: EnvStack2), (var_8: ManagedCuda.CudaBlas.CudaBlasHandle), (var_9: EnvStack2), (var_10: EnvStack2), (var_11: EnvStack2), (var_12: EnvStack2), (var_223: int64), (var_199: float), (var_17: int64))
    else
        (Env7(var_13, var_14))
