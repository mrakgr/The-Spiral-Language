...
extern "C" {
    ...
    __global__ void method_17(float * var_0, long long int var_1, float * var_2, float * var_3);
    ...
    __global__ void method_17(float * var_0, long long int var_1, float * var_2, float * var_3) {
        ...
        while (method_18(var_11)) {
            ...
            long long int var_21 = (var_1 + var_20);
            char var_23;
            if (var_16) {
                var_23 = (var_14 < 2);
            } else {
            ...
            while (method_19(var_28)) {
                ...
                long long int var_40 = (var_21 + var_31);
            ...
            Tuple2 var_55 = cub::BlockReduce<Tuple2,1>().Reduce(make_Tuple2(var_50, var_51), var_54);
...
and method_12((var_0: EnvStack2), (var_1: uint64), (var_2: uint64), (var_3: System.Collections.Generic.Stack<Env3>), (var_4: ManagedCuda.CudaContext), (var_5: ManagedCuda.BasicTypes.CUmodule), (var_6: ManagedCuda.CudaStream), (var_7: EnvStack2), (var_8: int64)): unit =
    ...
    if var_9 then
        ...
        let (var_23: (Union0 ref)) = var_0.mem_0
        let (var_24: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_23: (Union0 ref)))
        let (var_25: (Union0 ref)) = var_22.mem_0
        let (var_26: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_25: (Union0 ref)))
        // Cuda join point
        // method_13((var_24: ManagedCuda.BasicTypes.CUdeviceptr), (var_26: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_28: (System.Object [])) = [|var_24; var_26|]: (System.Object [])
        let (var_29: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_13", var_5, var_4)
        let (var_30: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(1u, 1u, 1u)
        var_29.set_GridDimensions(var_30)
        let (var_31: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(128u, 1u, 1u)
        var_29.set_BlockDimensions(var_31)
        let (var_32: ManagedCuda.BasicTypes.CUstream) = var_6.get_Stream()
        var_29.RunAsync(var_32, var_28)
        let (var_33: int64) = 40L
        let (var_34: EnvStack2) = method_2((var_1: uint64), (var_3: System.Collections.Generic.Stack<Env3>), (var_2: uint64), (var_33: int64))
        let (var_35: (Union0 ref)) = var_7.mem_0
        let (var_36: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_35: (Union0 ref)))
        let (var_37: (Union0 ref)) = var_34.mem_0
        let (var_38: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_37: (Union0 ref)))
        // Cuda join point
        // method_13((var_36: ManagedCuda.BasicTypes.CUdeviceptr), (var_38: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_40: (System.Object [])) = [|var_36; var_38|]: (System.Object [])
        let (var_41: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_13", var_5, var_4)
        let (var_42: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(1u, 1u, 1u)
        ...
        let (var_44: ManagedCuda.BasicTypes.CUstream) = var_6.get_Stream()
        var_41.RunAsync(var_44, var_40)
        let (var_45: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_25: (Union0 ref)))
        let (var_46: (float32 [])) = Array.zeroCreate<float32> (System.Convert.ToInt32(10L))
        var_4.CopyToHost(var_46, var_45)
        var_4.Synchronize()
        let (var_47: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_37: (Union0 ref)))
        let (var_48: (float32 [])) = Array.zeroCreate<float32> (System.Convert.ToInt32(10L))
        var_4.CopyToHost(var_48, var_47)
        var_4.Synchronize()
        let (var_49: System.Text.StringBuilder) = System.Text.StringBuilder()
        let (var_50: string) = ""
        let (var_51: int64) = 0L
        method_6((var_49: System.Text.StringBuilder), (var_51: int64))
        let (var_52: System.Text.StringBuilder) = var_49.AppendLine("[|")
        let (var_53: int64) = 0L
        method_15((var_49: System.Text.StringBuilder), (var_50: string), (var_46: (float32 [])), (var_48: (float32 [])), (var_53: int64))
        let (var_54: int64) = 0L
        method_6((var_49: System.Text.StringBuilder), (var_54: int64))
        let (var_55: System.Text.StringBuilder) = var_49.AppendLine("|]")
        let (var_56: string) = var_49.ToString()
        let (var_57: string) = System.String.Format("{0}",var_56)
        System.Console.WriteLine(var_57)
        var_37 := Union0Case1
        var_25 := Union0Case1
        let (var_58: int64) = 8L
        let (var_59: EnvStack2) = method_2((var_1: uint64), (var_3: System.Collections.Generic.Stack<Env3>), (var_2: uint64), (var_58: int64))
        let (var_60: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_23: (Union0 ref)))
        let (var_61: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_35: (Union0 ref)))
        let (var_62: (Union0 ref)) = var_59.mem_0
        let (var_63: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_62: (Union0 ref)))
        // Cuda join point
        // method_17((var_60: ManagedCuda.BasicTypes.CUdeviceptr), (var_17: int64), (var_61: ManagedCuda.BasicTypes.CUdeviceptr), (var_63: ManagedCuda.BasicTypes.CUdeviceptr))
        let (var_65: (System.Object [])) = [|var_60; var_17; var_61; var_63|]: (System.Object [])
        let (var_66: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_17", var_5, var_4)
        ...
        let (var_69: ManagedCuda.BasicTypes.CUstream) = var_6.get_Stream()
        var_66.RunAsync(var_69, var_65)
        let (var_70: float32) = 0.000000f
        let (var_71: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_62: (Union0 ref)))
        let (var_72: (float32 [])) = Array.zeroCreate<float32> (System.Convert.ToInt32(2L))
        var_4.CopyToHost(var_72, var_71)
        var_4.Synchronize()
        let (var_73: int64) = var_72.LongLength
        let (var_74: int64) = 0L
        let (var_75: float32) = method_21((var_72: (float32 [])), (var_73: int64), (var_70: float32), (var_74: int64))
        let (var_76: int64) = (int64 var_75)
        var_62 := Union0Case1
...
and method_15((var_0: System.Text.StringBuilder), (var_1: string), (var_2: (float32 [])), (var_3: (float32 [])), (var_4: int64)): unit =
    ...
    if var_5 then
        ...
        ()
and method_21((var_0: (float32 [])), (var_1: int64), (var_2: float32), (var_3: int64)): float32 =
    let (var_4: bool) = (var_3 < var_1)
    if var_4 then
        let (var_5: float32) = var_0.[int32 var_3]
        let (var_6: float32) = (var_2 + var_5)
        let (var_7: int64) = (var_3 + 1L)
        method_21((var_0: (float32 [])), (var_1: int64), (var_6: float32), (var_7: int64))
    else
        var_2
