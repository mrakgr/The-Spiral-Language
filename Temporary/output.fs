...
let rec method_1((var_0: (int64 [])), (var_1: int64)): unit =
    ...
    if var_2 then
        ...
        if var_4 then
            ...
            ()
        let (var_5: int64) = (var_1 * 9L)
        let (var_6: int64) = 0L
        method_2((var_1: int64), (var_0: (int64 [])), (var_5: int64), (var_6: int64))
        let (var_7: int64) = (var_1 + 1L)
        method_1((var_0: (int64 [])), (var_7: int64))
    else
        ()
...
and method_2((var_0: int64), (var_1: (int64 [])), (var_2: int64), (var_3: int64)): unit =
    ...
    if var_4 then
        ...
        let (var_8: int64) = (var_0 + 1L)
        let (var_9: int64) = (var_3 + 2L)
        let (var_10: int64) = 2L
        let (var_11: int64) = method_3((var_8: int64), (var_9: int64), (var_10: int64))
        var_1.[int32 var_7] <- var_11
        let (var_12: int64) = (var_3 + 1L)
        method_2((var_0: int64), (var_1: (int64 [])), (var_2: int64), (var_12: int64))
    else
        ()
...
and method_12((var_0: int64), (var_1: (int64 [])), (var_2: int64), (var_3: int64), (var_4: int64), (var_5: int64)): int64 =
    ...
    if var_6 then
        ...
        if var_11 then
            ...
            ()
        let (var_12: int64) = (var_7 * 9L)
        let (var_13: int64) = (var_0 - 2L)
