...
extern "C" {
    ...
    __device__ void method_9(long long int var_0, long long int var_1, long long int var_2, long long int * var_3, long long int * var_4, long long int var_5, long long int var_6, long long int var_7, long long int var_8);
    __device__ long long int method_10(long long int var_0, long long int * var_1, long long int var_2, long long int var_3);
    __device__ void method_11(long long int * var_0, long long int var_1, long long int * var_2, long long int var_3, long long int var_4, long long int var_5);
    ...
    __global__ void method_8(long long int * var_0, long long int * var_1) {
        ...
        method_9(var_5, var_6, var_7, var_0, var_1, var_2, var_3, var_4, var_9);
    }
    __device__ void method_9(long long int var_0, long long int var_1, long long int var_2, long long int * var_3, long long int * var_4, long long int var_5, long long int var_6, long long int var_7, long long int var_8) {
        char var_9 = (var_8 < 8);
        if (var_9) {
            ...
            long long int var_15 = method_10(var_8, var_3, var_14, var_13);
            ...
            if (var_29) {
                ...
                method_11(var_16, var_21, var_4, var_8, var_15, var_30);
            } else {
            }
            long long int var_31 = (var_8 + 8);
            method_9(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_31);
        } else {
        }
    }
    __device__ long long int method_10(long long int var_0, long long int * var_1, long long int var_2, long long int var_3) {
        ...
        if (var_4) {
            ...
            long long int var_14 = (var_2 + var_13);
            long long int var_15 = (var_3 + 8);
            return method_10(var_0, var_1, var_14, var_15);
        } else {
            return var_2;
        }
    }
    __device__ void method_11(long long int * var_0, long long int var_1, long long int * var_2, long long int var_3, long long int var_4, long long int var_5) {
        ...
        if (var_6) {
            ...
            method_11(var_0, var_1, var_2, var_3, var_12, var_13);
        } else {
...
and method_2((var_0: (int64 [])), (var_1: int64)): unit =
    ...
    if var_2 then
        ...
        ()
and method_4((var_0: uint64), (var_1: System.Collections.Generic.Stack<Env2>), (var_2: uint64), (var_3: int64)): Env3 =
    ...
    if var_5 then
        ...
        | Union0Case0(var_11) ->
            ...
            method_5((var_12: ManagedCuda.BasicTypes.CUdeviceptr), (var_0: uint64), (var_2: uint64), (var_3: int64), (var_1: System.Collections.Generic.Stack<Env2>), (var_7: Env3), (var_8: int64))
        | Union0Case1 ->
            let (var_14: Env2) = var_1.Pop()
            let (var_15: Env3) = var_14.mem_0
            let (var_16: int64) = var_14.mem_1
            method_4((var_0: uint64), (var_1: System.Collections.Generic.Stack<Env2>), (var_2: uint64), (var_3: int64))
    else
        method_6((var_0: uint64), (var_2: uint64), (var_3: int64), (var_1: System.Collections.Generic.Stack<Env2>))
and method_7((var_0: (Union0 ref))): ManagedCuda.BasicTypes.CUdeviceptr =
    let (var_1: Union0) = (!var_0)
    match var_1 with
    | Union0Case0(var_2) ->
        var_2.mem_0
    | Union0Case1 ->
        (failwith "A Cuda memory cell that has been disposed has been tried to be accessed.")
and method_12((var_0: ManagedCuda.CudaContext), (var_1: ManagedCuda.CudaStream), (var_2: uint64), (var_3: uint64), (var_4: System.Collections.Generic.Stack<Env2>), (var_5: (Union0 ref)), (var_6: int64), (var_7: int64), (var_8: int64), (var_9: int64), (var_10: int64), (var_11: int64), (var_12: int64), (var_13: int64)): unit =
    ...
    if var_24 then
        ...
        ()
    let (var_25: ManagedCuda.BasicTypes.CUdeviceptr) = method_7((var_5: (Union0 ref)))
    ...
    let (var_28: string) = ""
    let (var_29: int64) = 0L
    method_13((var_27: System.Text.StringBuilder), (var_29: int64))
    let (var_30: System.Text.StringBuilder) = var_27.AppendLine("[|")
    method_14((var_27: System.Text.StringBuilder), (var_28: string), (var_26: (int64 [])), (var_6: int64), (var_7: int64), (var_8: int64), (var_9: int64), (var_10: int64), (var_11: int64), (var_12: int64), (var_13: int64))
    let (var_31: int64) = 0L
    method_13((var_27: System.Text.StringBuilder), (var_31: int64))
    let (var_32: System.Text.StringBuilder) = var_27.AppendLine("|]")
    let (var_33: string) = var_27.ToString()
    let (var_34: string) = System.String.Format("{0}",var_33)
    System.Console.WriteLine(var_34)
and method_19((var_0: ManagedCuda.CudaContext), (var_1: ManagedCuda.CudaStream), (var_2: uint64), (var_3: uint64), (var_4: System.Collections.Generic.Stack<Env2>), (var_5: (Union0 ref)), (var_6: int64), (var_7: int64), (var_8: int64), (var_9: int64)): unit =
    ...
    if var_14 then
        ...
        ()
    let (var_15: ManagedCuda.BasicTypes.CUdeviceptr) = method_7((var_5: (Union0 ref)))
    ...
    let (var_18: string) = ""
    let (var_19: int64) = 0L
    method_13((var_17: System.Text.StringBuilder), (var_19: int64))
    let (var_20: System.Text.StringBuilder) = var_17.Append("[|")
    let (var_21: string) = method_16((var_17: System.Text.StringBuilder), (var_16: (int64 [])), (var_6: int64), (var_7: int64), (var_8: int64), (var_9: int64), (var_18: string))
...
and method_3((var_0: (int64 [])), (var_1: int64), (var_2: int64)): unit =
    ...
    if var_3 then
        ...
        ()
and method_5((var_0: ManagedCuda.BasicTypes.CUdeviceptr), (var_1: uint64), (var_2: uint64), (var_3: int64), (var_4: System.Collections.Generic.Stack<Env2>), (var_5: Env3), (var_6: int64)): Env3 =
    ...
    (Env3(var_19))
and method_6((var_0: uint64), (var_1: uint64), (var_2: int64), (var_3: System.Collections.Generic.Stack<Env2>)): Env3 =
...
and method_13((var_0: System.Text.StringBuilder), (var_1: int64)): unit =
    ...
    if var_2 then
        ...
        ()
and method_14((var_0: System.Text.StringBuilder), (var_1: string), (var_2: (int64 [])), (var_3: int64), (var_4: int64), (var_5: int64), (var_6: int64), (var_7: int64), (var_8: int64), (var_9: int64), (var_10: int64)): unit =
    ...
    if var_11 then
        ...
        let (var_15: int64) = 0L
        method_15((var_0: System.Text.StringBuilder), (var_15: int64))
        let (var_16: System.Text.StringBuilder) = var_0.Append("[|")
        let (var_17: string) = method_16((var_0: System.Text.StringBuilder), (var_2: (int64 [])), (var_14: int64), (var_6: int64), (var_9: int64), (var_10: int64), (var_1: string))
        let (var_18: System.Text.StringBuilder) = var_0.AppendLine("|]")
        let (var_19: int64) = (var_7 + 1L)
        method_18((var_0: System.Text.StringBuilder), (var_1: string), (var_2: (int64 [])), (var_3: int64), (var_4: int64), (var_5: int64), (var_6: int64), (var_7: int64), (var_8: int64), (var_9: int64), (var_10: int64), (var_19: int64))
    else
        ()
and method_16((var_0: System.Text.StringBuilder), (var_1: (int64 [])), (var_2: int64), (var_3: int64), (var_4: int64), (var_5: int64), (var_6: string)): string =
    ...
    if var_7 then
        ...
        method_17((var_0: System.Text.StringBuilder), (var_1: (int64 [])), (var_2: int64), (var_3: int64), (var_4: int64), (var_5: int64), (var_14: string), (var_15: int64))
    else
        var_6
and method_15((var_0: System.Text.StringBuilder), (var_1: int64)): unit =
    ...
    if var_2 then
        ...
        ()
and method_18((var_0: System.Text.StringBuilder), (var_1: string), (var_2: (int64 [])), (var_3: int64), (var_4: int64), (var_5: int64), (var_6: int64), (var_7: int64), (var_8: int64), (var_9: int64), (var_10: int64), (var_11: int64)): unit =
    ...
    if var_12 then
        ...
        let (var_19: int64) = 0L
        method_15((var_0: System.Text.StringBuilder), (var_19: int64))
        let (var_20: System.Text.StringBuilder) = var_0.Append("[|")
        let (var_21: string) = method_16((var_0: System.Text.StringBuilder), (var_2: (int64 [])), (var_18: int64), (var_6: int64), (var_9: int64), (var_10: int64), (var_1: string))
        let (var_22: System.Text.StringBuilder) = var_0.AppendLine("|]")
        let (var_23: int64) = (var_11 + 1L)
        method_18((var_0: System.Text.StringBuilder), (var_1: string), (var_2: (int64 [])), (var_3: int64), (var_4: int64), (var_5: int64), (var_6: int64), (var_7: int64), (var_8: int64), (var_9: int64), (var_10: int64), (var_23: int64))
    else
        ()
and method_17((var_0: System.Text.StringBuilder), (var_1: (int64 [])), (var_2: int64), (var_3: int64), (var_4: int64), (var_5: int64), (var_6: string), (var_7: int64)): string =
    ...
    if var_8 then
        ...
        let (var_18: string) = "; "
        let (var_19: int64) = (var_7 + 1L)
        method_17((var_0: System.Text.StringBuilder), (var_1: (int64 [])), (var_2: int64), (var_3: int64), (var_4: int64), (var_5: int64), (var_18: string), (var_19: int64))
    else
        var_6
...
let (var_54: Env3) = method_4((var_47: uint64), (var_44: System.Collections.Generic.Stack<Env2>), (var_48: uint64), (var_53: int64))
let (var_55: (Union0 ref)) = var_54.mem_0
let (var_56: ManagedCuda.BasicTypes.CUdeviceptr) = method_7((var_55: (Union0 ref)))
var_1.CopyToDevice(var_56, var_50)
let (var_57: int64) = 64L
let (var_58: Env3) = method_4((var_47: uint64), (var_44: System.Collections.Generic.Stack<Env2>), (var_48: uint64), (var_57: int64))
let (var_59: (Union0 ref)) = var_58.mem_0
let (var_60: ManagedCuda.BasicTypes.CUdeviceptr) = method_7((var_55: (Union0 ref)))
let (var_61: ManagedCuda.BasicTypes.CUdeviceptr) = method_7((var_59: (Union0 ref)))
// Cuda join point
// method_8((var_60: ManagedCuda.BasicTypes.CUdeviceptr), (var_61: ManagedCuda.BasicTypes.CUdeviceptr))
let (var_63: (System.Object [])) = [|var_60; var_61|]: (System.Object [])
let (var_64: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_8", var_32, var_1)
...
let (var_71: int64) = 1L
let (var_72: int64) = 0L
let (var_73: int64) = 32L
let (var_74: int64) = 0L
let (var_75: int64) = 8L
method_12((var_1: ManagedCuda.CudaContext), (var_49: ManagedCuda.CudaStream), (var_47: uint64), (var_48: uint64), (var_44: System.Collections.Generic.Stack<Env2>), (var_55: (Union0 ref)), (var_68: int64), (var_69: int64), (var_70: int64), (var_71: int64), (var_72: int64), (var_73: int64), (var_74: int64), (var_75: int64))
let (var_76: int64) = 0L
let (var_77: int64) = 1L
let (var_78: int64) = 0L
let (var_79: int64) = 8L
method_19((var_1: ManagedCuda.CudaContext), (var_49: ManagedCuda.CudaStream), (var_47: uint64), (var_48: uint64), (var_44: System.Collections.Generic.Stack<Env2>), (var_59: (Union0 ref)), (var_76: int64), (var_77: int64), (var_78: int64), (var_79: int64))
var_59 := Union0Case1
var_55 := Union0Case1
var_49.Dispose()
