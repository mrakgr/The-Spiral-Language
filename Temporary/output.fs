...
and method_10((var_0: (int64 [])), (var_1: int64)): unit =
    ...
    if var_2 then
        ...
        method_10((var_0: (int64 [])), (var_5: int64))
    else
        ()
...
and method_12((var_0: ResizeArray<EnvStack2>), (var_1: ResizeArray<Env1>), (var_2: EnvStack0), (var_3: uint64), (var_4: ResizeArray<Env1>), (var_5: int64)): EnvStack2 =
    ...
    let (var_7: EnvStack0) = method_13((var_1: ResizeArray<Env1>), (var_2: EnvStack0), (var_3: uint64), (var_4: ResizeArray<Env1>), (var_6: uint64))
    let (var_8: (int64 ref)) = (ref 0L)
    let (var_9: EnvStack2) = EnvStack2((var_8: (int64 ref)), (var_7: EnvStack0))
    method_14((var_9: EnvStack2), (var_0: ResizeArray<EnvStack2>))
    var_9
and method_5((var_0: (uint64 ref))): uint64 =
    ...
    if var_3 then
        ...
        ()
    var_1
and method_17((var_0: int64), (var_1: EnvStack4), (var_2: int64), (var_3: int64)): (int64 []) =
...
and method_18((var_0: System.Text.StringBuilder), (var_1: int64)): unit =
    ...
    if var_2 then
        ...
        ()
and method_19((var_0: System.Text.StringBuilder), (var_1: (int64 [])), (var_2: (int64 [])), (var_3: string), (var_4: int64), (var_5: int64)): int64 =
    ...
    if var_6 then
        ...
        if var_7 then
            ...
            method_19((var_0: System.Text.StringBuilder), (var_1: (int64 [])), (var_2: (int64 [])), (var_18: string), (var_19: int64), (var_20: int64))
        else
            let (var_22: System.Text.StringBuilder) = var_0.Append("...")
            var_4
    else
        var_4
and method_20((var_0: ResizeArray<EnvStack3>)): unit =
    let (var_2: (EnvStack3 -> unit)) = method_21
    var_0.ForEach <| System.Action<_>(var_2)
    var_0.Clear()
and method_22((var_0: ResizeArray<EnvStack2>)): unit =
    let (var_2: (EnvStack2 -> unit)) = method_23
    var_0.ForEach <| System.Action<_>(var_2)
    var_0.Clear()
...
and method_14((var_0: EnvStack2), (var_1: ResizeArray<EnvStack2>)): unit =
    ...
    var_2 := var_5
    var_1.Add(var_0)
and method_21 ((var_0: EnvStack3)): unit =
    ...
    if var_6 then
        ...
        ()
and method_23 ((var_0: EnvStack2)): unit =
    let (var_1: (int64 ref)) = var_0.mem_0
...
let (var_61: (int64 [])) = Array.zeroCreate<int64> (System.Convert.ToInt32(32L))
let (var_62: int64) = 0L
...
let (var_67: EnvStack2) = var_66.mem_0
let (var_68: int64) = 256L
let (var_69: EnvStack2) = method_12((var_46: ResizeArray<EnvStack2>), (var_41: ResizeArray<Env1>), (var_40: EnvStack0), (var_35: uint64), (var_42: ResizeArray<Env1>), (var_68: int64))
let (var_70: EnvStack4) = EnvStack4((var_69: EnvStack2))
let (var_71: (int64 ref)) = var_54.mem_0
let (var_72: EnvStack5) = var_54.mem_1
let (var_73: (bool ref)) = var_72.mem_0
let (var_74: ManagedCuda.CudaStream) = var_72.mem_1
let (var_75: bool) = (!var_73)
let (var_76: bool) = (var_75 = false)
if var_76 then
    (failwith "The stream has been disposed.")
else
    ()
let (var_77: ManagedCuda.BasicTypes.CUstream) = var_74.Stream
let (var_78: EnvStack2) = var_70.mem_0
...
let (var_85: ManagedCuda.BasicTypes.SizeT) = ManagedCuda.BasicTypes.SizeT(256L)
var_1.ClearMemoryAsync(var_84, 0uy, var_85, var_77)
let (var_86: (int64 ref)) = var_67.mem_0
let (var_87: EnvStack0) = var_67.mem_1
let (var_88: (uint64 ref)) = var_87.mem_0
let (var_89: uint64) = method_5((var_88: (uint64 ref)))
let (var_90: uint64) = method_5((var_81: (uint64 ref)))
// Cuda join point
// method_15((var_89: uint64), (var_90: uint64))
let (var_91: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_15", var_32, var_1)
let (var_92: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(1u, 1u, 1u)
...
let (var_94: bool) = (!var_73)
let (var_95: bool) = (var_94 = false)
if var_95 then
    (failwith "The stream has been disposed.")
else
    ()
let (var_96: ManagedCuda.BasicTypes.CUstream) = var_74.Stream
let (var_98: (System.Object [])) = [|var_89; var_90|]: (System.Object [])
var_91.RunAsync(var_96, var_98)
let (var_99: int64) = 32L
let (var_100: int64) = 0L
let (var_101: int64) = 1L
let (var_102: (int64 [])) = method_17((var_99: int64), (var_70: EnvStack4), (var_100: int64), (var_101: int64))
let (var_103: System.Text.StringBuilder) = System.Text.StringBuilder()
let (var_104: string) = ""
let (var_105: int64) = 0L
let (var_106: int64) = 0L
method_18((var_103: System.Text.StringBuilder), (var_106: int64))
let (var_107: System.Text.StringBuilder) = var_103.Append("[|")
let (var_108: int64) = 0L
let (var_109: int64) = method_19((var_103: System.Text.StringBuilder), (var_61: (int64 [])), (var_102: (int64 [])), (var_104: string), (var_105: int64), (var_108: int64))
let (var_110: System.Text.StringBuilder) = var_103.AppendLine("|]")
let (var_111: string) = var_103.ToString()
let (var_112: string) = System.String.Format("{0}",var_111)
System.Console.WriteLine(var_112)
var_59.Dispose()
var_56.Dispose()
method_20((var_53: ResizeArray<EnvStack3>))
method_22((var_46: ResizeArray<EnvStack2>))
let (var_113: (uint64 ref)) = var_40.mem_0
