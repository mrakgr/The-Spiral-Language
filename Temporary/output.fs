...
let (var_84: ManagedCuda.BasicTypes.CUdeviceptr) = method_5((var_65: (Union0 ref)))
...
let (var_122: ManagedCuda.BasicTypes.CUdeviceptr) = method_5((var_76: (Union0 ref)))
...
let (var_155: ManagedCuda.BasicTypes.CUdeviceptr) = method_5((var_76: (Union0 ref)))
...
let (var_176: ManagedCuda.BasicTypes.CUdeviceptr) = method_5((var_70: (Union0 ref)))
...
let (var_187: int64) = 4L
let (var_188: int64) = 1L
let (var_189: int64) = 0L
let (var_190: int64) = 6L
let (var_191: int64) = 0L
let (var_192: int64) = 4L
method_22((var_1: ManagedCuda.CudaContext), (var_49: ManagedCuda.CudaStream), (var_47: uint64), (var_48: uint64), (var_44: System.Collections.Generic.Stack<Env2>), (var_70: (Union0 ref)), (var_185: int64), (var_186: int64), (var_187: int64), (var_188: int64), (var_189: int64), (var_190: int64), (var_191: int64), (var_192: int64))
var_127 := Union0Case1
var_117 := Union0Case1
var_106 := Union0Case1
var_96 := Union0Case1
...
var_51.Dispose()
var_49.Dispose()
let (var_193: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_43: (Union0 ref)))
var_1.FreeMemory(var_193)
var_43 := Union0Case1
var_1.Dispose()
