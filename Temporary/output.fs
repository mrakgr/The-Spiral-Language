...
let (var_8: string) = System.IO.Path.Combine("C:\\cub-1.7.4", "VC\\Auxiliary\\Build\\vcvarsx86_amd64.bat")
let (var_9: string) = System.IO.Path.Combine("C:\\cub-1.7.4", "VC\\Tools\\MSVC\\14.11.25503\\bin\\Hostx64\\x64\\cl.exe")
let (var_10: string) = System.IO.Path.Combine("C:\\Program Files\\NVIDIA GPU Computing Toolkit\\CUDA\\v9.0", "include")
let (var_11: string) = System.IO.Path.Combine("C:\\cub-1.7.4", "VC\\Tools\\MSVC\\14.11.25503\\include")
...
let (var_57: System.Text.StringBuilder) = var_56.Append("C:\\Program Files (x86)\\Microsoft Visual Studio\\2017\\Community")
...
let (var_112: (int64 [])) = Array.zeroCreate<int64> (System.Convert.ToInt32(8L))
let (var_113: int64) = 0L
let (var_114: int64) = 0L
let (var_115: int64) = method_2((var_112: (int64 [])), (var_114: int64), (var_113: int64))
let (var_116: EnvHeap5) = ({mem_0 = (var_112: (int64 []))} : EnvHeap5)
let (var_117: (int64 [])) = var_116.mem_0
let (var_118: int64) = var_117.LongLength
let (var_119: int64) = (int64 sizeof<int64>)
let (var_120: int64) = (var_118 * var_119)
let (var_121: EnvStack2) = method_3((var_108: uint64), (var_110: System.Collections.Generic.Stack<Env3>), (var_109: uint64), (var_120: int64))
let (var_122: (Union0 ref)) = var_121.mem_0
let (var_123: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_122: (Union0 ref)))
var_111.CopyToDevice(var_123, var_117)
let (var_128: int64) = (8L * var_119)
let (var_129: EnvStack2) = method_3((var_108: uint64), (var_110: System.Collections.Generic.Stack<Env3>), (var_109: uint64), (var_128: int64))
let (var_130: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_122: (Union0 ref)))
let (var_131: (Union0 ref)) = var_129.mem_0
let (var_132: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_131: (Union0 ref)))
// Cuda join point
// method_7((var_130: ManagedCuda.BasicTypes.CUdeviceptr), (var_132: ManagedCuda.BasicTypes.CUdeviceptr))
let (var_133: (System.Object [])) = Array.zeroCreate<System.Object> (System.Convert.ToInt32(2L))
var_133.[int32 0L] <- (var_132 :> System.Object)
var_133.[int32 1L] <- (var_130 :> System.Object)
let (var_134: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_7", var_84, var_1)
let (var_135: ManagedCuda.VectorTypes.dim3) = ManagedCuda.VectorTypes.dim3(32u, 1u, 1u)
...
let (var_137: float32) = var_134.Run(var_133)
let (var_138: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_131: (Union0 ref)))
let (var_139: (int64 [])) = Array.zeroCreate<int64> (System.Convert.ToInt32(8L))
var_111.CopyToHost(var_139, var_138)
var_111.Synchronize()
let (var_140: string) = method_9((var_139: (int64 [])))
System.Console.WriteLine(var_140)
var_131 := Union0Case1
var_122 := Union0Case1
let (var_141: ManagedCuda.CudaRand.GeneratorType) = ManagedCuda.CudaRand.GeneratorType.PseudoDefault
ManagedCuda.CudaRand.CudaRandDevice(var_141)
