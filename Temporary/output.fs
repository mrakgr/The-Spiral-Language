...
let (var_99: (Union0 ref)) = (ref (Union0Case0(Tuple2(Tuple1(var_98)))))
let (var_100: EnvStack3) = EnvStack3((var_99: (Union0 ref)))
let (var_101: System.Collections.Generic.Stack<Env4>) = System.Collections.Generic.Stack<Env4>()
...
let (var_107: EnvStack5) = EnvStack5((var_105: uint64), (var_106: uint64), (var_101: System.Collections.Generic.Stack<Env4>), (var_1: ManagedCuda.CudaContext))
let (var_108: uint64) = var_107.mem_0
let (var_109: uint64) = var_107.mem_1
let (var_110: System.Collections.Generic.Stack<Env4>) = var_107.mem_2
...
let (var_120: EnvHeap6) = ({mem_0 = (var_116: (float32 []))} : EnvHeap6)
...
let (var_126: EnvHeap7) = ({mem_0 = (var_122: (float32 []))} : EnvHeap7)
...
let (var_131: EnvStack3) = method_4((var_108: uint64), (var_110: System.Collections.Generic.Stack<Env4>), (var_109: uint64), (var_130: int64))
...
let (var_136: EnvStack3) = method_4((var_108: uint64), (var_110: System.Collections.Generic.Stack<Env4>), (var_109: uint64), (var_135: int64))
