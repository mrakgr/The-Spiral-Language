...
and method_8((var_0: ResizeArray<Env1>), (var_1: EnvStack0), (var_2: uint64), (var_3: ResizeArray<Env1>), (var_4: uint64)): EnvStack0 =
...
let (var_43: uint64) = 128UL
let (var_44: EnvStack0) = method_8((var_41: ResizeArray<Env1>), (var_40: EnvStack0), (var_35: uint64), (var_42: ResizeArray<Env1>), (var_43: uint64))
let (var_45: uint64) = 64UL
let (var_46: EnvStack0) = method_8((var_41: ResizeArray<Env1>), (var_40: EnvStack0), (var_35: uint64), (var_42: ResizeArray<Env1>), (var_45: uint64))
let (var_47: uint64) = 32UL
let (var_48: EnvStack0) = method_8((var_41: ResizeArray<Env1>), (var_40: EnvStack0), (var_35: uint64), (var_42: ResizeArray<Env1>), (var_47: uint64))
