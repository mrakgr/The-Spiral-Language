...
and EnvHeap11 =
    ...
    mem_7: uint64
    mem_8: uint64
    mem_9: System.Collections.Generic.Stack<Env3>
    mem_10: ManagedCuda.CudaBlas.CudaBlas
    mem_11: ManagedCuda.CudaContext
    mem_12: ManagedCuda.BasicTypes.CUmodule
    mem_13: ManagedCuda.CudaStream
    mem_14: EnvStack2
    mem_15: int64
    mem_16: int64
    mem_17: int64
...
and method_3((var_0: (float32 [])), (var_1: int64), (var_2: int64)): unit =
    ...
    if var_3 then
        ...
        ()
and method_4((var_0: string)): Env4 =
...
and method_9((var_0: uint64), (var_1: System.Collections.Generic.Stack<Env3>), (var_2: uint64), (var_3: int64)): EnvStack2 =
    ...
    if var_5 then
        ...
        | Union0Case0(var_11) ->
            ...
            method_10((var_12: ManagedCuda.BasicTypes.CUdeviceptr), (var_0: uint64), (var_2: uint64), (var_3: int64), (var_1: System.Collections.Generic.Stack<Env3>), (var_7: EnvStack2), (var_8: int64))
        | Union0Case1 ->
        ...
        method_11((var_0: uint64), (var_1: System.Collections.Generic.Stack<Env3>), (var_2: uint64), (var_3: int64))
and method_12((var_0: ManagedCuda.BasicTypes.CUdeviceptr)): ManagedCuda.BasicTypes.CUdeviceptr =
    ...
    var_4
and method_13((var_0: int64), (var_1: uint64), (var_2: uint64), (var_3: System.Collections.Generic.Stack<Env3>), (var_4: ManagedCuda.CudaBlas.CudaBlas), (var_5: ManagedCuda.CudaContext), (var_6: ManagedCuda.BasicTypes.CUmodule), (var_7: ManagedCuda.CudaStream), (var_8: EnvStack2), (var_9: EnvStack2), (var_10: int64), (var_11: int64), (var_12: int64), (var_13: int64), (var_14: int64), (var_15: EnvStack2), (var_16: int64), (var_17: int64), (var_18: int64), (var_19: int64), (var_20: int64)): unit =
    ...
    if var_21 then
        ...
        let (var_58: EnvHeap11) = ({mem_0 = (var_15: EnvStack2); mem_1 = (var_46: int64); mem_2 = (var_16: int64); mem_3 = (var_35: int64); mem_4 = (var_18: int64); mem_5 = (var_19: int64); mem_6 = (var_8: EnvStack2); mem_7 = (var_1: uint64); mem_8 = (var_2: uint64); mem_9 = (var_3: System.Collections.Generic.Stack<Env3>); mem_10 = (var_4: ManagedCuda.CudaBlas.CudaBlas); mem_11 = (var_5: ManagedCuda.CudaContext); mem_12 = (var_6: ManagedCuda.BasicTypes.CUmodule); mem_13 = (var_7: ManagedCuda.CudaStream); mem_14 = (var_9: EnvStack2); mem_15 = (var_57: int64); mem_16 = (var_10: int64); mem_17 = (var_13: int64); mem_18 = (var_14: int64)} : EnvHeap11)
        let (var_59: EnvStack2) = var_58.mem_0
        ...
        let (var_65: EnvStack2) = var_58.mem_6
        let (var_66: uint64) = var_58.mem_7
        let (var_67: uint64) = var_58.mem_8
        let (var_68: System.Collections.Generic.Stack<Env3>) = var_58.mem_9
        let (var_69: ManagedCuda.CudaBlas.CudaBlas) = var_58.mem_10
        let (var_70: ManagedCuda.CudaContext) = var_58.mem_11
        let (var_71: ManagedCuda.BasicTypes.CUmodule) = var_58.mem_12
        let (var_72: ManagedCuda.CudaStream) = var_58.mem_13
        let (var_73: EnvStack2) = var_58.mem_14
        ...
        let (var_83: EnvStack2) = method_9((var_66: uint64), (var_68: System.Collections.Generic.Stack<Env3>), (var_67: uint64), (var_82: int64))
        ...
        let (var_99: ManagedCuda.BasicTypes.CUstream) = var_72.get_Stream()
        var_69.set_Stream(var_99)
        let (var_100: ManagedCuda.CudaBlas.CudaBlasHandle) = var_69.get_CublasHandle()
        ...
        if var_85 then
            ...
            ()
        let (var_121: EnvStack2) = method_9((var_66: uint64), (var_68: System.Collections.Generic.Stack<Env3>), (var_67: uint64), (var_82: int64))
        ...
        let (var_131: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_15", var_71, var_70)
        ...
        let (var_134: ManagedCuda.BasicTypes.CUstream) = var_72.get_Stream()
        ...
        if var_144 then
            ...
            let (var_151: EnvStack2) = method_9((var_66: uint64), (var_68: System.Collections.Generic.Stack<Env3>), (var_67: uint64), (var_150: int64))
            ...
            let (var_157: ManagedCuda.CudaKernel) = ManagedCuda.CudaKernel("method_17", var_71, var_70)
            ...
            let (var_161: ManagedCuda.BasicTypes.CUstream) = var_72.get_Stream()
            var_157.RunAsync(var_161, var_156)
            let (var_163: (Union12 ref)) = (ref Union12Case1)
            let (var_164: float32) = method_22((var_151: EnvStack2), (var_145: int64), (var_70: ManagedCuda.CudaContext), (var_163: (Union12 ref)))
            let (var_165: string) = System.String.Format("{0}",var_164)
            System.Console.WriteLine(var_165)
            var_152 := Union0Case1
        else
            let (var_167: (Union12 ref)) = (ref Union12Case1)
            let (var_168: float32) = method_25((var_121: EnvStack2), (var_73: EnvStack2), (var_80: int64), (var_70: ManagedCuda.CudaContext), (var_167: (Union12 ref)))
            let (var_169: string) = System.String.Format("{0}",var_168)
            System.Console.WriteLine(var_169)
        var_126 := Union0Case1
        var_96 := Union0Case1
        method_13((var_0: int64), (var_1: uint64), (var_2: uint64), (var_3: System.Collections.Generic.Stack<Env3>), (var_4: ManagedCuda.CudaBlas.CudaBlas), (var_5: ManagedCuda.CudaContext), (var_6: ManagedCuda.BasicTypes.CUmodule), (var_7: ManagedCuda.CudaStream), (var_8: EnvStack2), (var_9: EnvStack2), (var_10: int64), (var_11: int64), (var_12: int64), (var_13: int64), (var_14: int64), (var_15: EnvStack2), (var_16: int64), (var_17: int64), (var_18: int64), (var_19: int64), (var_22: int64))
    else
        ()
...
and method_7((var_0: (uint8 [])), (var_1: int64), (var_2: int64), (var_3: (float32 [])), (var_4: int64)): unit =
    ...
    if var_5 then
        ...
        ()
and method_10((var_0: ManagedCuda.BasicTypes.CUdeviceptr), (var_1: uint64), (var_2: uint64), (var_3: int64), (var_4: System.Collections.Generic.Stack<Env3>), (var_5: EnvStack2), (var_6: int64)): EnvStack2 =
    ...
    var_20
and method_11((var_0: uint64), (var_1: System.Collections.Generic.Stack<Env3>), (var_2: uint64), (var_3: int64)): EnvStack2 =
...
and method_14((var_0: int64), (var_1: ManagedCuda.BasicTypes.CUdeviceptr)): ManagedCuda.BasicTypes.CUdeviceptr =
    ...
    var_7
and method_22((var_0: EnvStack2), (var_1: int64), (var_2: ManagedCuda.CudaContext), (var_3: (Union12 ref))): float32 =
    let (var_4: Union12) = (!var_3)
    match var_4 with
    | Union12Case0(var_5) ->
        var_5.mem_0
    | Union12Case1 ->
        let (var_7: float32) = method_20((var_0: EnvStack2), (var_1: int64), (var_2: ManagedCuda.CudaContext))
        var_3 := (Union12Case0(Tuple13(var_7)))
        var_7
and method_25((var_0: EnvStack2), (var_1: EnvStack2), (var_2: int64), (var_3: ManagedCuda.CudaContext), (var_4: (Union12 ref))): float32 =
    let (var_5: Union12) = (!var_4)
    match var_5 with
    | Union12Case0(var_6) ->
        var_6.mem_0
    | Union12Case1 ->
        let (var_8: float32) = method_23((var_0: EnvStack2), (var_1: EnvStack2), (var_2: int64), (var_3: ManagedCuda.CudaContext))
        var_4 := (Union12Case0(Tuple13(var_8)))
        var_8
...
and method_8((var_0: (uint8 [])), (var_1: int64), (var_2: int64), (var_3: (float32 [])), (var_4: int64)): unit =
    ...
    if var_5 then
        ...
        ()
and method_20((var_0: EnvStack2), (var_1: int64), (var_2: ManagedCuda.CudaContext)): float32 =
    ...
    if var_4 then
        ...
        ()
    let (var_8: float32) = var_7.[int32 0L]
    let (var_9: int64) = 1L
    method_21((var_7: (float32 [])), (var_1: int64), (var_9: int64), (var_8: float32))
and method_23((var_0: EnvStack2), (var_1: EnvStack2), (var_2: int64), (var_3: ManagedCuda.CudaContext)): float32 =
    let (var_4: bool) = (0L < var_2)
    let (var_5: bool) = (var_4 = false)
    if var_5 then
        (failwith "Tensor needs to be at least size 1.")
    else
        ()
    let (var_6: (Union0 ref)) = var_0.mem_0
    let (var_7: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_6: (Union0 ref)))
    let (var_8: (float32 [])) = Array.zeroCreate<float32> (System.Convert.ToInt32(var_2))
    var_3.CopyToHost(var_8, var_7)
    var_3.Synchronize()
    let (var_9: (Union0 ref)) = var_1.mem_0
    let (var_10: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_9: (Union0 ref)))
    let (var_11: (float32 [])) = Array.zeroCreate<float32> (System.Convert.ToInt32(var_2))
    var_3.CopyToHost(var_11, var_10)
    var_3.Synchronize()
    if var_5 then
        (failwith "Argument out of bounds.")
    else
        ()
    let (var_12: float32) = var_8.[int32 0L]
    let (var_13: float32) = var_11.[int32 0L]
    let (var_14: float32) = (var_13 - var_12)
    let (var_15: float32) = (var_14 * var_14)
    let (var_16: int64) = 1L
    method_24((var_8: (float32 [])), (var_11: (float32 [])), (var_2: int64), (var_16: int64), (var_15: float32))
and method_21((var_0: (float32 [])), (var_1: int64), (var_2: int64), (var_3: float32)): float32 =
    ...
    if var_4 then
        ...
        method_21((var_0: (float32 [])), (var_1: int64), (var_9: int64), (var_8: float32))
    else
        var_3
and method_24((var_0: (float32 [])), (var_1: (float32 [])), (var_2: int64), (var_3: int64), (var_4: float32)): float32 =
    ...
    if var_5 then
        ...
        method_24((var_0: (float32 [])), (var_1: (float32 [])), (var_2: int64), (var_13: int64), (var_12: float32))
    else
        var_4
...
let (var_66: Env4) = method_4((var_65: string))
let (var_67: Env5) = var_66.mem_0
let (var_68: Env6) = var_67.mem_0
let (var_69: Tuple7) = var_67.mem_1
let (var_70: Env8) = var_69.mem_0
let (var_71: Env8) = var_69.mem_1
...
let (var_94: Tuple9) = var_68.mem_1
let (var_95: int64) = var_68.mem_2
let (var_96: int64) = var_68.mem_3
let (var_97: Env10) = var_94.mem_0
...
let (var_103: Env4) = method_4((var_102: string))
let (var_104: Env5) = var_103.mem_0
let (var_105: Env6) = var_104.mem_0
let (var_106: Tuple7) = var_104.mem_1
let (var_107: Env8) = var_106.mem_0
let (var_108: Env8) = var_106.mem_1
...
let (var_131: Tuple9) = var_105.mem_1
let (var_132: int64) = var_105.mem_2
let (var_133: int64) = var_105.mem_3
let (var_134: Env10) = var_131.mem_0
...
let (var_140: Env4) = method_4((var_139: string))
let (var_141: Env5) = var_140.mem_0
let (var_142: Env6) = var_141.mem_0
let (var_143: Tuple7) = var_141.mem_1
let (var_144: Env8) = var_143.mem_0
let (var_145: Env8) = var_143.mem_1
...
let (var_168: Tuple9) = var_142.mem_1
let (var_169: int64) = var_142.mem_2
let (var_170: int64) = var_142.mem_3
let (var_171: Env10) = var_168.mem_0
...
let (var_177: Env4) = method_4((var_176: string))
let (var_178: Env5) = var_177.mem_0
let (var_179: Env6) = var_178.mem_0
let (var_180: Tuple7) = var_178.mem_1
let (var_181: Env8) = var_180.mem_0
let (var_182: Env8) = var_180.mem_1
...
let (var_205: Tuple9) = var_179.mem_1
let (var_206: int64) = var_179.mem_2
let (var_207: int64) = var_179.mem_3
let (var_208: Env10) = var_205.mem_0
...
let (var_216: EnvStack2) = method_9((var_54: uint64), (var_50: System.Collections.Generic.Stack<Env3>), (var_55: uint64), (var_215: int64))
...
let (var_221: EnvStack2) = method_9((var_54: uint64), (var_50: System.Collections.Generic.Stack<Env3>), (var_55: uint64), (var_220: int64))
...
let (var_226: EnvStack2) = method_9((var_54: uint64), (var_50: System.Collections.Generic.Stack<Env3>), (var_55: uint64), (var_225: int64))
...
let (var_231: EnvStack2) = method_9((var_54: uint64), (var_50: System.Collections.Generic.Stack<Env3>), (var_55: uint64), (var_230: int64))
...
let (var_234: float32) = sqrt 0.002519f
let (var_235: int64) = (7840L * var_214)
let (var_236: EnvStack2) = method_9((var_54: uint64), (var_50: System.Collections.Generic.Stack<Env3>), (var_55: uint64), (var_235: int64))
let (var_237: ManagedCuda.BasicTypes.CUstream) = var_56.get_Stream()
var_36.SetStream(var_237)
let (var_238: (Union0 ref)) = var_236.mem_0
let (var_239: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_238: (Union0 ref)))
let (var_240: ManagedCuda.BasicTypes.CUdeviceptr) = method_12((var_239: ManagedCuda.BasicTypes.CUdeviceptr))
let (var_241: ManagedCuda.BasicTypes.SizeT) = ManagedCuda.BasicTypes.SizeT(7840L)
var_36.GenerateNormal32(var_240, var_241, 0.000000f, var_234)
let (var_242: bool) = (var_146 = var_183)
let (var_244: bool) =
    if var_242 then
        (var_147 = var_184)
    else
        false
let (var_245: bool) = (var_244 = false)
if var_245 then
    (failwith "Training and test set need to have to equal first dimensions.")
else
    ()
let (var_246: int64) = 0L
method_13((var_147: int64), (var_54: uint64), (var_55: uint64), (var_50: System.Collections.Generic.Stack<Env3>), (var_39: ManagedCuda.CudaBlas.CudaBlas), (var_1: ManagedCuda.CudaContext), (var_32: ManagedCuda.BasicTypes.CUmodule), (var_56: ManagedCuda.CudaStream), (var_236: EnvStack2), (var_231: EnvStack2), (var_201: int64), (var_183: int64), (var_184: int64), (var_197: int64), (var_198: int64), (var_226: EnvStack2), (var_164: int64), (var_146: int64), (var_160: int64), (var_161: int64), (var_246: int64))
var_238 := Union0Case1
var_56.Dispose()
let (var_247: ManagedCuda.BasicTypes.CUdeviceptr) = method_1((var_51: (Union0 ref)))
var_1.FreeMemory(var_247)
var_51 := Union0Case1
var_39.Dispose()
var_36.Dispose()
var_1.Dispose()
