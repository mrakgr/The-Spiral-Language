...
let example2 () =
    let rec method_0((var_0: string), (var_1: int64)): Union0 =
        if var_1 >= 0L && var_1 < int64 var_0.Length then
            ...
            let (var_11: bool) =
                if var_9 then
                    ...
                    false
            if var_11 then
                let (var_17: uint64) = uint64 var_7 - uint64 '0'
                let (var_18: bool) = (0UL < var_17)
                if var_18 then
...
printfn "The time it took to run 100k iterations: %A" stopwatch.Elapsed // 00:00:00.0060667
