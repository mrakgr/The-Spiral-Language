...
class US4_0(NamedTuple): # CommunityCardIs
    v0 : US5
    tag = 0
class US4_1(NamedTuple): # PlayerAction
    v0 : i32
    v1 : US1
    tag = 1
class US4_2(NamedTuple): # PlayerGotCard
    v0 : i32
    v1 : US5
    tag = 2
class US4_3(NamedTuple): # Showdown
    v0 : list[US5]
    v1 : i32
    v2 : i32
    tag = 3
...
class UH0_0(NamedTuple): # Action
    ...
    v4 : list[i32]
    v5 : i32
    v6 : Callable[[US1], Tuple[UH0, US4]]
    tag = 0
class UH0_1(NamedTuple): # Chance
    v0 : Callable[[US5], Tuple[UH0, US4]]
    tag = 1
...
class US3_1(NamedTuple): # Some
    v0 : Callable[[list[US4], list, US1], UH0]
    v1 : list[US5]
    v2 : list
    tag = 1
...
def Closure1(env_v0 : Callable[[US1], Tuple[UH0, US4]]):
    def inner(v1 : list[US4], v2 : list, v3 : US1) -> UH0:
        nonlocal env_v0
        v0 = env_v0
        v4, v5 = v0(v3)
        del v0
        ...
        return v4
    return inner
def Closure4(env_v0 : US6, env_v1 : bool, env_v2 : list[US5], env_v3 : i32, env_v4 : list[i32], env_v5 : i32, env_v6 : Callable[[US1], UH0]):
    def inner(v7 : US1) -> Tuple[UH0, US4]:
        ...
        return v8, v9
    return inner
def Closure3(env_v0 : US6, env_v1 : bool, env_v2 : list[US5], env_v3 : i32, env_v4 : list[i32], env_v5 : i32):
    ...
    return inner
def Closure2():
    def inner(v0 : US6, v1 : bool, v2 : list[US5], v3 : i32, v4 : list[i32], v5 : i32) -> Callable[[Callable[[US1], UH0]], UH0]:
        return Closure3(v0, v1, v2, v3, v4, v5)
    return inner
def Closure6(env_v0 : Callable[[US5], UH0]):
    def inner(v1 : US5) -> Tuple[UH0, US4]:
        nonlocal env_v0
        v0 = env_v0
        v2 = v0(v1)
        del v0
...
def Closure9(env_v0 : i32, env_v1 : Callable[[US5], UH0]):
    def inner(v2 : US5) -> Tuple[UH0, US4]:
...
def Closure10():
    def inner(v0 : US6, v1 : bool, v2 : list[US5], v3 : i32, v4 : list[i32], v5 : i32) -> UH0:
        v6 = 0 <= v3
        if v6:
            v7 = v3 < 2
            v8 = v7
...
def Closure11():
    def inner(v0 : US6, v1 : bool, v2 : list[US5], v3 : i32, v4 : list[i32], v5 : i32) -> UH0:
        ...
        if v12:
            ...
            v16 = 0
        del v12
        v17 = US4_3(v2, v11, v16)
        del v11, v16
        return UH0_2(v0, v1, v2, v3, v4, v5, v15, v17)
    return inner
def Closure19(env_v0 : Callable[[US6, bool, list[US5], i32, list[i32], i32], Callable[[Callable[[US1], UH0]], UH0]], env_v1 : Callable[[Callable[[US5], UH0]], UH0], env_v2 : Callable[[i32], Callable[[Callable[[US5], UH0]], UH0]], env_v3 : Callable[[US6, bool, list[US5], i32, list[i32], i32], UH0], env_v4 : Callable[[US6, bool, list[US5], i32, list[i32], i32], UH0], env_v5 : US5, env_v6 : list[US5], env_v7 : list[i32], env_v8 : i32):
    def inner(v9 : US1) -> UH0:
        ...
        match v9:
            case US1_0(): # Call
                ...
                v31 = US6_1(v5)
                del v5
                return v3(v31, False, v6, 0, v23, v8)
            case US1_1(): # Fold
                del v0, v1, v2, v3
                v10 = US6_1(v5)
                del v5
                return v4(v10, False, v6, 0, v7, v8)
            case US1_2(): # Raise
                v33 = v8 > 0
                if v33:
                    del v33
                    ...
                    while method19(v55):
                        ...
                        v68 = v67 == False
                        if v68:
                            v69 = "The read index needs to be in range."
                            assert v67, v69
                            del v69
                        else:
                            pass
                    ...
                    del v46, v55
                    v70 = US6_1(v5)
                    v71 = v0(v70, False, v6, 1, v54, v34)
                    del v70
                    v72 = Closure18(v0, v1, v2, v3, v4, v5, v6, v54, v34)
                    del v0, v1, v2, v3, v4, v5, v6, v34, v54
                    return v71(v72)
                else:
                    del v0, v1, v2, v3, v4, v5, v6, v7, v8, v33
                    raise Exception("Invalid action. The number of raises left is not positive.")
            case _:
                raise Exception('Pattern matching miss.')
    return inner
def Closure18(env_v0 : Callable[[US6, bool, list[US5], i32, list[i32], i32], Callable[[Callable[[US1], UH0]], UH0]], env_v1 : Callable[[Callable[[US5], UH0]], UH0], env_v2 : Callable[[i32], Callable[[Callable[[US5], UH0]], UH0]], env_v3 : Callable[[US6, bool, list[US5], i32, list[i32], i32], UH0], env_v4 : Callable[[US6, bool, list[US5], i32, list[i32], i32], UH0], env_v5 : US5, env_v6 : list[US5], env_v7 : list[i32], env_v8 : i32):
    def inner(v9 : US1) -> UH0:
        nonlocal env_v0, env_v1, env_v2, env_v3, env_v4, env_v5, env_v6, env_v7, env_v8
        v0 = env_v0; v1 = env_v1; v2 = env_v2; v3 = env_v3; v4 = env_v4; v5 = env_v5; v6 = env_v6; v7 = env_v7; v8 = env_v8
        match v9:
            case US1_0(): # Call
                ...
                v31 = US6_1(v5)
                del v5
                return v3(v31, False, v6, 1, v23, v8)
            case US1_1(): # Fold
                del v0, v1, v2, v3
                v10 = US6_1(v5)
                del v5
                return v4(v10, False, v6, 1, v7, v8)
            case US1_2(): # Raise
                v33 = v8 > 0
                if v33:
                    del v33
                    ...
                    del v46, v55
                    v70 = US6_1(v5)
                    v71 = v0(v70, False, v6, 0, v54, v34)
                    del v70
                    v72 = Closure19(v0, v1, v2, v3, v4, v5, v6, v54, v34)
                    del v0, v1, v2, v3, v4, v5, v6, v34, v54
                    return v71(v72)
                else:
                    del v0, v1, v2, v3, v4, v5, v6, v7, v8, v33
            ...
            case _:
                raise Exception('Pattern matching miss.')
    return inner
def Closure17(env_v0 : Callable[[US6, bool, list[US5], i32, list[i32], i32], Callable[[Callable[[US1], UH0]], UH0]], env_v1 : Callable[[Callable[[US5], UH0]], UH0], env_v2 : Callable[[i32], Callable[[Callable[[US5], UH0]], UH0]], env_v3 : Callable[[US6, bool, list[US5], i32, list[i32], i32], UH0], env_v4 : Callable[[US6, bool, list[US5], i32, list[i32], i32], UH0], env_v5 : US5, env_v6 : list[US5], env_v7 : list[i32], env_v8 : i32):
    def inner(v9 : US1) -> UH0:
        nonlocal env_v0, env_v1, env_v2, env_v3, env_v4, env_v5, env_v6, env_v7, env_v8
        v0 = env_v0; v1 = env_v1; v2 = env_v2; v3 = env_v3; v4 = env_v4; v5 = env_v5; v6 = env_v6; v7 = env_v7; v8 = env_v8
        match v9:
            case US1_0(): # Call
                v12 = US6_1(v5)
                v13 = v0(v12, False, v6, 1, v7, v8)
                del v12
                v14 = Closure18(v0, v1, v2, v3, v4, v5, v6, v7, v8)
            ...
            case US1_2(): # Raise
                ...
                if v16:
                    ...
                    while method19(v38):
                        ...
                        v43 = v42 == False
                        if v43:
                            v44 = "The read index needs to be in range."
                            assert v42, v44
                            del v44
                        else:
                            pass
                    ...
                    del v29, v38
                    v53 = US6_1(v5)
                    v54 = v0(v53, False, v6, 1, v37, v17)
                    del v53
                    v55 = Closure18(v0, v1, v2, v3, v4, v5, v6, v37, v17)
                    del v0, v1, v2, v3, v4, v5, v6, v17, v37
                    return v54(v55)
                else:
                    del v0, v1, v2, v3, v4, v5, v6, v7, v8, v16
                    raise Exception("Invalid action. The number of raises left is not positive.")
            case _:
                raise Exception('Pattern matching miss.')
    return inner
def Closure16(env_v0 : Callable[[US6, bool, list[US5], i32, list[i32], i32], Callable[[Callable[[US1], UH0]], UH0]], env_v1 : Callable[[Callable[[US5], UH0]], UH0], env_v2 : Callable[[i32], Callable[[Callable[[US5], UH0]], UH0]], env_v3 : Callable[[US6, bool, list[US5], i32, list[i32], i32], UH0], env_v4 : Callable[[US6, bool, list[US5], i32, list[i32], i32], UH0], env_v5 : list[US5], env_v6 : list[i32], env_v7 : i32):
    def inner(v8 : US5) -> UH0:
        ...
        del v11, v22
        v29 = US6_1(v8)
        v30 = v0(v29, True, v5, 0, v21, v9)
        del v29
        v31 = Closure17(v0, v1, v2, v3, v4, v8, v5, v21, v9)
        del v0, v1, v2, v3, v4, v5, v9, v21
        return v30(v31)
    return inner
def Closure21(env_v0 : Callable[[US6, bool, list[US5], i32, list[i32], i32], Callable[[Callable[[US1], UH0]], UH0]], env_v1 : Callable[[Callable[[US5], UH0]], UH0], env_v2 : Callable[[i32], Callable[[Callable[[US5], UH0]], UH0]], env_v3 : Callable[[US6, bool, list[US5], i32, list[i32], i32], UH0], env_v4 : Callable[[US6, bool, list[US5], i32, list[i32], i32], UH0], env_v5 : list[US5], env_v6 : list[i32], env_v7 : i32):
    def inner(v8 : US5) -> UH0:
        nonlocal env_v0, env_v1, env_v2, env_v3, env_v4, env_v5, env_v6, env_v7
        v0 = env_v0; v1 = env_v1; v2 = env_v2; v3 = env_v3; v4 = env_v4; v5 = env_v5; v6 = env_v6; v7 = env_v7
        del v7
        ...
        return v30(v31)
    return inner
def Closure20(env_v0 : Callable[[US6, bool, list[US5], i32, list[i32], i32], Callable[[Callable[[US1], UH0]], UH0]], env_v1 : Callable[[Callable[[US5], UH0]], UH0], env_v2 : Callable[[i32], Callable[[Callable[[US5], UH0]], UH0]], env_v3 : Callable[[US6, bool, list[US5], i32, list[i32], i32], UH0], env_v4 : Callable[[US6, bool, list[US5], i32, list[i32], i32], UH0], env_v5 : list[US5], env_v6 : list[i32], env_v7 : i32):
    def inner(v8 : US1) -> UH0:
        nonlocal env_v0, env_v1, env_v2, env_v3, env_v4, env_v5, env_v6, env_v7
        v0 = env_v0; v1 = env_v1; v2 = env_v2; v3 = env_v3; v4 = env_v4; v5 = env_v5; v6 = env_v6; v7 = env_v7
        match v8:
            case US1_0(): # Call
                v11 = Closure21(v0, v1, v2, v3, v4, v5, v6, v7)
                del v0, v2, v3, v4, v5, v6, v7
                return v1(v11)
            case US1_1(): # Fold
                del v0, v1, v2, v3
                v9 = US6_0()
                return v4(v9, False, v5, 0, v6, v7)
            case US1_2(): # Raise
                v13 = v7 > 0
                if v13:
                    del v13
                    ...
                    while method19(v27):
                        ...
                        v32 = v31 == False
                        if v32:
                            v33 = "The read index needs to be in range."
                            assert v31, v33
                            del v33
                        else:
                            pass
                    ...
                    while method19(v35):
                        ...
                        v40 = v39 == False
                        if v40:
                            v41 = "The read index needs to be in range."
                            assert v39, v41
                            del v41
                        else:
                            pass
                    ...
                    del v26, v35
                    v50 = US6_0()
                    v51 = v0(v50, False, v5, 1, v34, v14)
                    del v50
                    v52 = Closure15(v0, v1, v2, v3, v4, v5, v34, v14)
                    del v0, v1, v2, v3, v4, v5, v14, v34
                    return v51(v52)
                else:
                    del v0, v1, v2, v3, v4, v5, v6, v7, v13
                    raise Exception("Invalid action. The number of raises left is not positive.")
            case _:
                raise Exception('Pattern matching miss.')
    return inner
def Closure15(env_v0 : Callable[[US6, bool, list[US5], i32, list[i32], i32], Callable[[Callable[[US1], UH0]], UH0]], env_v1 : Callable[[Callable[[US5], UH0]], UH0], env_v2 : Callable[[i32], Callable[[Callable[[US5], UH0]], UH0]], env_v3 : Callable[[US6, bool, list[US5], i32, list[i32], i32], UH0], env_v4 : Callable[[US6, bool, list[US5], i32, list[i32], i32], UH0], env_v5 : list[US5], env_v6 : list[i32], env_v7 : i32):
    def inner(v8 : US1) -> UH0:
        nonlocal env_v0, env_v1, env_v2, env_v3, env_v4, env_v5, env_v6, env_v7
        v0 = env_v0; v1 = env_v1; v2 = env_v2; v3 = env_v3; v4 = env_v4; v5 = env_v5; v6 = env_v6; v7 = env_v7
        match v8:
            case US1_0(): # Call
                v11 = Closure16(v0, v1, v2, v3, v4, v5, v6, v7)
                del v0, v2, v3, v4, v5, v6, v7
                return v1(v11)
            case US1_1(): # Fold
                del v0, v1, v2, v3
                v9 = US6_0()
                return v4(v9, False, v5, 1, v6, v7)
            case US1_2(): # Raise
                v13 = v7 > 0
                if v13:
                    del v13
                    ...
                    del v26, v35
                    v50 = US6_0()
                    v51 = v0(v50, False, v5, 0, v34, v14)
                    del v50
                    v52 = Closure20(v0, v1, v2, v3, v4, v5, v34, v14)
                    del v0, v1, v2, v3, v4, v5, v14, v34
                    return v51(v52)
                else:
                    del v0, v1, v2, v3, v4, v5, v6, v7, v13
            ...
            case _:
                raise Exception('Pattern matching miss.')
    return inner
def Closure14(env_v0 : Callable[[US6, bool, list[US5], i32, list[i32], i32], Callable[[Callable[[US1], UH0]], UH0]], env_v1 : Callable[[Callable[[US5], UH0]], UH0], env_v2 : Callable[[i32], Callable[[Callable[[US5], UH0]], UH0]], env_v3 : Callable[[US6, bool, list[US5], i32, list[i32], i32], UH0], env_v4 : Callable[[US6, bool, list[US5], i32, list[i32], i32], UH0], env_v5 : list[US5], env_v6 : list[i32], env_v7 : i32):
    def inner(v8 : US1) -> UH0:
        nonlocal env_v0, env_v1, env_v2, env_v3, env_v4, env_v5, env_v6, env_v7
        v0 = env_v0; v1 = env_v1; v2 = env_v2; v3 = env_v3; v4 = env_v4; v5 = env_v5; v6 = env_v6; v7 = env_v7
        match v8:
            case US1_0(): # Call
                v11 = US6_0()
                v12 = v0(v11, False, v5, 1, v6, v7)
                del v11
                v13 = Closure15(v0, v1, v2, v3, v4, v5, v6, v7)
                del v0, v1, v2, v3, v4, v5, v6, v7
                return v12(v13)
            case US1_1(): # Fold
                del v0, v1, v2, v3
                v9 = US6_0()
                return v4(v9, True, v5, 0, v6, v7)
            case US1_2(): # Raise
                v15 = v7 > 0
                if v15:
                    del v15
                    ...
                    del v28, v37
                    v52 = US6_0()
                    v53 = v0(v52, False, v5, 1, v36, v16)
                    del v52
                    v54 = Closure15(v0, v1, v2, v3, v4, v5, v36, v16)
                    del v0, v1, v2, v3, v4, v5, v16, v36
                    return v53(v54)
                else:
                    del v0, v1, v2, v3, v4, v5, v6, v7, v15
                    raise Exception("Invalid action. The number of raises left is not positive.")
            case _:
                raise Exception('Pattern matching miss.')
    return inner
def Closure13(env_v0 : Callable[[US6, bool, list[US5], i32, list[i32], i32], Callable[[Callable[[US1], UH0]], UH0]], env_v1 : Callable[[Callable[[US5], UH0]], UH0], env_v2 : Callable[[i32], Callable[[Callable[[US5], UH0]], UH0]], env_v3 : Callable[[US6, bool, list[US5], i32, list[i32], i32], UH0], env_v4 : Callable[[US6, bool, list[US5], i32, list[i32], i32], UH0], env_v5 : US5):
    def inner(v6 : US5) -> UH0:
        ...
        v9[1] = v6
        v10 = US6_0()
        v11 = v0(v10, True, v9, 0, v8, v7)
        del v10
        v12 = Closure14(v0, v1, v2, v3, v4, v9, v8, v7)
        del v0, v1, v2, v3, v4, v7, v8, v9
        return v11(v12)
    return inner
def Closure12(env_v0 : Callable[[US6, bool, list[US5], i32, list[i32], i32], Callable[[Callable[[US1], UH0]], UH0]], env_v1 : Callable[[Callable[[US5], UH0]], UH0], env_v2 : Callable[[i32], Callable[[Callable[[US5], UH0]], UH0]], env_v3 : Callable[[US6, bool, list[US5], i32, list[i32], i32], UH0], env_v4 : Callable[[US6, bool, list[US5], i32, list[i32], i32], UH0]):
        ...
        match v2:
            case US0_0(v63): # ActionSelected
                match v3:
                    case US3_0(): # None
                        del v63
                        v93, v94, v95, v96, v97 = v3, v4, v5, v6, v7
                    case US3_1(v64, v65, v66): # Some
                        v67 = v64(v4, v5, v63)
                        del v63, v64
                        v93, v94, v95, v96, v97 = method11(v3, v4, v5, v6, v7, v65, v66, v67)
                    case _:
                        raise Exception('Pattern matching miss.')
            case US0_1(v62): # PlayerChanged
                v93, v94, v95, v96, v97 = v3, v4, v5, v62, v7
            case US0_2(): # StartGame
                ...
                v54 = Closure10()
                v55 = Closure11()
                v56 = method18(v51, v52, v53, v54, v55)
                del v51, v52, v53, v54, v55
                v93, v94, v95, v96, v97 = method11(v13, v11, v12, v8, v14, v15, v16, v56)
            case _:
                raise Exception('Pattern matching miss.')
        del v2, v3, v4, v5, v6, v7
        return method20(v93, v94, v95, v96, v97)
    return inner
def Closure22():
    def inner() -> object:
        v0 = [None] * 2
        ...
        if v8:
            ...
            if v15:
                ...
                if v22:
                    ...
                    v44 = v43
                    del v43
                    return US4_3(v29, v41, v44)
                else:
                    del v2, v22
                    raise TypeError(f"Cannot convert the Python object into a Spiral union type. Invalid string tag. Got: {v1}")
                    del v1
                    raise Exception("Error")
def method10(v0 : object) -> US6:
    v1 = v0[0]
    v2 = v0[1]
    del v0
    v4 = "None" == v1
    ...
    if v4:
        ...
        if v7:
            ...
            if v54:
                ...
                del v1
                raise Exception("Error")
def method5(v0 : object) -> Tuple[US3, list[US4], list, list[US2], US7]:
    v1 = "game_state"
    v2 = v0[v1]
    del v1
    v3 = "next"
...
def method13(v0 : list[US5], v1 : list, v2 : US3, v3 : list[US4], v4 : list, v5 : list[US2], v6 : US7, v7 : Callable[[US5], Tuple[UH0, US4]]) -> Tuple[US3, list[US4], list, list[US2], US7]:
    v8 = v1[0]
    v9 = v8 - 1
    del v8
    v10 = 0 <= v9
    ...
    match v22:
        ...
        case _:
            raise Exception('Pattern matching miss.')
def method12(v0 : list[US5], v1 : list, v2 : US3, v3 : list[US4], v4 : list, v5 : list[US2], v6 : US7, v7 : Callable[[US1], Tuple[UH0, US4]], v8 : US6, v9 : bool, v10 : list[US5], v11 : i32, v12 : list[i32], v13 : i32) -> Tuple[US3, list[US4], list, list[US2], US7]:
    del v8, v9, v10, v11
    v14 = [None] * 3
    v15 = [0]
    v16 = v15[0]
    ...
    match v70:
        ...
        case _:
            raise Exception('Pattern matching miss.')
def method11(v0 : US3, v1 : list[US4], v2 : list, v3 : list[US2], v4 : US7, v5 : list[US5], v6 : list, v7 : UH0) -> Tuple[US3, list[US4], list, list[US2], US7]:
    match v7:
...
def method17(v0 : i32, v1 : i32) -> Tuple[i32, i32]:
    ...
    if v2:
        ...
        del v2
        return v0, v1
def method14(v0 : US6, v1 : bool, v2 : list[US5], v3 : i32, v4 : list[i32], v5 : i32) -> US8:
    del v1, v3, v4, v5
    match v0:
        case US6_0(): # None
            del v0, v2
...
def method19(v0 : i32) -> bool:
    ...
    del v0
    return v1
def method18(v0 : Callable[[US6, bool, list[US5], i32, list[i32], i32], Callable[[Callable[[US1], UH0]], UH0]], v1 : Callable[[Callable[[US5], UH0]], UH0], v2 : Callable[[i32], Callable[[Callable[[US5], UH0]], UH0]], v3 : Callable[[US6, bool, list[US5], i32, list[i32], i32], UH0], v4 : Callable[[US6, bool, list[US5], i32, list[i32], i32], UH0]) -> UH0:
    v5 = v2(0)
...
def method24(v0 : US1) -> object:
    match v0:
        ...
        case _:
            raise Exception('Pattern matching miss.')
def method23(v0 : US4) -> object:
    match v0:
        case US4_0(v1): # CommunityCardIs
            del v0
            v2 = method22(v1)
            del v1
            v3 = "CommunityCardIs"
        ...
        case US4_1(v5, v6): # PlayerAction
            ...
            del v10, v11
            return v12
        case US4_2(v13, v14): # PlayerGotCard
            del v0
            v15 = []
            v16 = v13
            del v13
            ...
            del v18, v19
            return v20
        case US4_3(v21, v22, v23): # Showdown
            del v0
            v24 = []
            v25 = 0
            while method19(v25):
...
def method26(v0 : US7) -> object:
    match v0:
        ...
        case _:
            raise Exception('Pattern matching miss.')
def method20(v0 : US3, v1 : list[US4], v2 : list, v3 : list[US2], v4 : US7) -> object:
    v5 = method21(v0)
    del v0
    v6 = {'next': v5}
    del v5
