...
cdef class Closure1():
    ...
    def __call__(self, list v1):
        ...
        if v3:
            ...
            pass # import torch
            v6 = len(v1)
            v7 = numpy.zeros((v6,(<signed short>300)),dtype=numpy.float32)
            ...
            del v167
            v169 = v0((<signed short>266), v166, v168)
            del v166; del v168
            v170 = v169[0]
            v171 = v169[1]
            v172 = v169[2]
...
cdef signed short method6(numpy.ndarray[float,ndim=1] v0, signed short v1, signed short v2, signed short v3) except *:
    ...
    cdef float v13
    cdef signed short v14
    v4 = v2 < (<signed short>4)
    if v4:
        v5 = v2 + (<signed short>1)
        v6 = (<signed short>4) - v2
...
cdef void method5(signed short v0, numpy.ndarray[float,ndim=1] v1, signed short v2) except *:
    ...
    if v11:
        ...
        v15 = f'Pickle failure. Bin int value out of bounds. Got: {v0} Size: {(<signed short>4)}'
        raise Exception(v15)
...
cpdef object main():
    ...
    cdef object v7
    cdef object v8
    v0 = collections.namedtuple("Size",['action', 'policy', 'value'])((<signed short>10), (<signed short>266), (<signed short>300))
    v1 = Closure0()
