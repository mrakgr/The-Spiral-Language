...
from belief import InfNormSGD,Head,model_evaluate,InfCube,ResInfCube
...
def create_nn_agent(iter_train,iter_avg,iter_chk,iter_sub,iter_batch,vs_self,vs_one,neural,uniform_player,callbot_player,restriction_level=2,is_flop=False,sb=10,bb=20,stack_size=1000,resume_from=None,mode='self',schema_bb=20,schema_stack_size=1000):
...
def competitive_eval(players,vs_self,vs_one,neural,uniform_player,callbot_player,restriction_level=2,is_flop=False,sb=10,bb=20,stack_size=1000,schema_bb=20,schema_stack_size=1000):
    neural_applied = neural(schema_bb,schema_stack_size)
