...
static const char *__pyx_f[] = {
  "Source\\Repos\\The Spiral Language\\Spiral Compilation Tests\\cython_experiments\\test1\\test.pyx",
};
 ...
 * print(x)             # <<<<<<<<<<<<<<
 */
  __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_n_s_x); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 2, __pyx_L1_error)
