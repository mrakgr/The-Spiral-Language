...
cdef class Closure5():
    ...
    def __call__(self, numpy.ndarray[float,ndim=1] v3):
        ...
        while method0(v50, v55):
            ...
            v58 = v49[v57]
            tmp7 = v0[v57]
            v59, v60, v61, v62, v63, v64, v65, v66, v67, v68, v69, v70, v71, v72, v73, v74, v75, v76, v77, v78, v79 = tmp7.v0, tmp7.v1, tmp7.v2, tmp7.v3, tmp7.v4, tmp7.v5, tmp7.v6, tmp7.v7, tmp7.v8, tmp7.v9, tmp7.v10, tmp7.v11, tmp7.v12, tmp7.v13, tmp7.v14, tmp7.v15, tmp7.v16, tmp7.v17, tmp7.v18, tmp7.v19, tmp7.v20
            del tmp7
            del v61; del v64; del v75; del v79
            v80 = v78 == (<unsigned char>0)
            if v80:
                v82 = v58
            else:
                v81 = -v58
