...
cdef unsigned long long method3(signed short v0, signed short v1, signed short v2, signed short v3, signed short v4, signed short v5, numpy.ndarray[float,ndim=3] v6, numpy.ndarray[float,ndim=3] v7, unsigned long long v8, UH0 v9, unsigned long long v10) except *:
    ...
    if v9.tag == 0: # cons_
        ...
        if v11.tag == 0: # c1of2_
            v14 = (<US0_0>v11).v0
            v15 = v14 // (<signed char>13)
            v16 = v14 % (<signed char>13)
            v17 = (<signed char>0) <= v15
            if v17:
                v18 = <signed short>v15
                v20 = v18 < (<signed short>4)
            else:
                v20 = 0
            if v20:
                v21 = <signed short>v15
                v13[v21] = (<float>1)
            else:
                v22 = f'Pickle failure. Int value out of bounds. Got: {v15} Size: {(<signed short>4)}'
                raise Exception(v22)
            v23 = (<signed char>0) <= v16
            if v23:
                v24 = <signed short>v16
                v26 = v24 < (<signed short>13)
            else:
                v26 = 0
            if v26:
                v27 = <signed short>v16
                v28 = (<signed short>4) + v27
                v13[v28] = (<float>1)
            else:
                v29 = f'Pickle failure. Int value out of bounds. Got: {v16} Size: {(<signed short>13)}'
                raise Exception(v29)
        elif v11.tag == 1: # c2of2_
            v30 = (<US0_1>v11).v0
            if v30.tag == 0: # call
                v13[(<signed short>17)] = (<float>1)
            elif v30.tag == 1: # fold
                v13[(<signed short>18)] = (<float>1)
            elif v30.tag == 2: # raiseTo_
                v31 = (<US1_2>v30).v0
                v32 = (<signed short>19)
                method4(v2, v31, v13, v32)
            del v30
        del v13
        v33 = v7[v8,v10,:]
        if v11.tag == 0: # c1of2_
            v34 = (<US0_0>v11).v0
            v35 = v34 // (<signed char>13)
            v36 = v34 % (<signed char>13)
            v37 = (<signed char>0) <= v35
            if v37:
                v38 = <signed short>v35
                v40 = v38 < (<signed short>4)
            else:
                v40 = 0
            if v40:
                v41 = <signed short>v35
                v33[v41] = (<float>1)
            else:
                v42 = f'Pickle failure. Int value out of bounds. Got: {v35} Size: {(<signed short>4)}'
                raise Exception(v42)
            v43 = (<signed char>0) <= v36
            if v43:
                v44 = <signed short>v36
                v46 = v44 < (<signed short>13)
            else:
                v46 = 0
            if v46:
                v47 = <signed short>v36
                v48 = (<signed short>4) + v47
                v33[v48] = (<float>1)
            else:
                v49 = f'Pickle failure. Int value out of bounds. Got: {v36} Size: {(<signed short>13)}'
                raise Exception(v49)
        elif v11.tag == 1: # c2of2_
            v50 = (<US0_1>v11).v0
            if v50.tag == 0: # call
                v33[(<signed short>17)] = (<float>1)
            elif v50.tag == 1: # fold
                v33[(<signed short>18)] = (<float>1)
            elif v50.tag == 2: # raiseTo_
                v51 = (<US1_2>v50).v0
                v52 = (<signed short>19)
                method4(v2, v51, v33, v52)
            del v50
        del v11; del v33
        v53 = v10 + (<unsigned long long>1)
        return method3(v0, v1, v2, v3, v4, v5, v6, v7, v8, v12, v53)
    elif v9.tag == 1: # nil
        return v10
