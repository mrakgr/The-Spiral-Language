...
let rec method1 (v0 : int32, v1 : UH0) : int32 =
    match v1 with
    | UH0_0(v2, v3, v4, v5) -> (* cons_ *)
        let v6 : int32 = v0 + 4
...
and method2 (v0 : Mut0, v1 : (uint8 []), v2 : UH0) : unit =
    ...
    | UH0_0(v3, v4, v5, v6) -> (* cons_ *)
        ...
        v0.l0 <- v11
        let v12 : int32 = v0.l0
        let v13 : System.Span<uint8> = System.Span(v1,v12,4)
        ...
        let v19 : int32 = v0.l0
        let v20 : System.Span<uint8> = System.Span(v1,v19,4)
        ...
        v0.l0 <- v23
        let v24 : int32 = 0
        method3(v18, v17, v0, v1, v24)
        let v25 : int32 = v0.l0
        let v26 : System.Span<uint8> = System.Span(v1,v25,2)
...
and method0 () : unit =
    ...
    let v11 : int32 = 4
    let v12 : int32 = method1(v11, v10)
    let v13 : int32 = 4 + v12
    let v14 : int32 = 4 + v13
    let v15 : (uint8 []) = Array.zeroCreate<uint8> v14
    let v16 : Mut0 = {l0 = 0} : Mut0
    let v17 : int32 = v16.l0
    let v18 : System.Span<uint8> = System.Span(v15,v17,4)
    let v19 : bool = System.BitConverter.TryWriteBytes(v18,v0)
    ...
    let v21 : int32 = v17 + 4
    v16.l0 <- v21
    let v22 : int32 = v16.l0
    let v23 : System.Span<uint8> = System.Span(v15,v22,4)
    let v24 : bool = System.BitConverter.TryWriteBytes(v23,v1)
    ...
    v16.l0 <- v26
    method2(v16, v15, v10)
    let v27 : int32 = v16.l0
    let v28 : bool = v27 = v14
    ...
    if v29 then
        ...
        ()
    let v30 : Mut0 = {l0 = 0} : Mut0
    let v31 : int32 = v30.l0
    let v32 : int32 = v31 + 4
    v30.l0 <- v32
    let v33 : int32 = System.BitConverter.ToInt32(v15,v31)
    let v34 : int32 = v30.l0
    let v35 : int32 = v34 + 4
    v30.l0 <- v35
    let v36 : int32 = System.BitConverter.ToInt32(v15,v34)
    let v37 : UH0 = method4(v30, v15)
    let v38 : int32 = v30.l0
    let v39 : int32 = v15.Length
