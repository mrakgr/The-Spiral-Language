...
cdef class UH1_0(UH1): # cons_
    ...
    cdef public UH1 v1
    def __init__(self, v0, UH1 v1): self.tag = 0; self.v0 = v0; self.v1 = v1
...
cdef class UH3_0(UH3): # cons_
    ...
    cdef public char v2
    cdef public UH3 v3
    def __init__(self, signed long v0, v1, char v2, UH3 v3): self.tag = 0; self.v0 = v0; self.v1 = v1; self.v2 = v2; self.v3 = v3
...
cdef UH3 method4(UH3 v0, UH3 v1):
    ...
    if v1 == 0: # cons_
        ...
        return v0
cdef UH3 method3(signed long v0, v1, UH3 v2, UH2 v3):
    cdef char v4
    cdef UH2 v5
    cdef UH3 v6
    cdef UH3 v7
